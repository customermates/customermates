...
describe("ambiguous write targets", () => {
  ...
  it("never arms on a name the user governs with a set word or a name rule", () => {
    ...
    for (const text of [
      ...
      "Lösche alle Notizen des Nova Expansion Deals.",
      "Entferne alle Kontakte des Nova Expansion Deals.",
      "Lösche alle Notizen unseres Nova Expansion Deals.",
      "Entferne alle Kontakte eines Nova Expansion Deals.",
      "Set all of the Nova Expansion deals to Won.",
