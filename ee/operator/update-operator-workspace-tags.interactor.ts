...
import type { UpdateOperatorWorkspaceTagsData, OperatorWorkspaceTagsDto } from "./operator.schema";
...
import { OperatorWorkspaceTagsDtoSchema, UpdateOperatorWorkspaceTagsSchema } from "./operator.schema";

@OperatorInteractor
export class UpdateOperatorWorkspaceTagsInteractor {
  constructor(private readonly repo: OperatorRepo) {}

  @Enforce(UpdateOperatorWorkspaceTagsSchema)
  @ValidateOutput(OperatorWorkspaceTagsDtoSchema)
  async invoke(data: UpdateOperatorWorkspaceTagsData): Validated<OperatorWorkspaceTagsDto> {
    const result = await this.repo.updateWorkspaceTagsUnscoped(data);
