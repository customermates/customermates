...
export abstract class GetOperatorAuditRepo extends BaseGetRepo<OperatorAuditRowDto> {}

@OperatorInteractor
export class GetOperatorAuditInteractor extends BaseGetInteractor<OperatorAuditRowDto> {
  constructor(repo: GetOperatorAuditRepo, p13nRepo: P13nRepo) {
