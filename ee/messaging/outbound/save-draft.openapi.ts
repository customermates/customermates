...
import { BaseSaveDraftSchema } from "@/ee/messaging/outbound/save-draft.interactor";
...
export const saveDraftOperation: ZodOpenApiOperationObject = {
  ...
  requestBody: {
    ...
    content: {
      "application/json": {
        schema: BaseSaveDraftSchema.omit({ threadId: true, connectedAccountId: true, recipients: true }),
      },
    },
  },
  responses: {
...
export const saveNewThreadDraftOperation: ZodOpenApiOperationObject = {
  ...
  requestBody: {
    ...
    content: {
      "application/json": {
        schema: BaseSaveDraftSchema.omit({ threadId: true }),
      },
    },
  },
  responses: {
