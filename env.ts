...
export const env = {
  ...
  AGENT_CHAT_ENABLED: process.env.AGENT_CHAT_ENABLED === "true",
  AGENT_GATEWAY_DEBUG: process.env.AGENT_GATEWAY_DEBUG === "true",
  AGENT_AGENT_MODEL: process.env.AGENT_AGENT_MODEL ?? "openai:gpt-5.6-luna",
  AGENT_AGENT_MAX_STEPS: Number(process.env.AGENT_AGENT_MAX_STEPS ?? "8"),
  AGENT_APPROVAL_TIMEOUT_MS: Number(process.env.AGENT_APPROVAL_TIMEOUT_MS ?? "120000"),
  AGENT_APPROVAL_POLL_MS: Number(process.env.AGENT_APPROVAL_POLL_MS ?? "1000"),
  AGENT_MAX_OUTPUT_TOKENS: Number(process.env.AGENT_MAX_OUTPUT_TOKENS ?? "2048"),
  AGENT_CRM_TOOL_RESULT_MAX_CHARS: Number(process.env.AGENT_CRM_TOOL_RESULT_MAX_CHARS ?? "6000"),
};
