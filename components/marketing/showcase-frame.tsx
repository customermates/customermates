    ...
    <div className={cn("relative mb-10 w-full max-w-[1400px]", withHorizontalPadding && "px-4", className)}>
      {withGlow ? (
        <>
          ...
          <div className="absolute right-12 top-1/3 hidden rounded-full bg-muted will-change-transform md:block md:size-[105px] md:opacity-8 md:blur-[1.75rem] lg:right-20 lg:size-[250px] lg:opacity-50 lg:blur-[65px] md:dark:opacity-6 lg:dark:opacity-40" />
          ...
          <div className="absolute bottom-1/4 left-10 hidden rounded-full bg-muted will-change-transform sm:block sm:size-[62px] sm:opacity-7 sm:blur-[1.5rem] md:left-14 md:size-[95px] md:opacity-10 md:blur-[1.75rem] lg:left-20 lg:size-60 lg:opacity-60 lg:blur-[65px] sm:dark:opacity-6 md:dark:opacity-8 lg:dark:opacity-50" />
          ...
          <div className="absolute left-1/2 top-1/2 size-[130px] -translate-1/3 rounded-full bg-muted opacity-12 blur-[1.75rem] will-change-transform sm:size-[180px] sm:opacity-16 sm:blur-[2rem] md:size-[260px] md:opacity-24 md:blur-[2.75rem] lg:size-[350px] lg:opacity-50 lg:blur-[75px] dark:opacity-10 sm:dark:opacity-13 md:dark:opacity-19 lg:dark:opacity-40" />
        </>
      ) : null}

      <div
        className={cn(
          "relative z-10 overflow-hidden rounded-2xl border border-border bg-card p-2 shadow-2xl shadow-foreground/10",
          contentClassName,
        )}
      >
