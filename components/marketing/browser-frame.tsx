  ...
  return (
    <div className="relative mx-auto w-full">
      <div aria-hidden className="pointer-events-none absolute -inset-12 -z-10">
        <div className="absolute -left-8 top-0 size-[300px] rounded-full bg-[rgba(94,74,227,0.15)] blur-[70px]" />

        <div className="absolute -right-8 bottom-0 size-[280px] rounded-full bg-[rgba(18,148,144,0.12)] blur-[60px]" />
      </div>
