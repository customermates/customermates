...
export function NavigationLoadingOverlay() {
  ...
  const { loadingOverlayStore, navigationGuard } = useRootStore();
  ...
  useEffect(() => {
    ...
    function handleClick(event: MouseEvent) {
      ...
      if (innerInteractive && innerInteractive !== link && link.contains(innerInteractive)) return;
  ...
  }, [loadingOverlayStore, navigationGuard]);
