...
import { hasValidFilterConfiguration } from "../x-table-view/x-table-view.utils";

import { upsertFilterPresetAction, deleteFilterPresetAction } from "@/app/actions";
import { BaseModalStore } from "@/core/base/base-modal.store";

export class XEditFiltersModalStore extends BaseModalStore<UpsertFilterPresetData> {
