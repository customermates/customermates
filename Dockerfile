...
COPY --from=builder /app/scripts/agent-benchmark/build-source.ts ./scripts/agent-benchmark/build-source.ts
COPY --from=builder /app/scripts/agent-benchmark/workflow-world.ts ./scripts/agent-benchmark/workflow-world.ts
