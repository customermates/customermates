...
export const SEED_IDS = {
  ...
  pendingUser: "30000000-0000-4000-8000-000000000002",
  activeUser: "30000000-0000-4000-8000-000000000003",
...
export function createSeedContext(
  prisma: PrismaClient,
  input: Pick<SeedContext, "baseUrl" | "seedUserEmail" | "sharedUserPassword">,
): SeedContext {
