...
export const DYNAMIC_KEY_SITES = [
  ...
  "app/[locale]/(protected)/company/components/subscription/plan-picker.tsx :: t :: Subscription.picker.price.",
  "app/[locale]/(protected)/company/components/subscription/plan-picker.tsx :: t :: Subscription.planNames.",
  "app/[locale]/(protected)/company/components/subscription/plan-picker.tsx :: t.raw :: Subscription.picker.features.",
  "app/[locale]/(protected)/company/components/subscription/subscription-panel.tsx :: t :: Subscription.planNames.",
  ...
  "components/ai-connection/ai-connection-api-key-setup.tsx :: t :: OnboardingWizard.ai.choices.",
  "components/ai-connection/ai-connection-api-key-setup.tsx :: t :: OnboardingWizard.ai.install.instruction.",
  "components/ai-connection/ai-connection-claude-setup.tsx :: t :: OnboardingWizard.ai.choices.",
  "components/ai-connection/ai-connection-claude-setup.tsx :: t :: OnboardingWizard.ai.methods.",
  "components/ai-connection/ai-connection-flow.tsx :: t :: OnboardingWizard.ai.choices.",
  "components/ai-connection/ai-connection-provider-grid.tsx :: t :: OnboardingWizard.ai.choices.",
  ...
  "app/[locale]/(protected)/profile/components/profile-settings-form.tsx :: t :: Common.locales.",
  "app/[locale]/(protected)/profile/components/profile-settings-form.tsx :: t :: Common.themes.",
  ...
  "app/components/agent-chat/agent-chat.tsx :: t :: AgentChat.approval.",
  "app/components/agent-chat/agent-chat.tsx :: t :: AgentChat.credits.blocked.",
  "app/components/agent-chat/agent-chat.tsx :: t :: AgentChat.ui.activity",
  "app/components/agent-chat/agent-chat.tsx :: t :: Subscription.planNames.",
  "app/components/navigation/plan-subtitle.ts :: t :: Subscription.planNames.",
  "app/components/navigation/plan-subtitle.ts :: t :: Subscription.status.",
  ...
  "components/entity-terminology/use-column-label.ts :: t :: Common.table.columns.",
  "components/entity-terminology/use-filter-field-label.ts :: t :: Common.filters.fields.",
  ...
  "ee/messaging/sales-navigator/linkedin-browse-sales-list.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-list-sales-lists.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-list-sales-search-parameters.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-save-to-sales-list.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-search-sales-companies.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-search-sales-navigator.interactor.ts :: t :: Common.errors.",
  "ee/messaging/sales-navigator/linkedin-search-sales-people.interactor.ts :: t :: Common.errors.",
