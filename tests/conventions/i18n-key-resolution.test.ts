...
const AGENT_SETUP_TEXT_KEYS = [
  ...
  "AgentChat.setup.text.atRisk",
  "AgentChat.setup.text.blocked",
  "AgentChat.setup.text.bookProjectKickoff",
  "AgentChat.setup.text.brightpathRelaunch",
  "AgentChat.setup.text.cedarIntroduction",
  "AgentChat.setup.text.cedarPartnership",
  "AgentChat.setup.text.clarifyRequirements",
  "AgentChat.setup.text.collectProjectRequirements",
  "AgentChat.setup.text.commonGroundAdvisory",
  "AgentChat.setup.text.confirmDiscoveryGoals",
  "AgentChat.setup.text.confirmSeatRequirements",
  "AgentChat.setup.text.coreOffering",
  "AgentChat.setup.text.customerOpportunity",
  "AgentChat.setup.text.dealsByStage",
  "AgentChat.setup.text.discoveryWorkshop",
  "AgentChat.setup.text.done",
  "AgentChat.setup.text.draftPartnershipOutline",
  "AgentChat.setup.text.dueDate",
  "AgentChat.setup.text.enterprise",
  "AgentChat.setup.text.enterprisePlan",
  "AgentChat.setup.text.exampleCustomer",
  "AgentChat.setup.text.examplePartner",
  "AgentChat.setup.text.expandedOffering",
  "AgentChat.setup.text.growthRollout",
  "AgentChat.setup.text.implementationProject",
  "AgentChat.setup.text.inProgress",
  "AgentChat.setup.text.inbound",
  "AgentChat.setup.text.juniperDiscovery",
  "AgentChat.setup.text.juniperImplementation",
  "AgentChat.setup.text.keyRelationship",
  "AgentChat.setup.text.lindenExpansion",
  "AgentChat.setup.text.midMarket",
  "AgentChat.setup.text.new",
  "AgentChat.setup.text.northstarPilot",
  "AgentChat.setup.text.northstarRollout",
  "AgentChat.setup.text.oakFieldExpansion",
  "AgentChat.setup.text.oakFieldTeamPlan",
  "AgentChat.setup.text.onTrack",
  "AgentChat.setup.text.outbound",
  "AgentChat.setup.text.partnerExpansion",
  "AgentChat.setup.text.partnerOpportunity",
  "AgentChat.setup.text.partnershipProgram",
  "AgentChat.setup.text.pipelineValueByStage",
  "AgentChat.setup.text.prepareProductDemo",
  "AgentChat.setup.text.prepareRolloutProposal",
  "AgentChat.setup.text.prepareTheNextStep",
  "AgentChat.setup.text.projectHealth",
  "AgentChat.setup.text.proposal",
  "AgentChat.setup.text.qualified",
  "AgentChat.setup.text.referral",
  "AgentChat.setup.text.relationship",
  "AgentChat.setup.text.reviewDeliveryPlan",
  "AgentChat.setup.text.scheduleACheckIn",
  "AgentChat.setup.text.scheduleAFollowUp",
  "AgentChat.setup.text.scheduleStakeholderReview",
  "AgentChat.setup.text.segment",
  "AgentChat.setup.text.sendIntroductionNote",
  "AgentChat.setup.text.shareSecurityPackage",
  "AgentChat.setup.text.smallTeam",
  "AgentChat.setup.text.solarisEnterprisePlan",
  "AgentChat.setup.text.source",
  "AgentChat.setup.text.stage",
  "AgentChat.setup.text.status",
  "AgentChat.setup.text.strategySprint",
  "AgentChat.setup.text.tasksByStatus",
  "AgentChat.setup.text.teamPlan",
...
const AGENT_ACTIVITY_STATE_KEYS = [
  ...
  "AgentChat.activity.state.interface.configure.done",
  "AgentChat.activity.state.interface.configure.error",
  "AgentChat.activity.state.interface.configure.running",
  "AgentChat.activity.state.interface.fill.done",
  "AgentChat.activity.state.interface.fill.error",
  "AgentChat.activity.state.interface.fill.running",
