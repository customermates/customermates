...
export const DYNAMIC_KEY_SITES = [
  ...
  "app/[locale]/(protected)/contacts/components/add-channel-popover.tsx :: t :: EntityChannels.addChannel.placeholder.",
  ...
  "components/modal/start-chat-modal.tsx :: t :: Common.providers.",
