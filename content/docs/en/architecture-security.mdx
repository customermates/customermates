...
Every write is logged with user, action, entity, and before and after values. It is queryable from the UI and exportable as JSON. Audit logging is an Enterprise feature, available on paid cloud plans or self-host with a license key.
