...
Selecting a result opens the record's detail page. To add a record instead, use the **Add** control on its list page or the `?open={entityType}:new` deep link documented in [CRM Records](/docs/app-records).
...
On the record's detail page at `/{type}/{id}`, documented in [CRM Records](/docs/app-records).
</FaqItem>
</Faq>
