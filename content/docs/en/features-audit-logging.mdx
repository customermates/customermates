...
<DocsImage alt="Feature audit logging overview showing audit log list, event labels, user information, and timestamps" src="docs-features-audit-logging-overview.png" />
...
<DocsImage alt="Audit log details modal showing entity, event, actor, timestamp, and recorded event data" src="docs-features-audit-logging-details-modal.png" />
...
<DocsImage alt="Audit log change history modal showing users, events, change counts, and timestamps for an entity" src="docs-features-audit-logging-history-modal.png" />

<DocsImage alt="Audit log change history details view showing the selected change entry with field-level before and after values" src="docs-features-audit-logging-history-modal-details.png" />
