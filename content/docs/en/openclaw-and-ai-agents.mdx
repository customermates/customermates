...
## Skills and Orthogonal

Once the container is provisioned, the next practical step is usually the [Skills](/docs/skills) page. That is where users can browse reusable capabilities that can be added to the agent for more specific workflows.
...
For the broader runtime model behind that setup, continue with [Architecture & Security](/docs/architecture-security). For event-driven follow-up flows after agent actions, pair this with [Webhooks & Events](/docs/feature-guide-webhooks-events).
