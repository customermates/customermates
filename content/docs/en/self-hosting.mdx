...
| AI access | Hosted Assistant credits plus external MCP | External MCP with your provider; no hosted Assistant |
...
**Cost shape:** Cloud is priced per user across tiers, starting at [[commercial.price.starter.monthly]]/user/month; messaging capacity and hosted Assistant allowances grow with the plan. Self-host is free for the core application plus whatever you pay for infrastructure and your own AI provider. For a small team, cloud is often cheaper once you account for the time to run Postgres backups yourself. For a larger team, self-host is usually the lower cost.
