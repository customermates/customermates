...
Open the URL. Sign up with your email, click the verification link from the inbox, then choose a workspace name. This first account gets the built-in **Admin** role. Invite teammates under **My Company › Members** with **Add**, and define what they may do under **My Company › Roles**; see [My Company](/docs/app-company).
</Step>
...
**My Profile › API & Connectors**, then **Add**. Same flow as cloud. See [API keys](/docs/api-keys).
</Step>
</Steps>
...
A self-hosted workspace has no subscription and no trial: it starts active, and nothing in the app is billed. The sidebar therefore shows no **Subscription** entry under **My Company**, no **Channels** entry under **My Profile**, and no **Inbox** or **Routines**, and the role editor under **My Company › Roles** hides the **Inbox messages** and **Routines** rows. Opening one of those pages by URL returns you to the Dashboard.
