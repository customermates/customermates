...
Customermates has no dedicated CRM-record import or export workflow. Treat any move between systems as a separately designed and validated migration project.
