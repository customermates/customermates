...
<DocsImage alt="Contacts overview in table view with rows, columns, and a compact CRM layout" src="docs-features-table-kanban-view-table.png" />
...
<DocsImage alt="Contacts overview in card view with individual contact cards and visually separated records" src="docs-features-table-kanban-view-card.png" />
...
<DocsImage alt="Contacts overview as a Kanban board grouped by stages in the sales pipeline" src="docs-features-table-kanban-view-kanban.png" />
