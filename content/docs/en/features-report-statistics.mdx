...
<DocsImage alt="Feature report and statistics overview showing dashboard widgets and CRM analytics panels" src="docs-features-report-statistics-overview.png" />
...
<DocsImage alt="Widget setup modal for report and statistics showing entity, aggregation, grouping, and display configuration" src="docs-features-report-statistics-widget-modal.png" />
