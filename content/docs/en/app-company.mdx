---
title: Company
description: The Company screen, workspace-wide administration covering company data, team members, roles, webhooks, deliveries, and the audit trail, for humans and UI-driving agents.
---
...
|---|---|---|---|
| Go to Company | App sidebar | `#nav-company` | Opens /company/details |
| Details tab | Sidebar sub-item | `#nav-company-details` | Company name, logo, billing |
| Save / reset details | Form footer | `#company-details-save` / `#company-details-reset` | Persists or discards |
