...
<DocsImage alt="Feature custom columns overview showing custom field configuration and values inside records" src="docs-features-custom-columns-overview.png" />
...
<DocsImage alt="Custom column setup modal showing field type selection, naming, and configuration options" src="docs-features-custom-columns-field-modal.png" />
