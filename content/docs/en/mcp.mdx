...
- **Explicit column intent**: new integrations create with `intent=create` and no id, while legacy id-less calls remain create-only. Updates require `intent=update` plus an existing id. The tool keeps `label`, `type`, and `entityType` fixed on update, so a different label or type requires a new column.
...
| Tool                    | Read | Destructive | Purpose                                                                                                                                                                                                                                                                                                                                                                      |
| ----------------------- | ---- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `manage_custom_columns` |      | ✓           | One tool with an `action` switch: list, upsert (create or update), delete. New integrations use explicit `intent=create` without an id; legacy id-less creates remain accepted. Updates require `intent=update` with an existing id. Covers all ten column types; label, type and entityType are immutable on update. Delete is IRREVERSIBLE and removes every stored value. |
