...
description: Connect Claude Code, Codex, Cursor, or the Gemini CLI to Customermates, the open-source AI-native CRM, with an API key. One section per client, plus the Claude Desktop config-file fallback.
---
