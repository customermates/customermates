---
title: n8n
description: Build visual workflows over Customermates — webhook triggers, HTTP actions, and ready-made templates.
---
...
The payload shape is documented at [webhook events](/docs/webhook-events). Common next steps:
