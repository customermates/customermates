...
<DocsImage alt="Feature Webhooks und Events mit Subscriptions und Zustellhistorie" src="docs-features-webhooks-events-overview.png" />
...
<DocsImage alt="Webhook-Modal mit Ziel-URL, Event-Auswahl, Secret und Aktivstatus" src="docs-features-webhooks-events-webhook-modal.png" />
