...
description: Warum verbundene Kanäle Ratenlimits haben, welche Limits wir pro Anbieter anwenden und was passiert, wenn ein Limit erreicht wird.
---

Wenn du einen Kanal verbindest (LinkedIn, WhatsApp, E-Mail und so weiter), kommuniziert Customermates über Unipile mit diesem Anbieter. Jeder Anbieter erzwingt eigene Anfragelimits, und ein Überschreiten kann das zugrunde liegende Konto drosseln oder sogar sperren. Zum Schutz wenden wir pro Kanal ein konservatives Anfragebudget an und pausieren automatisch, bevor ein Anbieter eingreifen würde.

Eine pausierte Synchronisierung ist eine Funktion, kein Fehler: Sie bedeutet, dass dein Konto geschützt wurde.

## So funktionieren die Limits

Limits gelten **pro verbundenem Konto** und gleichzeitig auf drei Ebenen:
...
Lesevorgänge synchronisieren deinen Verlauf. Sie sind höher angesetzt als Schreibvorgänge, da Lesen selten eine Anbieter-Sperre auslöst.
...
Die Aktion gibt eine klare Meldung zurück, zum Beispiel:

> Dieser Kanal hat sein Limit vorerst erreicht. Bitte in 2 Minuten erneut versuchen.
