...
metaTitle: "Nachrichten-Ratenlimits pro Kanal und Tarif"
...
## Was Sie sehen, wenn ein Limit erreicht wird
...
Sobald das angegebene Fenster vorbei ist, können Sie es erneut versuchen. Es geht nichts verloren.

## Der Verlauf synchronisiert sich selbst

Der Import des gesamten Nachrichtenverlaufs kann umfangreich sein, etwa eine Anfrage pro Unterhaltung. Wird mitten im Import ein Limit erreicht, **pausiert der Hintergrund-Import und setzt automatisch fort**, sobald sich das Fenster erneuert; Sie müssen nichts tun. Beim Öffnen einer Unterhaltung werden deren Nachrichten zudem bei Bedarf geladen, und neue Aktivität trifft in Echtzeit über Webhooks ein.
