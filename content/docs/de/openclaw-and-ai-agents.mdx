---
title: OpenClaw und andere KI-Agenten
description: Verstehe, wie der Pro-Plan einen vorkonfigurierten sandboxed OpenClaw-Container mit nutzerbezogenem CRM-Zugriff und integrierten Container-Aktionen bereitstellt.
---
...
## Skills und Orthogonal

Sobald der Container bereitsteht, ist die [Skills](/docs/skills)-Seite meist der nächste praktische Schritt. Dort sehen Nutzer wiederverwendbare Fähigkeiten, die dem Agenten für konkretere Workflows hinzugefügt werden können.
...
Für das zugrunde liegende Sicherheits- und Laufzeitmodell gehst du weiter zu [Architektur & Sicherheit](/docs/architecture-security). Für eventgetriebene Folgeprozesse nach Agent-Aktionen kombinierst du das mit [Webhooks & Events](/docs/feature-guide-webhooks-events).
