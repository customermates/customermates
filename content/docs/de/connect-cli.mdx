...
| Alle | "Invalid API key" | Falscher oder abgeschnittener Key | Unter **Mein Profil → API & Konnektoren** einen neuen Key anlegen; der Key muss vollständige 64 Zeichen haben |
| Alle | Eine Verbindung, die funktioniert hat, wird nicht mehr authentifiziert | Der Key ist abgelaufen (Keys aus den **Schnellverbindungen** laufen nach 365 Tagen ab), wurde gelöscht, oder sein Besitzer steht auf **Inaktiv** | Ist der Key abgelaufen oder gelöscht, unter **Mein Profil → API & Konnektoren** einen neuen Key anlegen und den Client aktualisieren. Steht sein Besitzer auf **Inaktiv**, setzt ihn ein Mitglied mit **Verwalten** auf **Benutzer & Rollen** unter **Mein Unternehmen → Mitglieder** wieder auf **Aktiv**; danach funktioniert der vorhandene Key wieder |
