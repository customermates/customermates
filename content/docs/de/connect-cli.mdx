...
description: Verbinden Sie Claude Code, Codex, Cursor oder die Gemini CLI per API-Key mit Customermates, dem Open-Source-KI-CRM. Ein Abschnitt pro Client, plus Konfigurationsdatei-Fallback für Claude Desktop.
---
