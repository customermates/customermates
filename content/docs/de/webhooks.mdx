...
Um eine fehlgeschlagene Delivery erneut zuzustellen, nutze die UI oder `manage_webhooks` mit `action: "resend_delivery"` und der Delivery-id. Dabei entsteht ein neuer Delivery-Record; das Original bleibt unverändert.

Customermates wiederholt fehlgeschlagene Deliveries nicht automatisch. Wenn dein Receiver ausgefallen war, stelle aus der UI erneut zu oder steuere Retries über das Delivery-Log.
