...
Hat die Eigentümerin oder der Eigentümer Wiki-Leserechte, beginnt jeder Lauf mit dem begrenzten ersten Abschnitt des konventionellen Einstiegs `AGENTS.md`, sofern vorhanden, sowie einem kompakten Katalog aktueller [Workspace-Wiki-Seiten](/docs/mcp#gemeinsames-workspace-wiki). Die Routine folgt relevanten stabilen Links und liest die benötigten Dokumente. Die Einstiegsseite ist Referenzmaterial und kann die Berechtigungen der Routine nicht erweitern. Halte gemeinsame Unternehmensfakten, Tonalität, Abläufe und Support-Vorgaben dort fest, statt sie in jede Routine zu kopieren. Wiki-Seiten anzulegen oder zu bearbeiten erfordert Wiki-Verwaltungsrechte der Eigentümerin oder des Eigentümers.
