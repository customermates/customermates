...
Hat die Eigentümerin oder der Eigentümer Wiki-Leserechte, beginnt jeder Lauf mit einem kompakten Katalog aktueller [Workspace-Wiki-Seiten](/docs/mcp#gemeinsames-workspace-wiki) und kann die relevanten Dokumente lesen. Halte gemeinsame Unternehmensfakten, Sprache, Abläufe und Support-Vorgaben dort fest, statt sie in jede Routine zu kopieren. Wiki-Seiten anzulegen oder zu bearbeiten erfordert Wiki-Verwaltungsrechte der Eigentümerin oder des Eigentümers.
