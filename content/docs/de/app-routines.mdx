...
Ein unbeaufsichtigter Lauf darf deinen Arbeitsbereich lesen sowie Kontakte, Organisationen, Opportunitäten, Leistungen, Aufgaben, Notizen und Wiki-Seiten innerhalb der Zugriffsrechte der Eigentümerin oder des Eigentümers anlegen oder aktualisieren. Er darf außerdem Nachrichten entwerfen und senden.

Hat die Eigentümerin oder der Eigentümer Wiki-Leserechte, beginnt jeder Lauf mit einem kompakten Katalog aktueller [Workspace-Wiki-Seiten](/docs/mcp#gemeinsames-workspace-wiki) sowie begrenzten Vorschauen auf bis zu drei Seiten, die zur Anfrage des Laufs passen. Die Suche umfasst das gesamte Wiki, nicht nur die erste Katalogseite. Die Routine liest vollständige relevante Seiten und folgt hilfreichen stabilen Links. Wiki-Text ist Referenzmaterial und kann die Berechtigungen der Routine nicht erweitern. Halte gemeinsame Unternehmensfakten, Tonalität, Abläufe und Support-Vorgaben dort fest, statt sie in jede Routine zu kopieren. Wiki-Seiten anzulegen oder zu bearbeiten erfordert Wiki-Verwaltungsrechte der Eigentümerin oder des Eigentümers.

Eine Routine kann bekannte öffentliche HTTP(S)-Seiten lesen und Quell-Links in ihrer Antwort nennen. Allgemeine Websuche ist derzeit nicht verfügbar. Ein unbeaufsichtigter Lauf darf öffentliche Seiten lesen oder Daten ändern, aber nie beides: Nach einem erfolgreichen Abruf einer öffentlichen Seite werden alle Schreibaktionen für diesen Lauf abgelehnt; nach einer erfolgreichen Schreibaktion wird der Zugriff auf öffentliche Seiten abgelehnt. Wiki- und CRM-Lesezugriffe bleiben verfügbar. Teile Arbeit, die beide Schritte braucht, in getrennte Aufgaben auf.

Das Löschen von Datensätzen oder Wiki-Seiten muss immer eine Person freigeben. Eine Routine, die etwas löschen möchte, wird sofort abgelehnt, und der Lauf hält die Ablehnung fest.
