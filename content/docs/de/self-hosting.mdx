...
| KI-Zugriff | Gehosteter Assistent mit Credits plus externes MCP | Externes MCP mit eigenem Anbieter; kein gehosteter Assistent |
...
**Kostenform:** Cloud ist pro Nutzer über Tarife bepreist, ab [[commercial.price.starter.monthly]]/Nutzer/Monat; Messaging-Kapazität und Kontingente des gehosteten Assistenten wachsen mit dem Tarif. Self-Host ist kostenlos für die Kernanwendung plus Infrastruktur und Ihren eigenen KI-Anbieter. Für ein kleines Team ist Cloud oft günstiger, wenn Sie die Zeit fürs eigene Postgres-Backup einrechnen. Für ein größeres Team ist Self-Host meist die günstigere Variante.
