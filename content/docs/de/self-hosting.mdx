...
URL öffnen. Mit E-Mail registrieren, Verifizierungs-Link aus dem Postfach klicken, dann Workspace-Namen wählen. Dieser erste Account erhält die eingebaute Rolle **Admin**. Teammitglieder laden Sie unter **Mein Unternehmen › Mitglieder** mit **Hinzufügen** ein, und was sie dürfen, legen Sie unter **Mein Unternehmen › Rollen** fest; siehe [Mein Unternehmen](/docs/app-company).
</Step>
...
**Mein Profil › API & Konnektoren**, dann **Hinzufügen**. Genau wie in der Cloud. Siehe [API-Keys](/docs/api-keys).
</Step>
</Steps>
...
Ein Self-Hosted-Workspace hat weder Abonnement noch Testphase: Er startet aktiv, und in der App wird nichts abgerechnet. Die Seitenleiste zeigt deshalb unter **Mein Unternehmen** keinen Eintrag **Abonnement**, unter **Mein Profil** keinen Eintrag **Kanäle** und weder **Posteingang** noch **Routinen**, und der Rolleneditor unter **Mein Unternehmen › Rollen** blendet die Zeilen **Inbox-Nachrichten** und **Routinen** aus. Wer eine dieser Seiten per URL öffnet, landet wieder auf dem Dashboard.
