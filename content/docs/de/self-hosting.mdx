...
- `TRIGGER_SECRET_KEY` und `TRIGGER_PROJECT_REF`: ein kostenloses [Trigger.dev](https://trigger.dev)-Projekt. Wird für Webhook-Deliveries und Lifecycle-Jobs im Hintergrund benötigt.
...
Hintergrund-Jobs (Webhook-Deliveries, Trial-Lifecycle) laufen auf Trigger.dev. Runs im Trigger.dev-Dashboard einsehen.
