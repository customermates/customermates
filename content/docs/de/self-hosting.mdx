...
Beide betreiben dieselbe Kernanwendung. Das gemeinsame Postfach, Kalender-Sync, Audit-Logging, Enterprise-SSO und White-Labeling sind Enterprise-Edition-Features (die `ee/`-Komponenten). In der Cloud sind sie Teil der Tarife: Postfach und Kalender-Sync ab dem Pro-Tarif, Audit-Logging in jedem Cloud-Tarif, SSO und White-Label im Enterprise-Tarif. Der kostenlose Community-Self-Host-Build enthält das volle Kern-CRM ohne die Enterprise-Edition-Features; für ein Self-Hosted-Deployment mit diesen Features kontaktieren Sie uns für eine Enterprise-Edition-Vereinbarung. Anmeldung per Google- und Microsoft-OAuth gibt es in der Cloud; Self-Hosted-Installationen melden sich per E-Mail an.
...
| Audit-Log | in jedem Plan enthalten | Enterprise-Vereinbarung |
| Enterprise-Features (Enterprise-SSO, White-Label) | Enterprise-Plan | Enterprise-Vereinbarung |
| Google-/Microsoft-OAuth-Anmeldung | ✓ | E-Mail-Anmeldung |
...
Das gemeinsame Postfach, Kalender-Sync, Audit-Logging, Enterprise-SSO und White-Labeling sind Enterprise-Edition-Features (die `ee/`-Komponenten). In der Cloud sind sie Teil der Tarife: Postfach und Kalender ab Pro, Audit-Logging in jedem Tarif, SSO und White-Label im Enterprise-Tarif. Der kostenlose Community-Self-Host-Build enthält sie nicht. Wenn Sie diese Features auf eigener Infrastruktur benötigen, kontaktieren Sie uns für eine Enterprise-Edition-Vereinbarung.
