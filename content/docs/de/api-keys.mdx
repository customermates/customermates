...
API-Keys authentifizieren Clients für das Model Context Protocol (MCP) und die REST-API gegen dein Customermates-CRM. Ein Key pro Client (Claude, ChatGPT, Zapier etc.), in einer Umgebungsvariable speichern, rotieren, wenn ein Gerät kompromittiert ist oder ein Teammitglied geht.
