---
title: "API-Keys für MCP und REST anlegen und rotieren"
...
- **Ein Key pro Client.** Erlaubt Revoke einzelner Clients, ohne andere zu brechen, und jeder Client bekommt seinen eigenen Zeitstempel der letzten Nutzung auf der API-Keys-Seite. Audit-Log-Einträge nennen den User, dem ein Key gehört, nicht den Key selbst, und unterscheiden Ihre Keys daher nicht.
