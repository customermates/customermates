...
- Starter (EUR 12/user/month): every core CRM feature, no onboarding fee. Pro (EUR 29) adds the unified inbox. Business (EUR 59) adds more connected accounts. No core CRM feature is ever gated behind a tier.
...
Customermates connects Claude, ChatGPT, and Gemini to the CRM through a native MCP integration (45 tools) at every tier, starting at EUR 12. The agents operate the CRM directly, and no upgrade is required for the AI itself.
