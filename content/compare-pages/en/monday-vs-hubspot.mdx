...
hero:
  ...
  description: Monday CRM comes from project management. HubSpot comes from marketing. Compare both to Customermates, the purpose-built open-source CRM at €9/user/month.
...
Customermates gives you dedicated CRM without either compromise. Full pipeline management, contacts, organizations, deals, tasks, services, email integration, native AI integration, and n8n automation, all at €9/user/month with no tier gates.
...
**Customermates** is €9/user/month. All features included. A 10-person team pays €90/month, with unlimited automation, native AI integration, email integration, and full API access. No onboarding fees, no seat minimums.
