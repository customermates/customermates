...
hero:
  ...
  description: Monday CRM comes from project management. HubSpot comes from marketing. Compare both to Customermates, the purpose-built open-source CRM with transparent tiers from €12/user/month.
...
**Customermates** starts at €12/user/month (Starter), with every core CRM feature included. A 10-person team pays €120/month on Starter, with unlimited automation, MCP access for external AI clients, and full API access. No onboarding fees, no seat minimums. Pro (€29) and Business (€69) add the unified inbox across email, LinkedIn, WhatsApp, Instagram, and Telegram for teams that need it.
