...
hero:
  ...
  description: Pipedrive is a sales-first CRM. Monday is project management with CRM bolted on. Compare both to Customermates, the open-source alternative with EU hosting at €9/user/month.
...
**Customermates**: €9/user/month for everything. A 10-person team pays €90/month. No add-ons, no deal limits, no automation caps, no seat minimums.
