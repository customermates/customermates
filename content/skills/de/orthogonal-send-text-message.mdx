...
description: Send SMS text messages to phone numbers. Use when you need to text someone, message a phone number, or send a notification via text message.
tags:
  - outreach
  - phone
sourceUrl: https://www.orthogonal.com/skills/orthogonal/send-text-message
---
