...
The Customer grants the Provider a general written authorization to engage subprocessors. The Provider maintains a current list of its subprocessors, including their identity, purpose, and location, at [Subprocessors](/subprocessors), which is incorporated into this DPA by reference.
