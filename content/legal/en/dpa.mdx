...
_Version 1.0, last updated 6 August 2026; effective for each Customer when concluded under Section 2_
...
**Forward Email, LLC** is not used for the connected-account feature or ordinary CRM processing. Where the Customer attaches or reproduces personal data covered by this DPA in a support or feedback request delivered to the Provider's operator inbox, Forward Email processes that fragment as a subprocessor. For ordinary account and business correspondence, it supports processing for which the Provider is an independent controller and which is outside this DPA. The unresolved contract and transfer status for Forward Email is stated at [Subprocessors](/subprocessors); disclosure of that gap does not replace the contract required by the preceding paragraph.
