...
The consent choice remains valid until its stated expiry or withdrawal. If no click identifier is currently stored, one identifier from a later eligible Google Ads visit during that period may be stored without presenting the choice again; an existing identifier is never replaced.
