...
Before the assistant is made available, we will conclude a data processing agreement with OpenAI pursuant to Art. 28 GDPR and OpenAI is already listed in advance at [Subprocessors](/subprocessors) under the notice procedure set out in our [Data Processing Agreement](/dpa), marked as planned and not yet in use. According to OpenAI, data transmitted through its API is not used to train its own models. Further information:
