...
Reporting is not automatic, and it has not begun. Reporting would mean a person at Customermates generating an export from the records described above and submitting it to the platform's own conversion-import interface. No such route exists today for Google Ads, ChatGPT Ads, Reddit Ads or LinkedIn Ads, and nothing has been transmitted to any of them. Identifiers captured now are deleted at the end of their retention period unless a route is built before then. Before we begin reporting to any platform, we update this notice and ask you for your decision again.
