...
Incoming and outgoing e-mail is handled by the providers named in section 2, Forward Email for incoming e-mail and Resend for outgoing e-mail. We have concluded a data processing agreement (DPA) with each of them. This is a contract required by data protection law, which ensures that these parties process the personal data contained in your request only according to our instructions and in compliance with the GDPR.
