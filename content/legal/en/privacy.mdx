...
We use Vercel Web Analytics, a usage measurement service of Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA (hereinafter "Vercel"). Vercel Web Analytics is active on all pages of our website and of the web application, including the pages available after login.
...
The data transfer to the USA is based on the standard contractual clauses of the EU Commission. Vercel is additionally certified under the "EU-US Data Privacy Framework" (DPF). Further details can be found in Vercel's privacy policy: https://vercel.com/legal/privacy-policy.
