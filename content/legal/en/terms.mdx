...
Where the customer uses the optional connected-account features, the customer warrants that it is authorized to connect the relevant email, messaging, and calendar accounts and to process the communications, contacts, and third-party personal data that are accessed or transmitted through them. The customer is responsible for complying with the applicable terms, policies, and usage restrictions of the underlying third-party platforms, and undertakes to use these features only for lawful purposes, in particular in compliance with applicable anti-spam and communications law, and to keep account credentials and access secure. Where the software performs automated actions on connected accounts, the customer is responsible for appropriate human oversight and safeguards, including pre-activation review, ongoing monitoring, and confirmation controls appropriate to the risk.

Where the customer uses Mate, it must ensure that it is authorised to include the prompt and any CRM or connected-account content used for the requested task. Each person who uses Mate must be at least 16 years old or the minimum age required in that person's country to consent to use the service. A person under 18 may use Mate only with permission from a parent or legal guardian. The customer may make personal data in authorised prompts, CRM records, and connected-account content available to Mate only where necessary for the requested task. The customer must ensure an applicable legal basis, purpose limitation, transparency, data minimisation, access restrictions, and safeguards appropriate to the risk. Before making special categories of personal data under Art. 9 GDPR, data relating to criminal convictions and offences under Art. 10 GDPR, financial-account information, or government-issued identifiers available to Mate, the customer must satisfy every additional legal requirement applicable to that data and restrict the data and access to what is necessary. For interactive use, the customer must review generated output and proposed actions for accuracy, appropriateness, and legal compliance before relying on the output or confirming an action. The customer must not use Mate for prohibited or unlawful purposes. Mate and any output about a person must not be used for any purpose that could have a legal or material impact on that person, including decisions concerning credit, education, employment, housing, insurance, legal matters, or medical matters. A confirmation control supports review but does not transfer the customer's responsibility for the instruction or the resulting use of its data.

Where the managed service offers **Routines** or other saved or automated Mate runs, an authorised user may configure and activate a saved instruction for manual execution or execution on a schedule or configured in-product event, including an event arising from CRM activity or connected-account synchronisation. Configuration and activation constitute the customer's standing documented instruction for each resulting run until the Routine is disabled or materially changed. Before activation or a material change, the customer must review the instruction, owner, trigger, data scope, permissions, limits, possible side effects, and safeguards, and must monitor operation and results. Actions permitted by the applicable permissions and confirmation controls may occur without separate case-by-case confirmation. The customer must ensure that every person whom it authorises to use Mate or configure a Routine complies with these restrictions.
