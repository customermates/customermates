...
In the same way, the Provider is not liable for disruptions, failures, restrictions, or delayed or incomplete data caused by the transport provider Unipile SAS or by the underlying third-party platforms used for the connected-account features, to the extent these lie outside the Provider's sphere of influence. This limitation does not apply to, and the mandatory statutory liability remains unaffected in cases of, injury to life, body, or health; intent and gross negligence; the culpable breach of essential contractual obligations (cardinal obligations); and any other liability that cannot be excluded or limited by agreement. {/* REVIEWER: enforceability of this limitation under BGB §§ 276(3),307,310 to be confirmed by counsel; do not exclude non-waivable liabilities. */}
