...
The Provider is not itself a payment service provider. All payments are made through the external Payment Service Provider Sold through Link, LLC (formerly Lemon Squeezy LLC).
