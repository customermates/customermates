...
Dieser AVV wird in elektronischer Form im Sinne von Art. 28 Abs. 9 DSGVO geschlossen, indem der Kunde den Hauptvertrag bei der Registrierung akzeptiert, und gilt in der zu diesem Zeitpunkt geltenden Fassung. Auf Anfrage stellt der Anbieter dem Kunden eine Kopie dieses AVV in Textform zur Verfügung.
...
- Supportanfragen und die zugehörige Korrespondenz;
...
{/* BLOCKER: den Unipile-AVV nach Art. 28 vor der Veröffentlichung abschließen; dieser Abschnitt setzt voraus, dass er in Kraft ist. */}

Für die Speicherung der im Auftrag des Kunden verarbeiteten personenbezogenen Daten bindet der Anbieter **Neon, LLC**, ein verbundenes Unternehmen der Databricks, Inc. (https://neon.com), als Unterauftragsverarbeiter für den Betrieb der verwalteten PostgreSQL-Datenbank ein. Die Produktivdatenbank des Anbieters wird innerhalb der Europäischen Union (Frankfurt am Main) betrieben. Neon, LLC hat ihren Sitz in einem Drittland und setzt dort Unterauftragsverarbeiter ein; der auf sie anwendbare Übermittlungsmechanismus ist unter [Unterauftragsverarbeiter](/subprocessors) angegeben.

Der Anbieter informiert den Kunden über jede beabsichtigte Hinzuziehung oder Ersetzung eines Unterauftragsverarbeiters mindestens 30 Tage, bevor dieser Unterauftragsverarbeiter mit der Verarbeitung personenbezogener Daten im Auftrag des Kunden beginnt. Der Kunde kann der Änderung innerhalb von 14 Tagen nach dieser Mitteilung in Textform aus berechtigten datenschutzrechtlichen Gründen widersprechen. Widerspricht der Kunde und können die Parteien den Widerspruch nicht ausräumen, kann der Kunde den betroffenen Dienst nach Maßgabe des Hauptvertrags kündigen.
...
Die Löschung erfolgt unverzüglich, spätestens jedoch innerhalb von 90 Tagen, einschließlich der in Sicherungskopien enthaltenen Kopien nach Maßgabe von deren Ablauf. Die Rückgabe der Daten bei Beendigung des Hauptvertrags erfolgt nach Maßgabe der Bestimmungen des Hauptvertrags zur Datenübergabe.
...
{/* TODO: Herstellerangabe; Speicherorte und etwaige Übermittlungen außerhalb des EWR (Unipiles Unterauftragsverarbeiter-Liste enthält das US-Unternehmen Stripe) vor der Veröffentlichung anhand des abgeschlossenen AVV und der aktuellen Unterauftragsverarbeiter-Liste bestätigen. */}

{/* TODO: Bestätigen, welcher Übermittlungsmechanismus je Unterauftragsverarbeiter gilt (Standardvertragsklauseln / Angemessenheitsbeschluss / DPF), die einschlägigen SCC-Module und eine etwaige Transfer-Folgenabschätzung beifügen und dies mit der /subprocessors-Liste und der Datenschutzerklärung konsistent halten. */}
