...
Die Funktion für verbundene Konten wird durch den Transportdienstleister UNIPILE SAS bereitgestellt, der nach Ziffer 9 als Unterauftragsverarbeiter eingebunden ist. Die Authentifizierung erfolgt über eine von Unipile gehostete Authentifizierungsseite, auf der der Nutzer des Kunden die Zugangsdaten des betreffenden Kontoanbieters eingibt oder den OAuth-Ablauf des jeweiligen Kontoanbieters durchläuft. Die Passwörter und OAuth-Token der Kontoanbieter werden von Unipile verwahrt; der Anbieter erhält und speichert sie nicht und behält lediglich eine opake Konto-Kennung sowie nicht geheime Konto-Metadaten.
