...
Der verwaltete Cloud-Dienst kann den optionalen KI-Assistenten Mate umfassen. Mate leitet Modellanfragen über den Vercel AI Gateway an den ausgewählten nachgelagerten Modellanbieter weiter, der unter [Unterauftragsverarbeiter](/subprocessors) benannt ist, und hängt von einem geeigneten Tarif, verfügbaren KI-Credits, den globalen Betriebssteuerungen des Anbieters sowie der Verfügbarkeit und den Richtlinien des Gateways und des nachgelagerten Modellanbieters ab. Mate erzeugt Ausgaben automatisiert. Ausgaben können unrichtig, unvollständig oder für den beabsichtigten Zweck ungeeignet sein und stellen keine professionelle Rechts-, Steuer-, Medizin- oder Finanzberatung dar. Es gelten die vorhandenen Kontoberechtigungen; vor einer Handlung mit wesentlichen Nebenwirkungen kann das Produkt eine gesonderte Bestätigung verlangen. Die vorstehende Verfügbarkeitszusage erstreckt sich nicht auf Unterbrechungen, Beschränkungen oder Grenzen der Ausgabe, die durch das KI-Gateway oder den Modellanbieter verursacht werden.
...
Nutzt der Kunde die optionalen Funktionen für verbundene Konten, sichert er zu, dass er berechtigt ist, die betreffenden E-Mail-, Messaging- und Kalenderkonten anzubinden und die darüber abgerufenen oder übermittelten Kommunikationsinhalte, Kontakte und personenbezogenen Daten Dritter zu verarbeiten. Der Kunde ist für die Einhaltung der jeweils geltenden Bedingungen, Richtlinien und Nutzungsbeschränkungen der zugrunde liegenden Drittplattformen verantwortlich und verpflichtet sich, diese Funktionen ausschließlich zu rechtmäßigen Zwecken zu nutzen, insbesondere im Einklang mit dem geltenden Anti-Spam- und Kommunikationsrecht, sowie Zugangsdaten und Zugänge sicher zu verwahren. Führt die Software automatisierte Aktionen auf verbundenen Konten aus, ist der Kunde für eine dem Risiko angemessene menschliche Aufsicht und angemessene Schutzvorkehrungen verantwortlich, einschließlich einer Prüfung vor der Aktivierung, einer laufenden Überwachung und risikogerechter Bestätigungssteuerungen.

Nutzt der Kunde Mate, muss er sicherstellen, dass er berechtigt ist, die Eingabe und alle für die angeforderte Aufgabe verwendeten CRM- oder verbundenen Kontoinhalte einzubeziehen. Jeder Nutzer von Mate muss mindestens 16 Jahre alt sein oder das in seinem Land für die Einwilligung in die Nutzung des Dienstes erforderliche Mindestalter erreicht haben. Ein Nutzer unter 18 Jahren darf Mate nur mit Erlaubnis eines Elternteils oder gesetzlichen Vertreters verwenden. Der Kunde darf Mate personenbezogene Daten aus berechtigten Eingaben, CRM-Datensätzen und verbundenen Kontoinhalten nur zugänglich machen, soweit dies für die angeforderte Aufgabe erforderlich ist. Der Kunde muss eine anwendbare Rechtsgrundlage, Zweckbindung, Transparenz, Datenminimierung, Zugriffsbeschränkungen und dem Risiko angemessene Schutzvorkehrungen sicherstellen. Bevor der Kunde besondere Kategorien personenbezogener Daten nach Art. 9 DSGVO, Daten über strafrechtliche Verurteilungen und Straftaten nach Art. 10 DSGVO, Finanzkontoinformationen oder von Behörden ausgestellte Identifikationsmerkmale Mate zugänglich macht, muss er sämtliche für diese Daten geltenden zusätzlichen gesetzlichen Voraussetzungen erfüllen und die Daten und Zugriffe auf das Erforderliche beschränken. Bei interaktiver Nutzung muss der Kunde erzeugte Ausgaben und vorgeschlagene Handlungen auf Richtigkeit, Angemessenheit und Rechtmäßigkeit prüfen, bevor er sich auf die Ausgabe verlässt oder eine Handlung bestätigt. Der Kunde darf Mate nicht für verbotene oder rechtswidrige Zwecke verwenden. Mate und Ausgaben über eine Person dürfen nicht für einen Zweck verwendet werden, der rechtliche oder wesentliche Auswirkungen auf diese Person haben könnte, insbesondere nicht für Entscheidungen über Kredit, Bildung, Beschäftigung, Wohnraum, Versicherung, Rechtsangelegenheiten oder medizinische Angelegenheiten. Eine Bestätigungssteuerung unterstützt die Prüfung, überträgt aber nicht die Verantwortung des Kunden für die Weisung oder die anschließende Nutzung seiner Daten.

Soweit der verwaltete Dienst **Routines** oder andere gespeicherte oder automatisierte Mate-Durchläufe anbietet, kann ein berechtigter Nutzer eine gespeicherte Weisung zur manuellen Ausführung oder zur Ausführung nach einem Zeitplan oder einem konfigurierten produktinternen Ereignis konfigurieren und aktivieren; hierzu gehören auch Ereignisse aus CRM-Aktivitäten oder der Synchronisierung verbundener Konten. Konfiguration und Aktivierung gelten als dokumentierte Dauerweisung des Kunden für jeden daraus entstehenden Durchlauf, bis die Routine deaktiviert oder wesentlich geändert wird. Vor der Aktivierung oder einer wesentlichen Änderung muss der Kunde Weisung, zugeordneten Nutzer, Auslöser, Datenumfang, Berechtigungen, Grenzen, mögliche Nebenwirkungen und Schutzvorkehrungen prüfen und Betrieb und Ergebnisse überwachen. Handlungen, die nach den anwendbaren Berechtigungen und Bestätigungssteuerungen zulässig sind, können ohne gesonderte Bestätigung im Einzelfall erfolgen. Der Kunde muss sicherstellen, dass jede Person, die er zur Nutzung von Mate oder zur Konfiguration einer Routine berechtigt, diese Beschränkungen einhält.
...
Nutzt der Kunde Mate mit CRM- oder verbundenen Kontoinhalten, verarbeitet der Anbieter diese Inhalte nach den dokumentierten Weisungen des Kunden unter demselben Auftragsverarbeitungsvertrag und leitet den erforderlichen Anfragekontext über den Vercel AI Gateway an den ausgewählten nachgelagerten Modellanbieter weiter, der unter [Unterauftragsverarbeiter](/subprocessors) benannt ist. Die aktuelle Anbieterkette, Datenkategorien, Aufbewahrung und Angaben zu Übermittlungen sind in der [Datenschutzerklärung](/privacy), im [Auftragsverarbeitungsvertrag](/dpa) und unter [Unterauftragsverarbeiter](/subprocessors) beschrieben.
