...
Der Anbieter stellt dem Kunden die Software zur Nutzung über das Internet zur Verfügung. Das Angebot richtet sich ausschließlich an Unternehmer im Sinne von § 14 BGB, an juristische Personen des öffentlichen Rechts und an öffentlich-rechtliche Sondervermögen; die Nutzung erfolgt ausschließlich zu Zwecken der gewerblichen oder selbständigen beruflichen Tätigkeit des Kunden. Der Anbieter ist berechtigt, einen Nachweis der Unternehmereigenschaft zu verlangen und den Vertrag außerordentlich zu kündigen, wenn der Kunde tatsächlich als Verbraucher handelt.
...
Auf Verlangen des Kunden in Textform, das während der Vertragslaufzeit oder innerhalb von 30 Tagen nach Vertragsende gestellt wird, stellt der Anbieter die im Auftrag des Kunden verarbeiteten Daten in einem strukturierten, gängigen und maschinenlesbaren Format (CSV oder JSON) unentgeltlich und innerhalb von 30 Tagen nach dem Verlangen bereit. Nur für darüber hinausgehende, individuell angeforderte Migrationsleistungen berechnet der Anbieter nach vorheriger Vereinbarung in Textform seine jeweils gültigen Stundensätze. Nach Ablauf dieser Frist und im Übrigen nach Maßgabe von Ziffer 11 des Auftragsverarbeitungsvertrags löscht der Anbieter die gespeicherten Daten, soweit keine gesetzliche Aufbewahrungspflicht besteht.
...
Ebenso haftet der Anbieter nicht für Störungen, Ausfälle, Beschränkungen oder verzögerte oder unvollständige Daten, die durch den Transportdienstleister Unipile SAS oder durch die für die Funktionen für verbundene Konten genutzten zugrunde liegenden Drittplattformen verursacht werden, soweit diese außerhalb des Einflussbereichs des Anbieters liegen.
...
Der Anbieter kann diese AGB mit Wirkung für die Zukunft ändern, soweit dies erforderlich ist, um sie an eine geänderte Rechtslage, an höchstrichterliche oder behördliche Entscheidungen, an eine Änderung der eingesetzten Unterauftragsverarbeiter oder an eine technische Weiterentwicklung des Dienstes anzupassen, und soweit die Änderung den Kunden nicht unangemessen benachteiligt. Nicht auf diesem Weg geändert werden können die Hauptleistungspflichten der Parteien, die Vergütung (Ziffer 4), die Vertragslaufzeit und die Kündigungsregelungen (Ziffer 5) sowie die Haftungsregelungen (Ziffer 9). Änderungen des Auftragsverarbeitungsvertrags richten sich ausschließlich nach dessen eigenen Bestimmungen. Änderungen werden dem Kunden mindestens 2 Wochen vor ihrem Inkrafttreten in Textform zusammen mit der geänderten Fassung mitgeteilt.

Widerspricht der Kunde der Änderung nicht innerhalb von 2 Wochen nach Zugang der Mitteilung in Textform, gilt die Änderung als angenommen. Der Anbieter weist den Kunden in der Änderungsmitteilung gesondert und in hervorgehobener Form darauf hin, dass sein Schweigen als Zustimmung zu der Änderung gilt, welche Frist hierfür gilt und dass er widersprechen kann. Widerspricht der Kunde, kann jede Partei den Vertrag mit Wirkung zum Zeitpunkt des Inkrafttretens der Änderung kündigen; bis zur Beendigung gilt die bisherige Fassung fort.

## 11. Zahlungsdienstleister

Der Anbieter ist nicht selbst Zahlungsdienstleister. Sämtliche Zahlungen erfolgen über den externen Zahlungsdienstleister Sold through Link, LLC (vormals Lemon Squeezy LLC).
