...
_Version 2026-08-26, Stand 26. August 2026_
...
Wir nutzen Vercel Web Analytics, einen Dienst zur Nutzungsmessung der Vercel Inc., 440 N Barranca Ave #4133, Covina, CA 91723, USA (nachfolgend „Vercel“). Im verwalteten Cloud-Dienst wird die Analyse-Komponente auf Seiten der Website und Webanwendung, einschließlich der nach der Anmeldung verfügbaren Seiten, erst geladen, nachdem die Analyse-Kategorie akzeptiert wurde. Im Self-Hosted-Modus lädt die vorgelagerte Anwendung sie nicht.
...
Der Einsatz von Vercel Web Analytics beruht auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie können sie jederzeit über die Datenschutz-Auswahl widerrufen; nach dem Neuladen wird die Analyse-Komponente künftig nicht mehr geladen. Nach Angaben von Vercel verwendet dieser Analysedienst keine Cookies und speichert zu Analysezwecken keine Informationen auf Ihrem Endgerät und greift nicht darauf zu.
...
Der verwaltete Customermates-Dienst lädt oder initialisiert dieses Affiliate-Skript derzeit nicht; auch im Self-Hosted-Modus lädt die vorgelagerte Anwendung es nicht. Customermates verwendet das Skript daher weder zum Lesen eines `ls_aff_ref`-Cookies noch zur Erstellung eines Browser-Fingerabdrucks, zum Setzen eines Affiliate-Cookies oder zum Senden von Affiliate-Zuordnungsdaten. Die Integration bleibt deaktiviert, weil die vertragliche Rolle von Lemon Squeezy, der geltende Übermittlungsmechanismus und die shopspezifische Cookie-Laufzeit für unser Konto noch nicht geprüft wurden. Sie darf erst aktiviert werden, nachdem diese Fragen und die erforderliche Einwilligungsgestaltung geprüft wurden. Ein unabhängiger Self-Host-Betreiber kontrolliert seine eigene Bereitstellung und ist für jede von ihm hinzugefügte Integration selbst verantwortlich.
