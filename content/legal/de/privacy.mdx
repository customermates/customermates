...
### Forward Email (Weiterleitung betrieblicher E-Mails)

Für eingehende E-Mails an unsere eigenen betrieblichen Adressen unter `@customermates.com` nutzen wir Forward Email, LLC, 16192 Coastal Hwy, Lewes, DE 19958, USA (https://forwardemail.net). Forward Email stellt die technische Infrastruktur bereit, über die diese Nachrichten verarbeitet und an unser Betreiberpostfach weitergeleitet werden. Der Dienst wird nicht zur Verbindung von Kundenpostfächern, Messaging-Konten oder Kalendern eingesetzt und erhält gewöhnlich keine CRM-Datensätze. Nach Angaben von Forward Email werden Nachrichtentexte und Anhänge im Arbeitsspeicher weitergeleitet und nicht dauerhaft gespeichert. Bei fehlgeschlagenen Zustellungen mit Status 4xx oder 5xx speichert der Anbieter Fehlerprotokolle sieben Tage lang; diese können den SMTP-Fehler, Umschlagdaten, Nachrichtenkopfzeilen sowie IP-Adresse oder Hostname des sendenden Servers enthalten.

Im Rahmen dieser Weiterleitung können personenbezogene Daten über die Server von Forward Email laufen. Dazu zählen Absender- und Empfängeradressen, Nachrichteninhalte, Meta- und Kommunikationsdaten sowie technisch erforderliche Anhänge. Gewöhnlich handelt es sich um betriebliche Korrespondenz auf der Verantwortlichenebene. Nimmt ein Kunde von unserem Auftragsverarbeitungsvertrag erfasste personenbezogene Daten in eine Support- oder Feedbackanfrage auf, verarbeitet Forward Email zusätzlich diesen begrenzten Ausschnitt innerhalb unserer Unterauftragsverarbeitungskette.

Forward Email verarbeitet diese Daten in unserem Auftrag. Der veröffentlichte Auftragsverarbeitungsvertrag bestimmt, dass er erst beginnt, wenn Anbieter und Kunde ein Deckblatt vereinbaren und den Vertrag unterzeichnen oder elektronisch annehmen. Wir haben kein solches Deckblatt vereinbart und behandeln die veröffentlichten Bedingungen daher nicht als wirksamen Vertrag gemäß Art. 28 DSGVO für unser Konto. Rechtsgrundlagen unserer Verarbeitung sind Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer sicheren und zuverlässigen E-Mail-Infrastruktur) sowie, soweit für ein Vertragsverhältnis erforderlich, Art. 6 Abs. 1 lit. b DSGVO.

Da Forward Email Server in den USA betreibt, werden personenbezogene Daten in ein Drittland übermittelt. Der veröffentlichte Vertrag des Anbieters bezieht die EU-Standardvertragsklauseln ein; die erforderlichen Anlagen stehen jedoch in einem Deckblatt, das nur im Enterprise-Angebot verfügbar ist. Wir stützen uns daher nicht auf diese Klauseln als vollständigen Übermittlungsmechanismus. Verschlüsselung, die Weiterleitung von Nachrichtentexten und Anhängen im Arbeitsspeicher und die siebentägige Speicherung von Fehlerprotokollen fehlgeschlagener Zustellungen begrenzen die Exposition, ersetzen aber weder einen wirksamen Vertrag nach Art. 28 DSGVO noch einen Übermittlungsmechanismus nach Kapitel V DSGVO.

Weitere Informationen zum Datenschutz bei Forward Email finden Sie unter: https://forwardemail.net/en/privacy

### Vertragsstatus

Für unser Konto besteht mit Forward Email weder ein wirksamer Auftragsverarbeitungsvertrag nach Art. 28 DSGVO noch ein vollständiger Übermittlungsmechanismus nach Kapitel V DSGVO. Für die gegenwärtige Verarbeitung bestehen daher ungeklärte Vertrags- und Übermittlungslücken, die behoben werden müssen; die vorstehend beschriebenen technischen Maßnahmen schließen diese Lücken nicht.
...
Eingehende E-Mails an unsere eigenen betrieblichen Adressen unter `@customermates.com` werden durch Forward Email an unser Betreiberpostfach weitergeleitet. Resend versendet die von der Anwendung erzeugten automatisierten Transaktions- und Konto-E-Mails; gewöhnliche persönliche Antworten aus dem Betreiberpostfach werden durch den für dieses Konto ausgewählten Postfachanbieter verarbeitet. Die Verarbeitung durch Resend ist in einem Auftragsverarbeitungsvertrag gemäß Art. 28 DSGVO geregelt. Der ungeklärte Vertrags- und Übermittlungsstatus von Forward Email ist in Abschnitt 2 beschrieben; wir stellen nicht dar, dass hierfür derzeit ein wirksamer Vertrag nach Art. 28 DSGVO gilt.
