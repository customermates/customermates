...
Eine noch nicht abgelaufene Auswahl „Erlauben“ bleibt gültig, bis Sie sie widerrufen oder bis wir diesen Hinweis ändern; ein späterer zulässiger Besuch wird ohne erneute Anzeige der Auswahl gespeichert. Ändern wir diesen Hinweis, gilt Ihre frühere Entscheidung als nicht erteilt: Die gespeicherten Kennungen werden nicht mehr verwendet und Sie werden erneut gefragt. Da jede Werbeplattform eine Conversion nur der von ihr selbst ausgegebenen Kennung zuordnet, ersetzt ein späterer Klick derselben Plattform den früheren Klick dieser Plattform; Kennungen anderer Plattformen bleiben unberührt.
...
Die Rückmeldung erfolgt nicht automatisch, und sie hat noch nicht begonnen. Eine Rückmeldung würde bedeuten, dass eine Person bei Customermates aus den vorstehend beschriebenen Aufzeichnungen einen Export erzeugt und ihn der Conversion-Import-Schnittstelle der jeweiligen Plattform übergibt. Für Google Ads kann Customermates diesen Export erzeugen, in dem Format, das der Conversion-Import von Google annimmt. Für ChatGPT Ads, Reddit Ads und LinkedIn Ads kann es das nicht: Diese Plattformen nehmen Conversions ausschließlich über Programmierschnittstellen entgegen, die Customermates nicht gebaut hat. An keine der vier Plattformen wurde ein Export übergeben, keine Werbeplattform hat aus dieser Funktion etwas erhalten, und keine unserer Anzeigen ist bisher gelaufen. Die jetzt erfassten Kennungen werden nach Ablauf ihrer Speicherfrist gelöscht, sofern nicht zuvor eine Meldung erfolgt. Bevor wir mit der Meldung an eine Plattform beginnen, aktualisieren wir diesen Hinweis und fragen Sie erneut nach Ihrer Entscheidung.

Eine Meldung wird die von der Plattform selbst ausgegebene Kennung enthalten, die Bezeichnung des Ergebnisses („Customermates signup“ oder „Customermates paid“), dessen Zeitpunkt, eine Referenz zur Vermeidung doppelter Zählung sowie die beiden Einwilligungssignale, die Google mit jeder importierten Conversion verlangt („Ad User Data“, auf erteilt gesetzt, und „Ad Personalization“, auf verweigert gesetzt, weil dieser Hinweis nicht um personalisierte Werbung bittet). Die Referenz zur Vermeidung doppelter Zählung ist ein kryptografischer Einwegwert, mit dem die Plattform eine wiederholte Übermittlung ignorieren kann; sie gibt Ihren Workspace nicht preis und erlaubt es der Plattform nicht, Registrierung und kostenpflichtiges Abonnement miteinander zu verbinden. Die Klickkennung ist selbst ein personenbezogenes Datum: Die Plattform kann sie der Anzeige zuordnen, die sie Ihnen ausgeliefert hat. **Über diese Kennung hinaus werden keine unmittelbar identifizierenden Daten übermittelt: kein Name, keine E-Mail-Adresse, keine gehashte E-Mail-Adresse, keine Telefonnummer, keine IP-Adresse, keine User-Agent-Angabe und kein Geldbetrag.**

Es gibt derzeit keinen Empfänger: Keine Werbeplattform hat aus dieser Funktion etwas erhalten, und für sie ist unter [Unterauftragsverarbeiter und weitere Empfänger](/subprocessors) keine aufgeführt. Eine Werbeplattform, die eine Meldung erhält, wäre eigenständig Verantwortliche für ihre eigenen Werbedienste und keine Auftragsverarbeiterin für Customermates. Bevor eine Plattform Empfängerin wird, benennen wir hier die empfangenden Unternehmen, ihre Rolle und die Garantien für eine etwaige Übermittlung außerhalb des EWR und fragen Sie erneut nach Ihrer Entscheidung.

Mit der Auswahl „Erlauben“ erteilen Sie in einem Schritt zwei getrennte Einwilligungen: eine nach § 25 Abs. 1 TDDDG in das Speichern des vorstehend beschriebenen Cookies auf Ihrer Endeinrichtung und eine nach Art. 6 Abs. 1 lit. a DSGVO in die daran anschließende Verarbeitung, nämlich das Aufbewahren der Kennung, ihre Zuordnung zu einem von Ihnen erstellten Workspace und die Messung, welche unserer Anzeigen Menschen zu Customermates gebracht haben. Sie ist keine Einwilligung in eine Übermittlung an eine Werbeplattform. Wie vorstehend beschrieben, aktualisieren wir diesen Hinweis und fragen Sie erneut nach Ihrer Entscheidung, bevor eine Meldung beginnt; keine Meldung kann sich daher auf die heute getroffene Entscheidung stützen. Wenn Sie ablehnen, wird dasselbe Cookie für 90 Tage gespeichert; es enthält dann nur Auswahl, Entscheidungszeitpunkt, Fassung des Hinweises und Ablaufzeitpunkt und keinerlei Kennung. Sie können die Einwilligung jederzeit über „Datenschutzauswahl“ im Footer widerrufen, also über dieselbe Bedienmöglichkeit an derselben Stelle, an der Ihnen die Auswahl ursprünglich angeboten wurde. Der Widerruf entfernt die Kennungen sofort aus dem Cookie. Wurde bereits eine Kopie einem Workspace zugeordnet, melden Sie sich zuvor an: Dieselbe Bedienmöglichkeit löscht dann auch die Kopie im Workspace, wozu wir nach Art. 17 Abs. 1 lit. b DSGVO verpflichtet sind. Der Widerruf berührt die Rechtmäßigkeit der bis dahin erfolgten Verarbeitung nicht (Art. 7 Abs. 3 Satz 3 DSGVO); eine bereits an eine Plattform übermittelte Meldung lässt sich nicht zurückrufen. Abgelaufene Kennungen entfernt ein täglicher automatischer Löschlauf. Die Aufzeichnung, dass ein Workspace erstellt wurde und später zu einem zahlenden Abonnement wurde, enthält keine Werbekennung; sie wird für die Dauer des Bestehens des Workspace aufbewahrt und mit ihm gelöscht. Wir setzen weder Werbepixel noch Tags oder Mess-SDKs ein. Customer Match, die Übermittlung erweiterter Conversions (Enhanced Conversions) und erweiterter Abgleich (Advanced Matching) finden nicht statt.
