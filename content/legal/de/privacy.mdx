...
Die Rückmeldung erfolgt nicht automatisch. Eine Person bei Customermates erzeugt aus den vorstehend beschriebenen Aufzeichnungen einen Export und übergibt ihn der Conversion-Import-Schnittstelle der jeweiligen Plattform; derzeit geschieht dies ausschließlich für Google, über eine Tabelle in einem Google-Konto von Customermates, die Google Ads planmäßig ausliest. Für ChatGPT Ads, Reddit Ads und LinkedIn Ads besteht kein Meldeweg; an diese Plattformen wurde nichts übermittelt, und die für sie erfassten Kennungen werden nach Ablauf ihrer Speicherfrist gelöscht, ohne jemals übermittelt worden zu sein. Bevor wir eine Meldung an eine Plattform aufnehmen, an die wir heute nicht melden, aktualisieren wir diesen Hinweis und fragen Sie erneut nach Ihrer Entscheidung. Eine Meldung enthält die von der Plattform selbst ausgegebene Kennung, die Bezeichnung des Ergebnisses („Customermates signup“ oder „Customermates paid“), dessen Zeitpunkt, eine Referenz zur Vermeidung doppelter Zählung sowie die beiden Einwilligungssignale, die Google mit jeder importierten Conversion verlangt („Ad User Data“, auf erteilt gesetzt, und „Ad Personalization“, auf verweigert gesetzt, weil dieser Hinweis nicht um personalisierte Werbung bittet). Die Referenz zur Vermeidung doppelter Zählung ist ein kryptografischer Einwegwert, mit dem die Plattform eine wiederholte Übermittlung ignorieren kann; sie gibt Ihren Workspace nicht preis und erlaubt es der Plattform nicht, Registrierung und kostenpflichtiges Abonnement miteinander zu verbinden. Die Klickkennung ist selbst ein personenbezogenes Datum: Die Plattform kann sie der Anzeige zuordnen, die sie Ihnen ausgeliefert hat. **Über diese Kennung hinaus werden keine unmittelbar identifizierenden Daten übermittelt: kein Name, keine E-Mail-Adresse, keine gehashte E-Mail-Adresse, keine Telefonnummer, keine IP-Adresse, keine User-Agent-Angabe und kein Geldbetrag.** Empfänger ist derzeit ausschließlich die Google Ireland Limited, die insoweit eigenständig Verantwortliche für ihre eigenen Werbedienste und nicht Auftragsverarbeiterin für Customermates ist. Die Google Ireland Limited übermittelt die Daten weiter an die Google LLC in den USA, die am EU-US Data Privacy Framework teilnimmt; der Teilnehmereintrag ist unter https://www.dataprivacyframework.gov/list abrufbar. Bevor ChatGPT Ads, Reddit Ads oder LinkedIn Ads Empfänger werden, benennen wir hier die empfangenden Unternehmen und ihre Übermittlungsgarantien und fragen Sie erneut nach Ihrer Entscheidung. Informationen von Google zur eigenen Verwendung dieser Daten finden Sie unter https://business.safety.google/privacy/. Die aktuellen Empfänger sind zusätzlich unter [Unterauftragsverarbeiter und weitere Empfänger](/subprocessors) aufgeführt.

Mit der Auswahl „Erlauben“ erteilen Sie in einem Schritt zwei getrennte Einwilligungen: eine nach § 25 Abs. 1 TDDDG in das Speichern des vorstehend beschriebenen Cookies auf Ihrer Endeinrichtung und eine nach Art. 6 Abs. 1 lit. a DSGVO in die anschließende Verarbeitung einschließlich der vorstehend beschriebenen Übermittlung. Wenn Sie ablehnen, wird dasselbe Cookie für 90 Tage gespeichert; es enthält dann nur Auswahl, Entscheidungszeitpunkt, Fassung des Hinweises und Ablaufzeitpunkt und keinerlei Kennung. Sie können die Einwilligung jederzeit über „Datenschutzauswahl“ im Footer widerrufen, also über dieselbe Bedienmöglichkeit an derselben Stelle, an der Ihnen die Auswahl ursprünglich angeboten wurde. Der Widerruf entfernt die Kennungen sofort aus dem Cookie. Wurde bereits eine Kopie einem Workspace zugeordnet, melden Sie sich zuvor an: Dieselbe Bedienmöglichkeit löscht dann auch die Kopie im Workspace, wozu wir nach Art. 17 Abs. 1 lit. b DSGVO verpflichtet sind. Der Widerruf berührt die Rechtmäßigkeit der bis dahin erfolgten Verarbeitung nicht (Art. 7 Abs. 3 Satz 3 DSGVO); eine bereits an eine Plattform übermittelte Meldung lässt sich nicht zurückrufen. Abgelaufene Kennungen entfernt ein täglicher automatischer Löschlauf. Die Aufzeichnung, dass ein Workspace erstellt wurde und später zu einem zahlenden Abonnement wurde, enthält keine Werbekennung; sie wird für die Dauer des Bestehens des Workspace aufbewahrt und mit ihm gelöscht. Wir setzen weder Werbepixel noch Tags oder Mess-SDKs ein. Customer Match, die Übermittlung erweiterter Conversions (Enhanced Conversions) und erweiterter Abgleich (Advanced Matching) finden nicht statt.
