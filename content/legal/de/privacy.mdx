...
_Version 2026-09-02, Stand 2. September 2026_
...
### First-Party-Werbezuordnung

Customermates wirbt über Google Ads, ChatGPT Ads, Reddit Ads und LinkedIn Ads. Jede dieser Plattformen kann der Adresse der aufgerufenen Seite ihre eigene Klickkennung anhängen: `gclid`, `gbraid` oder `wbraid` bei Google, `oppref` bei ChatGPT, `rdt_cid` bei Reddit und `li_fat_id` bei LinkedIn. Customermates lädt weder Pixel noch Tag noch SDK einer Werbeplattform, und keine dieser Plattformen setzt auf dieser Website ein Cookie.

Wird eine öffentliche Inhaltsseite des verwalteten Cloud-Dienstes oder die Kontaktseite mit genau einer gültigen Kennung geöffnet und ist noch keine Zuordnungsentscheidung gespeichert, bietet Customermates eine optionale Zuordnungsauswahl an. Eine Seite mit mehr als einer erkannten Kennung wird vollständig ignoriert. Wenn Sie einwilligen, speichert ein signiertes, nur per HTTP zugängliches First-Party-Cookie höchstens eine Kennung je Werbeplattform, jeweils mit Kennungsart, Klickzeitpunkt, Erfassungszeitpunkt und Ablaufzeitpunkt, zusammen mit Ihrer Entscheidung, dem Entscheidungszeitpunkt und der Version dieses Hinweises. Es speichert keine UTM-Parameter, Referrer, Landingpfade, Formularinhalte oder CRM-Datensätze. Rohe Kennungen laufen bei Google und LinkedIn 89 Tage nach dem Klick ab, bei ChatGPT und Reddit 30 Tage nach dem Klick, und nie später als 90 Tage nach Ihrer Entscheidung.

Solange die Auswahl offen ist, werden die Kennung und eine technische Wartemarkierung in der Adresse der von Ihnen aufgerufenen Customermates-Seiten mitgeführt, damit die Auswahl Navigation und Neuladen übersteht. Die Anwendung erkennt diesen markierten Wartezustand 24 Stunden lang, mit bis zu fünf Minuten Toleranz für die Geräteuhr. Dadurch entsteht vor Ihrer Auswahl „Erlauben“ weder ein Customermates-Zuordnungscookie noch ein Benutzerdatensatz. Der Hinweis blockiert die Seite nicht: Sie können die Website lesen und nutzen, während die Auswahl offen ist, und es wird nichts gespeichert, bevor Sie „Erlauben“ wählen. Der Browserverlauf kann eine frühere markierte Adresse behalten, bis sie erneut aufgerufen wird; nach einer Entscheidung, einem Ablauf oder einer ungültigen Markierung entfernt die Anwendung beide Werte aus der aktuellen Adresse und beim erneuten Aufruf auch aus einem solchen früheren Verlaufseintrag.

Eine noch nicht abgelaufene Auswahl „Erlauben“ bleibt bis zum Widerruf gültig, und ein späterer zulässiger Besuch wird ohne erneute Anzeige der Auswahl gespeichert. Da jede Werbeplattform eine Conversion nur der von ihr selbst ausgegebenen Kennung zuordnet, ersetzt ein späterer Klick derselben Plattform den früheren Klick dieser Plattform; Kennungen anderer Plattformen bleiben unberührt.

Erstellt die besuchende Person vor Ablauf einen neuen verwalteten Cloud-Workspace, werden die gespeicherten Kennungen und diese Zeitstempel im Rahmen derselben Registrierungstransaktion einmalig diesem Workspace und seiner ersten Inhaberin oder seinem ersten Inhaber zugeordnet. Sie werden nicht auf eingeladene Personen oder Personen übertragen, die einem bestehenden Workspace beitreten, und bei späteren Anmeldungen nicht überschrieben. Customermates hält außerdem fest, dass der Workspace erstellt wurde und später zu einem zahlenden Abonnement wurde, damit der Werbeplattform mitgeteilt werden kann, dass ihre Anzeige zu einem Ergebnis geführt hat.

Customermates meldet diese Ergebnisse an die Plattform zurück, die die Kennung ausgegeben hat. Übermittelt werden ausschließlich die von der Plattform selbst ausgegebene Kennung, die Art des Ergebnisses, dessen Zeitpunkt und eine Referenz zur Doppelerfassungsvermeidung. **Es werden keine personenbezogenen Daten übermittelt: kein Name, keine E-Mail-Adresse, keine gehashte E-Mail-Adresse, keine Telefonnummer, keine IP-Adresse, keine User-Agent-Angabe und kein Geldbetrag.** Empfänger sind Google Ireland Limited und Google LLC, OpenAI Ireland Limited, Reddit, Inc. sowie LinkedIn Ireland Unlimited Company und LinkedIn Corporation, jeweils als eigenständige Verantwortliche für ihre eigenen Werbedienste. Für Übermittlungen in die USA nehmen Google LLC, Reddit, Inc. und LinkedIn Corporation am EU-US Data Privacy Framework teil; Übermittlungen an OpenAI beruhen auf den Standardvertragsklauseln der Europäischen Kommission.

Rechtsgrundlage für das Cookie und die verknüpfte First-Party-Verarbeitung einschließlich der vorstehend beschriebenen Übermittlung ist Ihre Einwilligung nach § 25 Abs. 1 TDDDG und Art. 6 Abs. 1 lit. a DSGVO. Wenn Sie ablehnen, speichert das Cookie nur Auswahl, Entscheidungszeitpunkt, Hinweisversion und Ablaufzeitpunkt und keinerlei Kennung. Sie können die Einwilligung über „Datenschutzauswahl“ im Footer widerrufen; dadurch werden die Kennungen aus dem Cookie und, wenn Sie angemeldet sind, aus Ihrem Workspace entfernt. Abgelaufene Kennungen entfernt die tägliche Wartung. Es sind kein Werbepixel, kein Tag, kein Mess-SDK, kein Customer Match, keine Übertragung für erweiterte Conversions und kein erweiterter Abgleich aktiv.
