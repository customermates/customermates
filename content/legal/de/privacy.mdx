...
_Version 2026-08-27, Stand 29. August 2026_
...
### Extern gehostete Flaggen

Die Sprachauswahl und Länderfelder können Flaggenbilder unmittelbar von `flagcdn.com` laden. Wird ein solches Bild angezeigt, stellt Ihr Browser eine direkte Verbindung zu dieser Domain her. Deren Betreiber kann die IP-Adresse, die abgerufene Bild-URL, den Zeitpunkt des Abrufs, Browser- und Geräte-Header sowie abhängig von der Referrer-Richtlinie des Browsers die verweisende Seite erhalten. Wir übermitteln mit diesen Bildabrufen nicht bewusst CRM-Inhalte oder Konto-Kennungen und erhalten vom Bild-Host keine besucherbezogenen Antwortdaten. Die Verzeichnisverweise im Footer sind Textlinks und laden keine Bilder oder sonstigen Ressourcen von den Zielseiten, bevor Sie einem Link folgen.

Wir veranlassen diese Abrufe auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO wegen unseres berechtigten Interesses, Sprach- und Länderauswahlen erkennbar zu machen. Der Bild-Host verarbeitet die Anfragedaten nach seinen eigenen Bedingungen; er ist als weiterer Empfänger und nicht als Unterauftragsverarbeiter für kundenseitig verantwortete CRM-Inhalte aufgeführt. Seine Infrastruktur kann eine Verarbeitung außerhalb des EWR umfassen; Standort und Übermittlungsgarantien hängen vom Betreiber ab. Die aktuelle Domain und ihre Rolle sind zusätzlich unter [Unterauftragsverarbeiter und weitere Empfänger](/subprocessors) aufgeführt.
