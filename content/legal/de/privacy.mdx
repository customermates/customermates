...
Customermates lädt oder initialisiert das optionale Affiliate-Skript derzeit weder im verwalteten Dienst noch in der vorgelagerten Self-Hosted-Anwendung. Klicks und Anmeldungen auf `customermates.com` werden daher nicht über dieses Skript zugeordnet. Links zur Partnerregistrierung öffnen die von Lemon Squeezy gehostete Website; dort gilt die Datenschutzerklärung von Lemon Squeezy. Ein unabhängiger Self-Host-Betreiber kontrolliert seine eigene Bereitstellung und ist für jede von ihm hinzugefügte Integration selbst verantwortlich.
