...
Customermates lädt das Standard-Affiliate-Skript von Lemon Squeezy nur im verwalteten Cloud-Dienst. Ruft jemand eine Customermates-Seite über einen Affiliate-Link auf, liest das Skript den URL-Parameter `aff`. Bei diesem Besuch oder bei einem späteren Besuch mit einem bestehenden Referral-Cookie übermittelt es Zielseite, Referrer, Referral-Referenz und eine aus Browsermerkmalen abgeleitete Besucherkennung an Lemon Squeezy. Es speichert das First-Party-Referral-Cookie `ls_aff_ref` für den in Lemon Squeezy konfigurierten Tracking-Zeitraum und kann die Referral-Referenz an Lemon-Squeezy-Checkout-Links anhängen.

Die vorgelagerte Self-Hosted-Anwendung lädt das Skript nicht. Links zur Partnerregistrierung öffnen die von Lemon Squeezy gehostete Website; dort gilt die Datenschutzerklärung von Lemon Squeezy. Ein unabhängiger Self-Host-Betreiber kontrolliert seine eigene Bereitstellung und ist für jede von ihm hinzugefügte Integration selbst verantwortlich.
