...
Die Rückmeldung erfolgt nicht automatisch, und sie hat noch nicht begonnen. Eine Rückmeldung würde bedeuten, dass eine Person bei Customermates aus den vorstehend beschriebenen Aufzeichnungen einen Export erzeugt und ihn der Conversion-Import-Schnittstelle der jeweiligen Plattform übergibt. Für Google Ads, ChatGPT Ads, Reddit Ads und LinkedIn Ads besteht heute kein solcher Meldeweg, und an keine dieser Plattformen wurde etwas übermittelt. Die jetzt erfassten Kennungen werden nach Ablauf ihrer Speicherfrist gelöscht, sofern nicht zuvor ein Meldeweg eingerichtet wird. Bevor wir mit der Meldung an eine Plattform beginnen, aktualisieren wir diesen Hinweis und fragen Sie erneut nach Ihrer Entscheidung.
