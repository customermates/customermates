...
_Version 2026-08-31, Stand 31. August 2026_
...
### First-Party-Zuordnung von Google-Ads-Klicks

Wird eine öffentliche Inhaltsseite des verwalteten Cloud-Dienstes oder die Kontaktseite mit einer gültigen Google-Ads-Klickkennung (`gclid`, `gbraid` oder `wbraid`) geöffnet und ist noch keine Zuordnungsentscheidung gespeichert, bietet Customermates eine optionale Zuordnungsauswahl an. Wenn Sie einwilligen, speichert ein signiertes, nur per HTTP zugängliches First-Party-Cookie genau eine Kennung mit Kennungsart, Erfassungszeitpunkt, Zeitpunkt der Einwilligungsentscheidung und Ablaufzeitpunkt. Es speichert keine UTM-Parameter, Referrer, Landingpfade, Formularinhalte oder CRM-Datensätze. Cookie und rohe Kennung laufen spätestens 90 Tage nach der Entscheidung ab.

Solange die Auswahl offen ist, werden die Kennung und eine technische Markierung für die noch offene Auswahl in der Adresse der von Ihnen aufgerufenen Customermates-Seiten weitergeführt, damit die Auswahl Navigation und Neuladen übersteht. Die Anwendung erkennt diesen markierten offenen Zustand 24 Stunden lang an; für Abweichungen der Geräteuhr gilt eine Toleranz von bis zu fünf Minuten. Dadurch werden vor Ihrer Auswahl von „Erlauben“ weder ein Customermates-Zuordnungs-Cookie noch ein Benutzerdatensatz angelegt. Ein früherer markierter Adresseintrag kann im Browser-Verlauf verbleiben, bis Sie ihn erneut aufrufen; nach einer Entscheidung, nach dem Ablauf oder bei einer ungültigen Markierung entfernt die Anwendung beide Werte aus der aktuellen Adresse und beim erneuten Aufruf auch aus einem solchen früheren Verlaufseintrag.

Eine noch nicht abgelaufene Auswahl „Erlauben“ bleibt bis zum Widerruf gültig. Enthält dieses Cookie aktuell keine Klickkennung, kann eine Kennung aus einem späteren zulässigen Google-Ads-Besuch ohne erneute Anzeige der Auswahl gespeichert werden; eine bereits vorhandene Kennung wird nicht ersetzt.

Erstellt der Besucher vor dem Ablauf einen neuen verwalteten Cloud-Workspace, werden Kennung und Zeitpunkte einmalig innerhalb derselben Registrierungstransaktion in den Benutzerdatensatz des ursprünglichen Inhabers übernommen. Sie werden weder bei eingeladenen Benutzern noch beim Beitritt zu einem bestehenden Workspace übernommen und bei späteren Anmeldungen nicht überschrieben. Vorhandene Felder zu Registrierung, Onboarding und Abonnement können intern ausgewertet werden, um das begrenzte Paid-Search-Experiment zu beurteilen. Customermates erstellt dafür kein separates Verhaltens- oder Lebenszyklusprofil.

Rechtsgrundlage für Cookie und verknüpfte First-Party-Verarbeitung ist Ihre Einwilligung nach § 25 Abs. 1 TDDDG und Art. 6 Abs. 1 lit. a DSGVO. Wenn Sie ablehnen, speichert das Cookie nur Auswahl, Entscheidungszeitpunkt und Ablaufzeitpunkt, jedoch keine Klickkennung. Sie können die Einwilligung über „Datenschutzauswahl“ im Footer widerrufen; dadurch wird die Kennung aus dem Cookie und, wenn Sie angemeldet sind, aus Ihrem Benutzerdatensatz entfernt. Abgelaufene Kennungen entfernt die tägliche Wartung. Für diese anfängliche reine Speicherung sind kein Google-Tag, keine Google-Conversion-Aktion, kein Conversion-Upload, kein Customer Match und keine Übertragung für erweiterte Conversions aktiv.
...
- Name, Spracheinstellung und aktuelle Anwendungsroute des Nutzers sowie dessen Eingabe und die jüngste Mate-Konversation;
...
- Werkzeugbeschreibungen, Werkzeugeingaben und -ergebnisse, Freigabe- und Bestätigungsstatus, Ergebnisse von Oberflächenbefehlen und erzeugte Ausgaben; sowie
...
Mate lädt nicht automatisch den gesamten Arbeitsbereich hoch. Eine Modellanfrage enthält die Eingabe und die jüngste Konversation zusammen mit dem Kontext und den Werkzeugergebnissen, die für die angeforderte Aufgabe benötigt werden. Anfragen werden über den **Vercel AI Gateway** der Vercel Inc. an **OpenAI** als ausgewählten Modellanbieter geleitet. Vercel und OpenAI erhalten daher die Teile einer Anfrage, die zur Erzeugung der Antwort erforderlich sind. Die aktuelle Anbieterkette und Angaben zu Übermittlungen finden Sie unter [Unterauftragsverarbeiter](/subprocessors).

### Rechtsgrundlage und Rollen

Für CRM- und verbundene Kontoinhalte einschließlich personenbezogener Daten der Kontakte und Korrespondenzpartner des Kunden ist der Kunde Verantwortlicher; Customermates verarbeitet diese Inhalte nach den dokumentierten Weisungen des Kunden als Auftragsverarbeiter gemäß Art. 28 DSGVO. Das Absenden einer Mate-Anfrage oder die Bestätigung einer Handlung ist eine solche Weisung und keine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO. Der Kunde bleibt dafür verantwortlich, dass für die Inhalte eine Rechtsgrundlage besteht und sie in eine Mate-Anfrage einbezogen werden dürfen.
...
Die Bedingungen des Vercel AI Gateway behandeln Drittanbieter von Modellen als Nicht-Vercel-Dienste und machen deren Anbieterbedingungen anwendbar. Die aktuellen Notices and License Information von Vercel verlinken für diese Route die Nutzungsbedingungen von OpenAI. Aus dem öffentlichen Produktquelltext geht nicht hervor, dass eine kontospezifische Deaktivierung des Trainings, eine Business- oder API-Datenverarbeitungskonfiguration oder eine Zero-Data-Retention-Einstellung gilt. Customermates verspricht daher weder, dass anbieterseitiges Training deaktiviert ist, noch eine bestimmte Aufbewahrungsfrist beim Anbieter oder die sofortige Löschung von Eingaben und Ausgaben. Nutzer dürfen über Mate keine sensiblen personenbezogenen Informationen übermitteln, insbesondere keine Gesundheitsdaten, Finanzkontoinformationen oder staatlichen Kennnummern; Kunden dürfen einer Mate-Anfrage keinen CRM- oder verbundenen Kontokontext mit solchen Informationen zugänglich machen.

Die Nutzung von Mate kann Verarbeitungen in den Vereinigten Staaten und anderen von den Anbietern und deren Unterauftragsverarbeitern genutzten Ländern umfassen. Der Auftragsverarbeitungszusatz von Vercel bezieht für beschränkte Übermittlungen die EU-Standardvertragsklauseln von 2021 ein. Die für die OpenAI-Route geltenden Bedingungen, Empfängerrollen und bekannten Einschränkungen sind unter [Unterauftragsverarbeiter](/subprocessors) beschrieben. Weitere Informationen:
