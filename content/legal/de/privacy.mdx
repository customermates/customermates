...
_Version 2026-08-06, Stand 6. August 2026_
...
Für eingehende E-Mails an unsere eigenen betrieblichen Adressen unter `@customermates.com` nutzen wir Forward Email, LLC, 16192 Coastal Hwy, Lewes, DE 19958, USA (https://forwardemail.net) als unser endgültiges gehostetes Betreiberpostfach. Nachrichten werden bei Forward Email empfangen und gespeichert; ein gesonderter nachgelagerter Postfachanbieter wird nicht eingesetzt. Der Dienst wird nicht zur Verbindung von Kundenpostfächern, Messaging-Konten oder Kalendern eingesetzt und erhält gewöhnlich keine CRM-Datensätze. Für die Postfachspeicherung gibt Forward Email an, Postfachdaten in verschlüsselten SQLite-Datenbanken auf LUKS-verschlüsselten Datenträgern zu speichern und verschlüsselte Sicherungskopien bei Cloudflare R2 abzulegen. Der Anbieter gibt an, täglich eine verschlüsselte Sicherungskopie je Postfach zu erstellen, sie durch die nächste Sicherungskopie mit geänderten Daten zu ersetzen und sie bei Löschung des Alias zu entfernen. Wird eine persönliche Antwort aus diesem Postfach versandt, verarbeitet Forward Email die ausgehende Nachricht auch über seinen SMTP-Dienst. Nach Angaben des Anbieters werden ausgehende SMTP-E-Mails ungefähr 30 Tage gespeichert. Nach erfolgreicher Zustellung oder endgültigem Fehlschlag wird der Nachrichtentext standardmäßig gelöscht; seine Speicherung kann jedoch auf null bis 30 Tage konfiguriert werden, während verbleibende Zustellungsdaten ungefähr 30 Tage fortbestehen können. Bei fehlgeschlagenen Zustellungen mit Status 4xx oder 5xx speichert der Anbieter Fehlerprotokolle sieben Tage lang; diese können den SMTP-Fehler, Umschlagdaten, Nachrichtenkopfzeilen sowie IP-Adresse oder Hostname des sendenden Servers enthalten.

Der Dienst von Forward Email kann Absender- und Empfängeradressen, Nachrichteninhalte, Anhänge, Kopfzeilen, Kommunikationsmetadaten sowie zugehörige Konto-, Domain-, Alias- und Sicherheitsdaten verarbeiten. Gewöhnlich handelt es sich um betriebliche Korrespondenz auf der Verantwortlichenebene. Nimmt ein Kunde von unserem Auftragsverarbeitungsvertrag erfasste personenbezogene Daten in eine Support- oder Feedbackanfrage auf, speichert und verarbeitet Forward Email zusätzlich diesen begrenzten Ausschnitt innerhalb unserer Unterauftragsverarbeitungskette.

Forward Email verarbeitet diese Daten in unserem Auftrag. Seine veröffentlichten Nutzungsbedingungen, seine DSGVO-Seite und seine FAQ geben an, dass sein Standard-Auftragsverarbeitungsvertrag automatisch mit den Nutzungsbedingungen angenommen werde und keine gesonderte Unterschrift erfordere. Der veröffentlichte Auftragsverarbeitungsvertrag selbst definiert die Vereinbarung dagegen als seine Standardbedingungen zusammen mit einem Deckblatt und bestimmt, dass seine Laufzeit erst beginnt, wenn Anbieter und Kunde dieses Deckblatt vereinbaren und den Vertrag unterzeichnen oder elektronisch annehmen. Wir haben kein solches Deckblatt vereinbart. Aufgrund dieses Widerspruchs stützen wir uns nicht darauf, dass die veröffentlichten Erklärungen für unser Konto einen wirksamen Vertrag gemäß Art. 28 DSGVO begründen. Für die Korrespondenz auf der Verantwortlichenebene sind die Rechtsgrundlagen unserer Verarbeitung Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer sicheren und zuverlässigen E-Mail-Infrastruktur) sowie, soweit für ein Vertragsverhältnis erforderlich, Art. 6 Abs. 1 lit. b DSGVO. Verarbeitet Forward Email innerhalb unserer Unterauftragsverarbeitungskette einen von unserem Auftragsverarbeitungsvertrag erfassten Ausschnitt, bestimmt der Kunde die Rechtsgrundlage und wir verarbeiten diesen Ausschnitt nach den dokumentierten Weisungen des Kunden unter diesem Vertrag.

Forward Email hat seinen Sitz in den USA und seine veröffentlichte Infrastrukturkette umfasst Anbieter außerhalb des EWR, sodass personenbezogene Daten in einem Drittland verarbeitet werden können. Der veröffentlichte Vertrag des Anbieters bezieht die EU-Standardvertragsklauseln ein; die erforderlichen Anlagen stehen jedoch in einem Deckblatt, das für unser Konto nicht vereinbart wurde. Wir stützen uns daher nicht auf diese Klauseln als vollständigen Übermittlungsmechanismus. Die Verschlüsselung der Postfachdatenbank, der Datenträger und der Sicherungskopien sowie die siebentägige Speicherung von Fehlerprotokollen fehlgeschlagener Zustellungen begrenzen die Exposition, ersetzen aber weder einen wirksamen Vertrag nach Art. 28 DSGVO noch einen Übermittlungsmechanismus nach Kapitel V DSGVO.

Weitere Informationen zum Datenschutz bei Forward Email finden Sie unter: https://forwardemail.net/en/privacy

### Vertragsstatus

Für unser Konto können wir weder einen wirksamen Auftragsverarbeitungsvertrag nach Art. 28 DSGVO noch einen vollständigen Übermittlungsmechanismus nach Kapitel V DSGVO belegen. Für die gegenwärtige Verarbeitung bestehen daher ungeklärte Vertrags- und Übermittlungslücken, die behoben werden müssen; die vorstehend beschriebenen technischen Maßnahmen schließen diese Lücken nicht.
...
Eingehende E-Mails an unsere eigenen betrieblichen Adressen unter `@customermates.com` werden in unserem bei Forward Email gehosteten Betreiberpostfach empfangen und gespeichert. Resend versendet die von der Anwendung erzeugten automatisierten Transaktions- und Konto-E-Mails; gewöhnliche persönliche Antworten werden aus dem Forward-Email-Postfach versandt. Ein gesonderter nachgelagerter Postfachanbieter wird nicht eingesetzt. Die Verarbeitung durch Resend ist in einem Auftragsverarbeitungsvertrag gemäß Art. 28 DSGVO geregelt. Der ungeklärte Vertrags- und Übermittlungsstatus von Forward Email ist in Abschnitt 2 beschrieben; wir stellen nicht dar, dass hierfür derzeit ein wirksamer Vertrag nach Art. 28 DSGVO gilt.
