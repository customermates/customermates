...
Customermates pricing starts at €9 per user per month on annual billing (€12 per user per month on monthly billing). There is a 3-day free trial with no credit card required. The full pricing breakdown sits at our [pricing page](/pricing).
