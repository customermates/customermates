...
description: "Recruiting CRM for agencies and in-house talent teams. Candidate pipelines, client tracking, automation. Open-source, EU-hosted, from €12/user/month."
...
The full Customermates [API](/features/api) and 26 webhook events let agencies plug the CRM into their existing job-board posting tools, video interview platforms, payroll software, and invoicing system. The CRM becomes the system of record without ripping out the rest of the stack.
...
Customermates pricing starts at €12 per user per month (€10 on annual billing) for Starter, the core CRM with no messaging inbox. Recruiting runs on the inbox, so most agencies land on Pro instead: the unified inbox for email, LinkedIn, and WhatsApp costs €24 per user per month annually (€29 monthly). There is a 7-day free trial on Pro, no credit card required. The full pricing breakdown sits at our [pricing page](/pricing).

A small recruiting agency of five recruiters on Pro runs at €120 per month annually, less than 1% of a single placement fee. Self-hosting is free if you bring your own infrastructure.
