...
description: "Best CRM for mortgage brokers in 2026. Track loan pipelines, nurture leads, manage referral partners, and stay compliant. Open-source. From €7/user/month."
...
cta:
  ...
  description: Get started with Customermates today, the open-source mortgage broker CRM with pipeline tracking, automation, and native AI integration at a flat €7/user/month.
  buttonLeftText: Start for free
  buttonLeftHref: /auth/signup
  buttonRightText: Watch live demo
  buttonRightHref: https://demo.customermates.com
