...
description: "Best CRM for architects in 2026. Manage project pipelines, client relationships, RFPs, and design phases. Open-source, GDPR-compliant. From €12/user/month."
...
cta:
  ...
  description: Join architecture firms that manage their entire project lifecycle with an open-source CRM, no per-project fees, no vendor lock-in, from €12/user/month.
  buttonLeftText: Start for free
  buttonLeftHref: /auth/signup
  buttonRightText: Watch live demo
  buttonRightHref: https://demo.customermates.com
...
On Pro, email, LinkedIn, and WhatsApp come together in one [unified inbox](/features/email-integration) inside the CRM, each message linked to the right project, client, or consultant. RFP questions, consultant coordination, and client updates stop bouncing between personal inboxes and leave a complete audit trail on the record. The same AI agents can draft and send replies from here.
...
- **Starter, €12 per user per month**, pipelines, automation, API, custom fields, and native AI integration, no hidden costs
- **Pro, €29 per user per month**, adds the unified inbox for email, LinkedIn, and WhatsApp plus calendar sync, useful once RFP and consultant coordination outgrows plain email
...
For an architecture office of 8 users, principals, project architects, business development, and marketing coordinator, that is €96 per month on Starter for a complete CRM for architects. No per-project fees, no seat minimums, no surprise charges at renewal.
