...
description: "Rechtsanwalts-CRM, in dem KI-Agenten die Dateneingabe übernehmen und Mandanten-E-Mail und WhatsApp in einem Posteingang zusammenlaufen. Konfliktprüfung, Mandatsverfolgung. Open-Source, DSGVO-konform, ab [[commercial.price.starter.monthly]]/Nutzer/Monat."
...
cta:
  ...
  description: "Kanzleien ersetzen Tabellen und teure Kanzleisoftware durch Customermates, das Open-Source-CRM für Anwälte, ab [[commercial.price.starter.monthly]]/Nutzer/Monat."
  buttonLeftText: Kostenlos starten
  buttonLeftHref: /auth/signup
  buttonRightText: Live-Demo ansehen
  buttonRightHref: https://demo.customermates.com
...
- Automatische Aufnahme-Follow-up-E-Mails bei neuen Anfragen Dafür ist ein Scheduler in Ihrer eigenen n8n-Instanz oder einem anderen externen Dienst über die API nötig; Customermates führt zeitgesteuerte Follow-ups und Erinnerungen nicht selbst aus.
...
Customermates verbindet sich nativ mit Claude, ChatGPT und Gemini über [[derived.mcp.tools.total]] MCP-Tools, sodass ein KI-Agent Ihr CRM direkt lesen und schreiben und die Dateneingabe übernehmen kann, die Anwälte meiden: Mandate eröffnen, Aufnahmephasen aktualisieren und Empfehlungsnotizen protokollieren. Bitten Sie einen Agenten,
...
|---|---|---|---|
| Preis | Ab [[commercial.price.starter.monthly]]/Nutzer/Monat | 50-200 €/Nutzer/Monat, gestaffelt | 15-100 €/Nutzer/Monat, gestaffelt |
...
| KI-Agenten bedienen das CRM (MCP) | Ja ([[derived.mcp.tools.total]] Tools) | Premium-Add-on | Premium-Add-on |
...
Für eine Kanzlei mit 10 Personen sind das [[commercial.price.starter.monthly.seats.10]]/Monat in Starter. Für einen Einzelanwalt [[commercial.price.starter.monthly]]/Monat. Keine Gebühren pro Mandat, keine Überschreitungskosten, keine Überraschungsrechnungen.
...
1. **Konto erstellen** unter [customermates.com/auth/signup](/auth/signup), kostenlos und ohne Kreditkarte. Die ersten [[commercial.trial.days]] Tage sind gratis.
...
<Faq>
<FaqItem question="Was ist ein CRM für Kanzleien?">
...
<FaqItem question="Brauchen kleine Kanzleien ein CRM?">
...
<FaqItem question="Wie unterscheidet sich ein Kanzlei-CRM von Kanzleisoftware?">
...
<FaqItem question="Kann Customermates Konfliktprüfungen durchführen?">
...
<FaqItem question="Ist Customermates DSGVO-konform für juristische Daten?">
...
<FaqItem question="Wie vergleicht sich Customermates mit anderen CRM-Systemen für Kanzleien?">
Spezialisierte Kanzlei-CRMs bieten starke Aufnahmefunktionen, verlangen aber meist 50-200 €/Nutzer/Monat mit gestaffeltem Funktionszugang und hohem Vendor-Lock-in. Customermates startet bei [[commercial.price.starter.monthly]]/Nutzer/Monat für das Kern-CRM mit nativen KI-Agenten, den einheitlichen Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram) gibt es ab Pro für [[commercial.price.pro.monthly]]/Nutzer/Monat, ist Open-Source, selbst hostbar und in der EU-Region gehostet. Wenn Ihre Kanzlei Datensouveränität, transparente Preise und Flexibilität gegenüber einem hochspezialisierten Funktionsumfang schätzt, lohnt sich ein genauer Blick auf Customermates.
</FaqItem>

<FaqItem question="Kann ich Customermates mit meiner Abrechnungssoftware integrieren?">
