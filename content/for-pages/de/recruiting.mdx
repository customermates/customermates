...
description: "Recruiting CRM für Personalvermittler und HR-Teams. Kandidaten-Pipelines, Kundenverwaltung, Automation. Open Source, DSGVO-konform, ab [[commercial.price.starter.monthly]]/Nutzer/Monat."
industryName: "Recruiting"

hero:
  title: "Das Open-Source-Recruiting-CRM für moderne Personalteams"
  description: "Verwalten Sie Kandidaten, Kunden und Mandate in einem Recruiting CRM. KI-Agenten übernehmen die Datenpflege, und ein nativer Posteingang führt LinkedIn, E-Mail und WhatsApp zusammen. Pipeline-orientiert, Agent-nativ, DSGVO-konform."
...
### LinkedIn und der einheitliche Posteingang für Sourcing-lastige Desks

Recruiting läuft über LinkedIn, deshalb steht es im Zentrum des nativen einheitlichen Posteingangs, neben E-Mail, WhatsApp, Instagram und Telegram (ab Pro). Ein Kandidat aus dem Sales Navigator oder LinkedIn Recruiter landet mit zwei Klicks im CRM, samt Profilkontext, und jede LinkedIn-Nachricht, E-Mail und WhatsApp-Konversation liegt am Kandidatendatensatz. Dieselben KI-Agenten können über alle lesen, entwerfen und senden. Das ist der größte Zeitspar-Hebel auf einem Sourcing-lastigen Desk. Siehe [LinkedIn-Integration](/features/linkedin-integration).

### Aufgaben- und Wiedervorlage-Verwaltung

Jede Suche hat ihren Rhythmus von Wiedervorlagen. [Aufgabenverwaltung](/features/task-management) hält Kandidaten- und Kundenarbeit mit Zuständigen und Notizen in einer Liste; Wiedervorlagedaten bilden Sie mit eigenen Datumsspalten ab. Ein separat betriebener Workflow kann erinnern, während sich der Recruiter aufs Gespräch konzentriert.

### API und Webhooks für eigene Workflows

Die volle Customermates-[API](/features/api) und [[derived.webhooks.events.total]] Webhook-Events erlauben es Agenturen, das CRM mit bestehenden Tools für Stellenausschreibung, Videointerviews, Lohnabrechnung und Rechnungswesen zu verbinden. Das CRM wird zum System of Record, ohne den restlichen Stack auszutauschen.
...
Customermates kostet ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat für Starter, das Kern-CRM ohne Nachrichtenposteingang. Recruiting läuft über den Posteingang, deshalb landen die meisten Agenturen bei Pro: Der einheitliche Posteingang für E-Mail, LinkedIn und WhatsApp kostet [[commercial.price.pro.monthly]] pro Nutzer pro Monat. Es gibt eine kostenlose [[commercial.trial.days]]-Tage-Testphase von Pro ohne Kreditkarte. Die volle Preisaufstellung steht auf unserer [Preisseite](/pricing).

Eine kleine Personalagentur mit fünf Recruitern fährt in Pro für [[commercial.price.pro.monthly.seats.5]] im Monat, einen kleinen Bruchteil einer typischen Honorarplatzierung. Self-Hosting ist kostenlos, wenn Sie eigene Infrastruktur mitbringen.
...
<Faq>
<FaqItem question="Ist Customermates ein CRM oder ein ATS?">
...
<FaqItem question={"Was bedeutet „Agent-nativ\" für ein Recruiting CRM?"}>
...
<FaqItem question="Ist Customermates DSGVO-konform für europäisches Recruiting?">
...
<FaqItem question="Wie lange dauert die Migration von einem anderen Recruiting CRM?">
Customermates hat keinen CSV-Uploader und keine eingebaute Migrationsmaske. Bereiten und ordnen Sie Kandidaten- und Kundendaten außerhalb des Produkts zu, erstellen Sie unterstützte Datensätze über die [REST API](/features/api) oder einen externen KI-Client per MCP und prüfen Sie das Ergebnis im CRM. Umfang, Dauer, Validierung und Duplikatbehandlung liegen bei Ihrer Integration.
</FaqItem>

<FaqItem question="Kann das Recruiting CRM Wechsel von Zeitarbeit zur Festanstellung tracken?">
...
<FaqItem question="Wie behandelt Customermates Off-Limits- und vertrauliche Kandidaten?">
Off-Limits-Status lässt sich mit einem eigenen Checkbox-Feld am Kontaktdatensatz sowie Freitext für Grund und Ablaufdatum abbilden. Berechtigungen gelten je Ressource und Aktion mit eigenem oder gesamtem Umfang; private Mandate oder Kandidatenlisten bietet Customermates nicht. Für vollständig vertrauliche Mandate gestalten Sie den Prozess um diese Grenzen und prüfen Self-Hosting sowie jeden verbundenen Anbieter separat.
</FaqItem>

<FaqItem question="Lohnt es sich, ein eigenes Recruiting CRM selbst zu bauen?">
