...
description: "Open-Source CRM für Anwälte. Mandantenakquise, Fallverfolgung, Abrechnung, Empfehlungen und Zeiterfassung, DSGVO-konform, ab €9/Nutzer/Monat."
...
Für einen Einzelanwalt bedeutet das €9 pro Monat. Punkt. Keine Gebühren pro Mandat, kein Prozentsatz der Abrechnung, keine Überraschungen.
...
Customermates ist Open Source, kostet €9/Nutzer/Monat mit allen Funktionen und kann selbst gehostet werden. Spezialisierte Kanzleitools sperren Funktionen hinter Preisstufen, sind proprietär und speichern Ihre Daten auf ihren Servern. Customermates gibt Einzelanwälten Enterprise-CRM-Funktionen ohne den Enterprise-Preis.
