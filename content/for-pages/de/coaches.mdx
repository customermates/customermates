---
title: "CRM für Coaches: Klienten und Coaching-Pipeline steuern"
description: "Open-Source CRM für Coaches. Klienten verwalten, Coaching-Pipeline steuern, Follow-ups automatisieren, DSGVO-konform, ab [[commercial.price.starter.monthly]]/Nutzer/Monat."
industryName: "Coaches"

hero:
  title: "Das CRM für Coaches, das Ihre Praxis wachsen lässt"
  description: "KI-Agenten halten Klientenakten und Follow-ups aktuell, während E-Mail, WhatsApp und Instagram in einem Posteingang liegen, verknüpft mit jedem Klienten. Beziehungen verwalten, Ihre Coaching-Pipeline steuern und Follow-ups automatisieren, ein Coaching-CRM für Life Coaches, Business Coaches und Coaching-Unternehmen, nicht für Enterprise-Vertriebsteams."
...
cta:
  ...
  description: Starten Sie mit Customermates, dem Open-Source CRM für Coaches, das sich selbst aktualisiert, ab [[commercial.price.starter.monthly]]/Nutzer/Monat.
  buttonLeftText: Kostenlos starten
  buttonLeftHref: /auth/signup
  buttonRightText: Live-Demo ansehen
  buttonRightHref: https://demo.customermates.com
...
### Follow-ups über Ihre eigene Automatisierung und Aufgabenverwaltung
...
- Ein neuer Lead füllt Ihr Kontaktformular aus? **Automatisch in die Pipeline aufnehmen** und Follow-up-Aufgabe zuweisen. Dafür ist ein Scheduler in Ihrer eigenen n8n-Instanz oder einem anderen externen Dienst über die API nötig; Customermates führt zeitgesteuerte Follow-ups und Erinnerungen nicht selbst aus.
...
In Pro laufen E-Mail, WhatsApp und Instagram-Nachrichten in einem [einheitlichen Posteingang](/features/email-integration) zusammen, jede automatisch mit dem Klienten-Datensatz verknüpft. Wenn Sie vor einer Sitzung das Klientenprofil öffnen, sehen Sie den kompletten Kommunikationsverlauf, kein Durchsuchen des Postfachs. Er verbindet sich mit Gmail, Outlook und anderen Anbietern, um alle Klientenkommunikation zentral und durchsuchbar zu halten, und KI-Agenten können Antworten direkt hier entwerfen.

Für Coaches, die intensiv per E-Mail und Messaging mit Klienten kommunizieren, spart das jede Woche Stunden an Kontextwechseln.

## KI-Agenten, die Ihr CRM bedienen

Verbinden Sie Claude, ChatGPT oder Gemini über die native MCP-Integration ([[derived.mcp.tools.total]] Tools) und lassen Sie sie die Dateneingabe und die Analyse übernehmen. Agenten legen Klientenakten an, verschieben Interessenten zwischen Pipeline-Phasen und protokollieren Sitzungsnotizen, sodass die Pipeline aktuell bleibt, und sie können außerdem:
...
- **Starter, [[commercial.price.starter.monthly]] pro Nutzer pro Monat**, Automatisierung, API, native KI (MCP), benutzerdefinierte Felder und Reporting ab Tag 1
- **Pro, [[commercial.price.pro.monthly]] pro Nutzer pro Monat**, ergänzt den einheitlichen Posteingang für Klienten-E-Mail, WhatsApp und Instagram, verknüpft mit jedem Engagement
- **Keine versteckten Kosten**, keine Implementierungsgebühren, keine Kosten pro Integration
- **Open Source und selbst hostbar**, betreiben Sie es auf eigenen Servern, wenn Datensouveränität zählt, für immer kostenlos

Ein Solo-Coach zahlt [[commercial.price.starter.monthly]]/Monat in Starter. Ein Coaching-Unternehmen mit 5 Coaches zahlt [[commercial.price.starter.monthly.seats.5]]/Monat. Volles CRM zu einem Bruchteil dessen, was [etablierte CRM-Anbieter](https://www.g2.com/categories/crm) verlangen.
...
<Faq>
<FaqItem question="Was ist ein CRM für Coaches?">
...
<FaqItem question="Brauche ich als Solo-Coach ein CRM?">
Ja. Solo-Coaches brauchen ein CRM sogar mehr als größere Firmen, weil es keinen Assistenten oder Support gibt, der verpasste Follow-ups auffängt. Wenn Sie gleichzeitig Coach, Vertriebsperson und Administrator sind, gibt Ihnen ein CRM für Coaching-Business die Struktur, um Business Development am Laufen zu halten, auch wenn Sie tief in Klientensitzungen stecken. Mit [[commercial.price.starter.monthly]]/Monat bei Customermates zahlt sich die Investition aus, sobald Sie auch nur einen zusätzlichen Klienten pro Quartal gewinnen.
</FaqItem>

<FaqItem question="Wie unterscheidet sich Customermates von Coaching-Tools wie Paperbell oder CoachAccountable?">
...
<FaqItem question="Kann Customermates mein Spreadsheet für die Klientenverwaltung ersetzen?">
...
<FaqItem question="Ist Customermates DSGVO-konform für Coaching-Klientendaten?">
...
<FaqItem question="Kann ich Customermates mit meinen anderen Coaching-Tools integrieren?">
...
<FaqItem question="Wie hilft mir ein CRM, mehr Coaching-Klienten zu gewinnen?">
