...
**Board- und Tabellenansichten.** Wechseln Sie jede Deal-Liste zwischen einer Board-Ansicht und einer Tabellenansicht und gruppieren Sie beide nach einer Phasenspalte, einem Verantwortlichen, einem verknüpften Datensatz oder einem Datum. Um Neugeschäft, Verlängerungen oder separate Produktlinien getrennt zu halten, speichern Sie jede Variante als eigene Ansicht und wechseln Sie über die Chips oberhalb der Liste zwischen ihnen.

**Geteilte Ansichten für Ihr Team.** Eine Ansicht merkt sich die gesamte Liste: Filter, Sortierung, Gruppierung, Layout und Spalten. Benennen Sie sie, teilen Sie sie mit dem Workspace, und alle öffnen dieselbe Pipeline über denselben Link. Wenn Sie eine geteilte Ansicht für sich ändern, ändert sich für andere nichts, bis Sie speichern.
