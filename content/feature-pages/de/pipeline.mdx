...
**Einfache, faire Preisgestaltung.** Pipeline-Management kostet 7 EUR pro Nutzer und Monat, pauschal. Mehrere Pipelines, Kanban-Boards, Analysen und alle Pipeline-Funktionen sind enthalten. Keine Premium-Stufe fuer erweiterte Pipeline-Funktionen erforderlich.
