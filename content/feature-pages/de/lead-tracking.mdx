...
**Externe KI-Clients bedienen zulässige CRM-Daten.** Unterstützte Clients wie Claude, ChatGPT oder Gemini können mit [[derived.mcp.tools.total]] MCP-Tools Datensätze aktualisieren, zulässigen Kontext zusammenfassen und ein Follow-up entwerfen. Customermates stellt diesen externen Client oder dessen Modell nicht bereit und ergänzt im MCP-Flow weder Scoring noch Anreicherung; separate Anbieter verantworten die Ergebnisse.
