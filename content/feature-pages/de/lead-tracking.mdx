...
**Ab 12 € pro Nutzer und Monat.** Pipeline-Phasen, eigene Felder, REST, Webhooks und MCP starten mit Starter. Lead-Scoring, Routing, Anreicherung, n8n und KI-Clients bleiben separat. Das gemeinsame Postfach startet mit Pro bei 29 €.
...
**Externe KI-Clients bedienen zulässige CRM-Daten.** Unterstützte Clients wie Claude, ChatGPT oder Gemini können mit 46 MCP-Tools Datensätze aktualisieren, zulässigen Kontext zusammenfassen und ein Follow-up entwerfen. Customermates enthält weder KI-Client noch Modell, Scoring oder Anreicherung; separate Anbieter verantworten die Ergebnisse.
...
Die Preise variieren stark. Salesforce verlangt ab 25 $/Nutzer/Monat, Pipedrive startet bei 14 $/Nutzer/Monat, und viele Tools beschränken Lead-Scoring auf Premium-Stufen. Customermates startet bei 12 €/Nutzer/Monat für Kern-Tracking und besitzt kein natives Lead-Scoring-Add-on.
