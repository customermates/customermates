...
Deploy Customermates on infrastructure you control, or [start with the cloud version](/auth/signup) free for seven days on Pro. Core record management, [sales tracking](/features/sales-tracking), API, webhooks, and MCP are available self-hosted; [workflow automation](/features/workflow-automation) requires a separate engine, while the unified inbox comes only with cloud Pro.
