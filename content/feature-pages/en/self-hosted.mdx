...
description: "Self hosted CRM you deploy with Docker and PostgreSQL on your own servers. Open-source core and full infrastructure control; providers stay separate."
...
faq:
  ...
  - id: self-hosted-faq-1
    title: "Can I switch between cloud and self-hosted?"
    content: |-
  ...
  - id: self-hosted-faq-2
    title: "What infrastructure do I need to self-host?"
    content: |-
  ...
  - id: self-hosted-faq-3
    title: "Is self-hosting free or does it cost extra?"
    content: |-
  ...
  - id: self-hosted-faq-4
    title: "How do I handle updates when self-hosting?"
    content: |-
  ...
  - id: self-hosted-faq-5
    title: "Is the self-hosted version secure?"
    content: |-
  ...
  - id: self-hosted-faq-6
    title: "Can I integrate self-hosted Customermates with other tools?"
    content: |-
