...
With Customermates, you do not have to choose permanently. You can start with the [cloud version](/features/cloud-crm) at €7 per user per month and migrate to self-hosting at any time, or vice versa. The application is identical in both environments with [full feature parity](/pricing).
...
| Price/user/month (cloud) | €7 flat | Free / $90+ | $25+ | $14+ |
...
Self-hosting Customermates eliminates per-user licensing entirely. You pay only for the server infrastructure. For teams of 10 or more, the savings are significant. Even the [cloud-hosted version](/pricing) at €7/user/month is substantially cheaper than most competitors. Compare [Salesforce pricing](/blog/salesforce-pricing) and [Pipedrive pricing](/blog/pipedrive-pricing) for more details.
...
Self-hosting Customermates is completely free because it is open-source software. The cloud-hosted version costs €7 per user per month and includes hosting, maintenance, and updates. Self-hosted users manage their own infrastructure and updates. All features, including [lead management](/features/lead-management), [sales automation](/features/sales-automation), [pipeline tracking](/features/pipeline), and [task management](/features/task-management), are identical in both options.
