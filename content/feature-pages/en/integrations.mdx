...
faq:
  ...
  - id: integrations-faq-1
    title: "How many integrations does Customermates support?"
    content: |-
  ...
  - id: integrations-faq-2
    title: "Do I need to pay extra for integrations?"
    content: |-
  ...
  - id: integrations-faq-3
    title: "Can I replace Zapier with Customermates?"
    content: |-
  ...
  - id: integrations-faq-4
    title: "Is the REST API included with every plan?"
    content: |-
  ...
  - id: integrations-faq-5
    title: "Can I build integrations with tools not listed in n8n?"
    content: |-
