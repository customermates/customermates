...
### Is workflow automation included in the base price?

Yes. From the €12/user/month Starter tier, unlimited automations, unlimited executions, and all 400+ integrations are included. There are no per-workflow, per-run, or per-integration charges. See full [pricing details](/pricing).
