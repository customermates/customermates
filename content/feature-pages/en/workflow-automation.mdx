...
faq:
  ...
  - id: workflow-automation-faq-1
    title: "Do I need coding skills to build workflow automations?"
    content: |-
  ...
  - id: workflow-automation-faq-2
    title: "Can I automate workflows that connect to external tools?"
    content: |-
  ...
  - id: workflow-automation-faq-3
    title: "Does connecting workflow automation cost extra?"
    content: |-
