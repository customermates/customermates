...
**No Customermates fee per external workflow.** REST, webhooks, MCP, and the community node start with the €12 Starter [tier](/pricing). n8n remains separate and applies its own subscription, hosting, execution, connector, limit, log, and provider costs; Customermates makes no unlimited-use promise.
...
[Sign up for Customermates](/auth/signup) and connect documented CRM interfaces to the automation service you operate. No credit card is required for your first seven days; [sales automation](/features/sales-automation) workflows and their runtime remain separate.
