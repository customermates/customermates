...
hero:
  ...
  description: Track every service interaction and log customer communications across email, LinkedIn, WhatsApp, Instagram, and Telegram in one native inbox. Give your team the complete context they need to resolve issues on the first contact. AI agents help draft replies and keep records current at scale.
...
**AI agents and AI assistance.** Claude, ChatGPT, and Gemini connect through a native MCP integration (45 tools) and work in your service data directly. They summarize long conversation histories so new agents get up to speed instantly, draft response templates based on similar past issues, classify incoming requests by type and urgency, and keep records current. AI enhances your team's capability without replacing the human empathy that good service requires.
...
**From €12 per user per month.** Customer service features, AI assistance, task tracking, automation, custom fields, and reporting are all included from the Starter tier. No separate service desk add-on and no per-ticket charges at any tier. Teams that want automatic email logging as part of the service timeline add the unified inbox from the Pro tier at €29/user/month.
