...
description: "CRM reporting with configurable dashboard charts over your pipeline, deals, and activity. External AI clients can query supported data through MCP. Open-source, with a managed database in an EU region."
