...
**Simple, fair pricing.** CRM reporting is included from EUR 12 per user per month (Starter tier). Dashboard chart widgets, filters, and MCP access for external AI clients are included at every tier. No per-report charges, and you can add as many widgets as you need.
