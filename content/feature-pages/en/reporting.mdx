...
**Simple, fair pricing.** CRM reporting costs EUR 9 per user per month, flat. Dashboards, analytics, and all reporting features are included. No premium analytics tiers, no per-report charges, and no limits on the number of dashboards you create.
