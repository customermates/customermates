...
Customermates positions in this gap: an open-source CRM with Table and Card (Kanban) views, five entities (Contacts, Organizations, Deals, Services, Tasks), ten custom field types, a full REST API, and a built-in MCP server with [[derived.mcp.tools.total]] tools that lets AI agents operate the CRM directly. Cloud from [[commercial.price.starter.monthly]] per user per month (Starter tier), free to self-host via Docker, AGPL-3.0 licensed.
...
If you offer CRM consulting yourself and want to package a CRM product under your own brand, Customermates has a white-label partner programme in the making. The intent is a hosted instance under your domain (like `crm.youragency.com`) with your logo and colours, with hosting, updates, and maintenance handled for you, billed on to your clients at your own price. The branding capability is not implemented yet, so today this is a conversation and a contract rather than a switch.

White-label sits on the Enterprise tier and is priced individually, as a contracted item rather than a shipped feature. It fits consultancies that want to combine implementation and ongoing operations under one offering, without building and supporting their own product. More on request through the contact form.
...
<Faq>
<FaqItem question="What does a CRM consultant actually do?">
...
<FaqItem question="How much does CRM consulting cost?">
...
<FaqItem question="Do I really need a CRM consultant?">
...
<FaqItem question="How long does a CRM consulting engagement take?">
...
<FaqItem question="What's the difference between a CRM consultant and a CRM implementation partner?">
...
<FaqItem question="Can AI replace a CRM consultant?">
...
<FaqItem question="How do CRM partner tier programs work?">
...
<FaqItem question="Should I hire a generalist or a platform-specialist consultant?">
