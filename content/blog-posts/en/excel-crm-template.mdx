...
Customermates has no CSV importer or field-mapping screen; records are created through the REST API or by an AI agent over MCP. During import you match your CSV column headers to CRM fields, preview the data, and confirm. Common column names like First Name, Email, and Company are recognized automatically.
