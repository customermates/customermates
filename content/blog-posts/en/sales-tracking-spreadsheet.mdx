...
2. **3-10 person team:** lightweight CRM ([Customermates](/) from €12, Pipedrive Lite at $14, HubSpot Free)
...
The new modern angle for 2026: AI tools (Claude, Codex, ChatGPT) can drive the CRM directly via MCP or API. [Customermates](/) exposes 46 MCP tools so Claude can read deals, draft follow-ups, and update notes from a transcript without the rep typing into the CRM. That is the spreadsheet-replacement experience finally getting good.
