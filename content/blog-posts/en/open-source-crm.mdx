...
- AI agents (Claude, ChatGPT, Gemini) that read and write the CRM through a native MCP integration (46 tools)
...
**Pricing**: from EUR 12/user/month for managed cloud (Starter, full core CRM; Pro at EUR 29 adds the unified inbox). Self-hosted is free and open source.
...
| **Cloud option** | From EUR 12/user/mo | From GBP 95/mo | From EUR 24.90/user/mo | From USD 15/user/mo | Beta | From USD 12/user/mo | Via partners |
...
If you prefer not to manage infrastructure, Customermates offers [managed EU cloud hosting](/pricing) from EUR 12/user/month with the full core CRM included, no Docker setup required.
...
| Customermates (Cloud, Starter) | EUR 1,440 | EUR 1,440 | EUR 1,440 | EUR 4,320 |
...
For small businesses, EspoCRM and Customermates are strong choices. EspoCRM offers a clean interface with low complexity. Customermates adds n8n automation, a native unified inbox, and AI agents that operate the CRM via MCP from EUR 12/user/month, with the full core CRM at every tier. Both support Docker-based self-hosting.
