...
**Pricing**: EUR 9/user/month for managed cloud. All features included, no tiers. Self-hosted is free and open source.
...
| **Cloud option** | EUR 9/user/mo | From GBP 95/mo | From EUR 24.90/user/mo | From USD 15/user/mo | Beta | From USD 12/user/mo | Via partners |
...
If you prefer not to manage infrastructure, Customermates offers [managed EU cloud hosting](/pricing) at EUR 9/user/month with all features included, no Docker setup required.
...
| Customermates (Cloud) | EUR 1,080 | EUR 1,080 | EUR 1,080 | EUR 3,240 |
...
For small businesses, EspoCRM and Customermates are strong choices. EspoCRM offers a clean interface with low complexity. Customermates adds n8n automation and native AI integration at a flat EUR 9/user/month, with no feature gating. Both support Docker-based self-hosting.
