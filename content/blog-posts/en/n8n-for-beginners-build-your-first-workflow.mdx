...
With [Customermates](/) (from EUR 12/user/month), the n8n integration is native, dedicated nodes instead of raw API calls.
...
Customermates (from EUR 12/user/month, full core CRM included) has a native n8n integration. This means you can use dedicated Customermates nodes in n8n rather than configuring raw API calls. The integration supports creating, reading, updating, and deleting contacts, deals, organizations, and notes.
