...
With [Customermates](/) (EUR 7/user/month), the n8n integration is native -- dedicated nodes instead of raw API calls.
...
Customermates (EUR 7/user/month, all features included) has a native n8n integration. This means you can use dedicated Customermates nodes in n8n rather than configuring raw API calls. The integration supports creating, reading, updating, and deleting contacts, deals, organizations, and notes.
...
Self-hosted n8n gives you complete control -- data never leaves your servers. For n8n Cloud, data is processed in the EU. In both cases, n8n itself does not access or store your workflow data beyond execution. Combined with a GDPR-compliant CRM like Customermates (EU-hosted, EUR 7/user/month), you can build fully compliant automation pipelines.
