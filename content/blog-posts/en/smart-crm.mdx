...
Yes. [Customermates](/) is an open-source smart CRM under AGPL-3.0, with 57 native MCP tools that let any AI agent operate it. Self-hostable via Docker; cloud from €9 per user per month.
