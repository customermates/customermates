...
Yes. [Customermates](/) is an open-source smart CRM under AGPL-3.0, with 46 native MCP tools that let any AI agent operate the records and the unified inbox. Self-hostable via Docker; cloud from €12 per user per month.
