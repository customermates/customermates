...
**Customermates.** Open-source, MCP-first CRM. The distinguishing angle is that any AI assistant that supports MCP can operate the full CRM: creating contacts, updating deals, assigning tasks, and firing webhooks, all through a structured API. Free to self-host; cloud from €12/user/month (Starter).
...
Pricing starts at €12 per user per month (€10 billed yearly) on the Starter tier, or is free to self-host. The unified inbox is on Pro from €29 per user per month. The [full feature list is on the pricing page](/pricing).
...
For teams under 10 people, folk and Customermates are strong options because pricing is simple and per-user, with Customermates starting at €12/month on Starter. Customermates adds the benefit of being self-hostable and fully open source. For teams willing to invest more, Attio and Clarify offer more sophisticated automation.
...
There is a 7-day free trial with full Pro access, no credit card required. Self-hosting is free. The cloud version starts at €12 per user per month (€10 yearly, Starter tier).
