...
**Customermates.** Open-source, MCP-first CRM. The distinguishing angle is that any AI assistant that supports MCP can operate the full CRM: creating contacts, updating deals, assigning tasks, and firing webhooks, all through a structured API. Free to self-host; cloud from [[commercial.price.starter.monthly]]/user/month (Starter).
...
| Pricing             | Simple per-user tiers    | Tiered by feature plus AI add-on |
...
Customermates is built around two co-equal capabilities. First, MCP is a first-class feature: it exposes [[derived.mcp.tools.total]] MCP tools covering contacts, organizations, deals, services, tasks, custom fields, widgets, and webhooks, so any AI assistant that supports MCP can operate the full CRM without leaving its context window. Second, it ships a native unified inbox for email, LinkedIn, WhatsApp, Instagram, and Telegram, and the same agents can read, draft, and send across every channel. Very few CRMs have native messaging on those channels, and almost none let an AI operate it.

The practical result: when I connect Customermates to Claude, I can say "update the deal with Acme to Proposal Sent and create a follow-up task for Thursday" and the CRM updates immediately. No clicking, no form fields. And because the inbox is native, the same agent can draft the LinkedIn or WhatsApp reply that moves the deal.

Pricing starts at [[commercial.price.starter.monthly]] per user per month on the Starter tier, or is free to self-host. The unified inbox is on Pro from [[commercial.price.pro.monthly]] per user per month. The [full feature list is on the pricing page](/pricing).
...
<Faq>
<FaqItem question="What is an AI-native CRM?">
...
<FaqItem question="What is the difference between AI-native and AI-first CRM?">
...
<FaqItem question="Can a CRM be both open source and AI-native?">
...
<FaqItem question="How does a generative AI CRM differ from an AI-native one?">
...
<FaqItem question="Which AI-native CRM is best for small teams?">
For teams under 10 people, folk and Customermates are strong options because pricing is simple and per-user, with Customermates starting at [[commercial.price.starter.monthly]]/month on Starter. Customermates adds the benefit of being self-hostable and fully open source. For teams willing to invest more, Attio and Clarify offer more sophisticated automation.
</FaqItem>

<FaqItem question="How long does it take to migrate from a legacy CRM to an AI-native one?">
...
<FaqItem question="What is agentic CRM and how does it differ from AI-native?">
...
<FaqItem question="Is Customermates free?">
There is a [[commercial.trial.days]]-day free trial with full Pro access, no credit card required. Self-hosting is free. The cloud version starts at [[commercial.price.starter.monthly]] per user per month (Starter tier).
</FaqItem>
</Faq>
