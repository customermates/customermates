...
The CRM I build. Open-source, self-hostable or EU-hosted cloud. From €12/user/month (€10 billed yearly), Starter; the native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram) is on Pro at €29, and AI agents can operate it. Modern Pipedrive replacement category. Agent-native via MCP, n8n community node, full REST API, 26 webhook events.
