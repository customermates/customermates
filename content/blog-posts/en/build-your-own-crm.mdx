...
**Realistic cost.** Self-hosted: server costs ($20-$200 per month depending on team size) plus your own time to operate it. Cloud-hosted by the project: usually €7 to €15 per user per month, in the same range as paid CRMs but with the source code as your exit option. Customization: zero to $5,000 if you hire a dev for a specific extension.
