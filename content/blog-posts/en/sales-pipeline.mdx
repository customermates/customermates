...
Customermates supports all of these templates out of the box. You can create custom pipelines with as many or as few stages as you need, at 7 euros per user per month with all features included.
...
- **All features for 7 euros per user per month**: No tiered pricing, no feature gates, no "contact sales for enterprise pricing." Every user gets every feature.
