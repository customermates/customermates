...
- **The full core CRM from [[commercial.price.starter.monthly]] per user per month**: transparent published tiers, no "contact sales for enterprise pricing." Every user gets every core feature; you only pay more for messaging scale.
