...
| **Customermates** | 8 types, unlimited per entity | 5 built-in entities, all custom-fieldable | Yes, full + 15 webhooks + MCP | Yes (Docker) | €9/user/mo |
...
If you want a customizable CRM that already includes the API, webhooks, custom fields, and an MCP server for AI agent automation, [Customermates](/pricing) ships at €9 per user per month. The first seven days are free, no credit card. If self-hosting is a hard requirement, the same product is on [GitHub](https://github.com/customermates/customermates) under AGPL-3.0.
