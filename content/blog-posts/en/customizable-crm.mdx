...
1. **Multiple typed custom field types.** Plain text is not enough. You need date, datetime, currency, single-select, multi-select, link, email, phone. Customermates ships eight typed field types, [HubSpot](https://www.hubspot.com/products/crm/customization) and [Zoho](https://www.zoho.com/crm/customization.html) ship more.
...
| **Customermates** | 8 types, unlimited per entity | 5 built-in entities, all custom-fieldable | Yes, full + 15 webhooks + MCP | Yes (Docker) | €7/user/mo |
...
If you want a customizable CRM that already includes the API, webhooks, custom fields, and an MCP server for AI agent automation, [Customermates](/pricing) ships at €7 per user per month. The first seven days are free, no credit card. If self-hosting is a hard requirement, the same product is on [GitHub](https://github.com/customermates/customermates) under AGPL-3.0.
...
**What is the difference between customizable CRM and custom CRM?**
