...
1. **Multiple typed custom field types.** Plain text is not enough. You need date, datetime, currency, single-select, link, email, phone. Customermates ships ten typed field types. [HubSpot](https://www.hubspot.com/products/crm/customization) and [Zoho](https://www.zoho.com/crm/customization/) are in the same range; Salesforce ships far more.
