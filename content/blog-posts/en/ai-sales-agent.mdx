...
**CRM cost.** The agent is only as useful as the CRM it feeds data into. Customermates cloud starts at €7/user/month with full API and MCP access included. Compare on the [Pipedrive alternative](/compare/pipedrive-alternative) page if you are evaluating options.
...
The [Customermates MCP integration](/features/api) is the starting point for this setup. [Pricing](/pricing) for Customermates cloud starts at €7 per user per month (yearly), with a free self-hosted option and a 7-day free trial.
