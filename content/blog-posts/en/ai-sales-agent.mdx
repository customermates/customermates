...
The [Customermates MCP integration](/features/api) is the starting point for this setup. [Pricing](/pricing) for Customermates cloud starts at €9 per user per month (yearly), with a free self-hosted option and a 3-day free trial.
