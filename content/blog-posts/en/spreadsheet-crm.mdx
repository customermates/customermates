...
Yes. Customermates is licensed under AGPL-3.0 and free to self-host via `docker compose up -d`. Two containers, 30 minutes, the system is ready. Other options: EspoCRM, SuiteCRM, Krayin. The Customermates cloud version starts at [[commercial.price.starter.monthly]] per user per month (Starter) and is hosted in the EU region.
</FaqItem>
