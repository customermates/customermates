...
| Customermates | Founders and small teams who want AI agents to operate the CRM | Free self-hosted, cloud from €12/user/month (€10 yearly, Starter) | Yes (Docker, AGPL-3.0) | Open source, MCP-native |
...
Pricing ranges from free to over $300 per user per month. Free tiers (HubSpot Starter, Bitrix24, Customermates self-hosted) work for small teams. Mid-market platforms (Pipedrive, Zoho, Customermates cloud) cluster around €12 to €30 per user per month. Enterprise CRMs (Salesforce, Microsoft Dynamics) start around $75 per user per month and rise quickly with edition tiers and add-ons.
