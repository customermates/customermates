...
| Salesforce Sales Cloud  | Enterprise sales teams with complex processes                  | $25-$350/user/month per edition                                                        | No                                         | Customization, ecosystem               |
| Pipedrive               | Pipeline-first sales teams that hate complexity                | $14-$79/user/month                                                                     | No                                         | Clean pipeline UX                      |
...
| Customermates           | Founders and small teams who want AI agents to operate the CRM | Free self-hosted, cloud from [[commercial.price.starter.monthly]]/user/month (Starter) | Yes (Docker, AGPL-3.0)                     | Open source, MCP-native                |
...
This is the bet behind Customermates. It exposes [[derived.mcp.tools.total]] MCP tools and [[derived.webhooks.events.total]] webhook events out of the box, with native MCP available from the Starter tier. If you already use Claude or ChatGPT, the pipeline updates itself: deals move on their own, follow-ups get drafted, contact notes stay current. A native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram, on the Pro tier) puts every customer conversation in the same system, and the same agents can read and reply across it. You stop being the person typing into the CRM. The mechanism is documented, but the outcome is the point.
...
Customermates is AGPL-3.0 and Docker-deployable, so you can run it entirely on your own infrastructure if that is the constraint. Cloud is from [[commercial.price.starter.monthly]] per user per month on the Starter tier, full core CRM included, with EU hosting. Pricing details and what is in each tier live on the [pricing page](/pricing).
...
<Faq>
<FaqItem question="What is an operational CRM in simple terms?">
...
<FaqItem question="What are the three types of operational CRM?">
...
<FaqItem question="What is the difference between operational and analytical CRM?">
...
<FaqItem question="Is Salesforce an operational CRM?">
...
<FaqItem question="Is HubSpot an operational CRM?">
...
<FaqItem question="How is AI changing operational CRM?">
...
<FaqItem question="How much does an operational CRM cost?">
Pricing ranges from free to over $300 per user per month. Free or self-operated options such as Bitrix24's free tier and the Customermates community self-host build can work for small teams with different operating trade-offs. The Customermates managed service currently starts at [[commercial.price.starter.monthly]] per user per month. Other mid-market platforms such as Pipedrive and Zoho often advertise entry offers in a broad €12 to €30 range, but compare their current edition, cadence, tax treatment, and feature limits directly. Enterprise CRMs such as Salesforce and Microsoft Dynamics rise quickly with edition tiers and add-ons.
</FaqItem>

<FaqItem question="How long does operational CRM implementation take?">
...
The shift worth paying attention to in 2026 is who does the operating. CRMs that treat AI agents as first-class operators (clean APIs, MCP tools, webhook events, open source) will quietly pull ahead of the ones that treat them as a feature to add later. That is the bet behind Customermates: an operational CRM that authorized Claude or ChatGPT clients can update through MCP, free to self-host under AGPL-3.0, with a managed application database configured in an EU region and a managed service from [[commercial.price.starter.monthly]] per user per month.
...
[Try Customermates free for [[commercial.trial.days]] days](/auth/signup) · [See pricing](/pricing) · [CRM software overview](/blog/crm-software)
