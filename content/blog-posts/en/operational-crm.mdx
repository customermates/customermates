...
| Customermates | Founders and small teams who want AI agents to operate the CRM | Free self-hosted, €9/user/month cloud (yearly) | Yes (Docker, AGPL-3.0) | Open source, MCP-native |
...
Customermates is AGPL-3.0 and Docker-deployable, so you can run it entirely on your own infrastructure if that is the constraint. Cloud is from €9 per user per month yearly (€12 monthly), all features included, with EU hosting. Pricing details and what is in each tier live on the [pricing page](/pricing).
