...
**AI agents that operate the CRM**: Claude, ChatGPT, and Gemini read and write records directly through a native MCP integration (46 tools). Deal stages move, follow-ups get drafted, and contact notes stay current, and the same agents can draft and send replies across the unified inbox.
...
**Transparent pricing**: from €12 per user per month with the full core CRM included. No per-contact fees, no hidden costs. For a typical German SME team of five, that is €60 per month on Starter for a full-featured CRM alongside Lexware Office.
...
The investment is minimal: from €12 per user per month and a few hours of setup time. The return, recovered leads, consistent follow-ups, and sales visibility, pays for itself within the first month.
...
The best CRM to pair with Lexware Office is one that integrates through n8n, supports the German market, and is GDPR-compliant. Customermates fits these criteria from €12 per user per month with the full core CRM, EU hosting, and native n8n integration for syncing contacts, triggering invoices, and automating follow-ups between both systems.
...
Customermates costs from €12 per user per month with the full core CRM included. For a five-person team, that is €60 per month on Starter. Combined with a Lexware Office subscription (starting around €7.90 net per month on the S tier), you get a complete business management setup, accounting plus CRM, for well under €100 per month.

### Is there a free CRM that works with Lexoffice?

Customermates is open-source and can be self-hosted at no licensing cost, making it a free CRM option that connects to Lexware Office through n8n. You only pay for hosting infrastructure. If you prefer managed hosting, the cost starts at €12 per user per month.
