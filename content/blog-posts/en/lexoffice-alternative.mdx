...
**Native unified inbox**: Email, LinkedIn, WhatsApp, Instagram, and Telegram in one inbox inside the CRM. Customer conversations across every channel land against the contact, so nothing is scattered between apps. For German SMEs whose customers reach out by email and WhatsApp, this keeps every thread in one place.

**AI agents that operate the CRM**: Claude, ChatGPT, and Gemini read and write records directly through a native MCP integration ([[derived.mcp.tools.total]] tools). Deal stages move, follow-ups get drafted, and contact notes stay current, and the same agents can draft and send replies across the unified inbox.
...
**GDPR support with a DPA and SCCs**: Both Customermates and Lexware Office serve the German-speaking market and take data protection seriously. Customermates uses an EU region for its managed database, offers a DPA and SCCs, and supports self-hosting; it holds no compliance certification, and connected providers require separate review.

**Transparent pricing**: from [[commercial.price.starter.monthly]] per user per month with the full core CRM included. No per-contact fees, no hidden costs. For a typical German SME team of five, that is [[commercial.price.starter.monthly.seats.5]] per month on Starter for a full-featured CRM alongside Lexware Office.
...
The investment is minimal: from [[commercial.price.starter.monthly]] per user per month and a few hours of setup time. The return, recovered leads, consistent follow-ups, and sales visibility, pays for itself within the first month.
...
| Tier        | Focus (from, net/mo)                        | Contact Features                   | CRM Gaps                                    |
| ----------- | ------------------------------------------- | ---------------------------------- | ------------------------------------------- |
| S (€7.90)   | Invoicing and quotes, no banking            | Basic contact list                 | No pipeline, no automation, no history      |
| M (€12.90)  | Automated receipt capture, online banking   | Contact list + invoice linking     | No pipeline, no follow-ups, no tasks        |
| L (€21.90)  | Advanced order management, XRechnung        | Kundenmanager + upsell analytics   | No pipeline, no automation, no lead capture |
| XL (€32.90) | Full suite including payroll and API access | Full contact features + API access | No pipeline, no workflow automation         |
...
<Faq>
<FaqItem question="Can Lexoffice be used as a CRM?">
...
<FaqItem question="What is the best CRM to use with Lexoffice?">
The best CRM to pair with Lexware Office is one that integrates through n8n, supports the German market, and is GDPR-compliant. Customermates fits these criteria from [[commercial.price.starter.monthly]] per user per month with the full core CRM, EU hosting, and native n8n integration for syncing contacts, triggering invoices, and automating follow-ups between both systems.
</FaqItem>

<FaqItem question="Can I connect Lexoffice with a CRM?">
...
<FaqItem question="How much does it cost to add a CRM to Lexoffice?">
Customermates costs from [[commercial.price.starter.monthly]] per user per month with the full core CRM included. For a five-person team, that is [[commercial.price.starter.monthly.seats.5]] per month on Starter. Add the current Lexware Office subscription (starting around €7.90 net per month on the S tier) to calculate the complete accounting-plus-CRM total.
</FaqItem>

<FaqItem question="Is there a free CRM that works with Lexoffice?">
Customermates is open-source and can be self-hosted at no licensing cost, making it a free CRM option that connects to Lexware Office through n8n. You only pay for hosting infrastructure. If you prefer managed hosting, the cost starts at [[commercial.price.starter.monthly]] per user per month.
</FaqItem>

<FaqItem question="Does the Lexoffice Kundenmanager replace a CRM?">
...
<FaqItem question="Do I need to replace Lexoffice if I get a CRM?">
...
<FaqItem question="What is the difference between Lexoffice and Lexware Office?">
