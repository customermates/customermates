...
All of this from [[commercial.price.starter.monthly]] per user per month, with no per-automation pricing. Every core feature is in every tier; you only pay more for messaging scale.
