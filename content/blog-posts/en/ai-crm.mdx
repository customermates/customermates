...
**Step 1.** Pick a CRM with a real MCP server. Customermates ships one with [46 tools covering every CRM operation](/features/api) (create contacts, update deals, link entities, configure custom columns). Salesforce, HubSpot, and Pipedrive offer MCP through community servers but coverage is partial.
