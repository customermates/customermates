...
**You want AI in your CRM, your team is 1-30 people, and you do not want a connector tax → native.** Use Customermates. Free to self-host via Docker, €7 per user per month on EU cloud (yearly), open-source AGPL-3.0. Claude operates it directly through 57 MCP tools.
...
[Customermates](/) is €7 per user per month on EU cloud or free to self-host via Docker, with native Claude support through 57 MCP tools. There is no separate AI tier or connector charge.
