...
hero:
  ...
  description: "What people mean by Claude CRM, what Claude can actually do inside a CRM, and the open-source CRM where Claude already operates 45 MCP tools out of the box."
...
| Cost sensitivity | Cannot afford €12/user | Can afford a small subscription |
...
[Customermates](/) is an open-source CRM built MCP-first. It exposes 45 native MCP tools: 43 across nine toolsets that cover every entity in the data model, plus two always-on deep-research connectors.

- **Records (17):** filter, count, search, get, create, update, link, unlink, delete, plus note and custom-field edits across contacts, organizations, deals, services, and tasks
- **Messaging (9):** read, draft, and send across email, LinkedIn, WhatsApp, Instagram, and Telegram
- **Social and Sales Navigator (8):** social-post tracking and LinkedIn Sales Navigator search
- **Docs (2):** search and read the product documentation
- **Workspace (2):** current user and workspace context
- **Admin (2):** roles and company management
- **Custom columns (1):** manage custom fields across ten field types
- **Widgets (1):** dashboard widgets
- **Webhooks (1):** manage webhook subscriptions
- **Deep research (2):** always-on `search` and `fetch` connectors

Those nine messaging tools are the second half of the story. The same agents that keep records current also operate a native unified inbox, reading, drafting, and sending across email, LinkedIn, WhatsApp, Instagram, and Telegram from one tool surface. Messaging and social tools require a Pro or Business tier; the core record, custom-field, and workspace tools are available from the Starter tier.
...
1. **Customermates.** Native MCP support. 45 tools. Open source. Native Claude integration with no separate AI tier.
...
**You want AI in your CRM, your team is 1-30 people, and you do not want a connector tax → native.** Use Customermates. Free to self-host via Docker, €12 per user per month on EU cloud (€10 yearly, Starter tier), open-source AGPL-3.0. Claude operates it directly through 45 MCP tools, and the same agents run the unified inbox across email, LinkedIn, WhatsApp, Instagram, and Telegram on Pro and up.
...
[Customermates](/) is from €12 per user per month on EU cloud or free to self-host via Docker, with native Claude support through 45 MCP tools. The core record and workspace tools are in every tier from Starter; there is no separate AI tier or connector charge.
