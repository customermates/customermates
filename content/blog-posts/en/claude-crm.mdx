...
hero:
  ...
  description: "What people mean by Claude CRM, what Claude can actually do inside a CRM, and the open-source CRM where Claude already operates 46 MCP tools out of the box."
...
[Customermates](/) is an open-source CRM built MCP-first. It exposes 46 native MCP tools: 44 across ten toolsets that cover every entity in the data model, plus two always-on deep-research connectors.
...
1. **Customermates.** Native MCP support. 46 tools. Open source. Native Claude integration with no separate AI tier.
...
**You want AI in your CRM, your team is 1-30 people, and you do not want a connector tax → native.** Use Customermates. Free to self-host via Docker, €12 per user per month on EU cloud (€10 yearly, Starter tier), open-source AGPL-3.0. Claude operates it directly through 46 MCP tools, and the same agents run the unified inbox across email, LinkedIn, WhatsApp, Instagram, and Telegram on Pro and up.
...
[Customermates](/) is from €12 per user per month on EU cloud or free to self-host via Docker, with native Claude support through 46 MCP tools. The core record and workspace tools are in every tier from Starter; there is no separate AI tier or connector charge.
