...
|---|---|---|---|
| **Customermates** | €7 (annual) | Open source, AI-agent native, made in Germany | Yes, EU/DE hosting |
...
**Entry tier, $7 to $20 per user.** Customermates ($7), Freshsales ($9), Monday ($12), Pipedrive ($14), Zoho ($14). Full CRM functionality for SMBs.
...
- **€7 per user per month in the cloud.** All features included: contacts, companies, deals, tasks, pipeline, workflow automation, API, audit log, permissions.
...
Prices range from free to over $300 per user per month. Most SMBs pay $10 to $30 per user. Customermates is €7 per user per month on the annual plan, with all features and no upsells.
