...
- **From €12 per user per month in the cloud (Starter),** with the full core CRM: contacts, companies, deals, services, tasks, custom fields, workflow automation, API, audit log, permissions. Pro at €29 adds the unified inbox, Business at €59 adds shared team accounts and more connected accounts per user.
