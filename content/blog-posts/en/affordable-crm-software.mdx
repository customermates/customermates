...
**What's included at [[commercial.price.starter.monthly]]/user/month (Starter):** unlimited deals, contacts, organizations, custom fields, custom pipelines, role-based permissions, mobile app, REST API, [[derived.mcp.tools.total]] [MCP tools](/docs/mcp), [[derived.webhooks.events.total]] webhook events, [n8n integration](/blog/n8n-for-beginners-build-your-first-workflow), [self-hosted](/features/self-hosted) option with the same source code. The unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram), calendar sync, and Sales Navigator move to Pro at [[commercial.price.pro.monthly]]/user/month. Every core CRM feature above is in every tier; you only pay more for messaging scale.
