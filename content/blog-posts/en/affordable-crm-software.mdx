...
The CRM I build. Open-source, EU-hosted or self-hosted. Cloud tiers from €12/user/month (€10 billed yearly) up to €69 for Business, or self-hosted free forever. Modern Pipedrive replacement category, agent-native via MCP, full REST API, n8n community node. Best for teams that value data ownership, EU hosting, and AI-driven workflows. Watch out for: younger project than Zoho or HubSpot, smaller community.

**What's included at €12/user/month (Starter):** unlimited deals, contacts, organizations, custom fields, custom pipelines, role-based permissions, mobile app, REST API, 46 [MCP tools](/docs/mcp), 26 webhook events, [n8n integration](/blog/n8n-for-beginners-build-your-first-workflow), [self-hosted](/features/self-hosted) option with the same source code. The unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram), calendar sync, and Sales Navigator move to Pro at €29/user/month. Every core CRM feature above is in every tier; you only pay more for messaging scale.
