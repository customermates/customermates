...
**Important:** With many providers, essential features like advanced automation, telephony or additional pipelines are only available in more expensive plans. With Customermates, every core CRM feature is included in every plan from [[commercial.price.starter.monthly]]/user/month; higher tiers only add messaging scale (unified inbox on Pro, more connected accounts on Business). Learn more at [Pricing](/pricing).
