...
- **From EUR 12 per user per month** for the full core CRM, keeps CRM costs low when you are already investing in ERP
...
Customermates, with its n8n automation, full API, and pricing from EUR 12 per user per month, gives you a CRM that is designed for integration from the ground up. Connect it to SAP, Dynamics, Odoo, or any ERP with an API, without writing code and without paying for a separate integration platform.
