...
- If **agent-native automation** (Claude, ChatGPT, or Codex operating the CRM) and **open source** are non-negotiable, Customermates is the direct fit. Cloud from €7 per user per month yearly, free to self-host.
