...
- If **agent-native automation** (Claude, ChatGPT, or Codex operating the CRM) and **open source** are non-negotiable, Customermates is the direct fit. Cloud from €12 per user per month (€10 yearly, Starter tier), free to self-host.
