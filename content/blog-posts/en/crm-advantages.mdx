...
Customermates exposes [[derived.mcp.tools.total]] tools through an [MCP server](https://modelcontextprotocol.io) covering every CRM operation, plus a native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram). The agent reads contacts, writes notes, updates fields, links entities, configures custom columns, and reads or sends messages. In practice: after a sales call you forward the email summary to Claude, and Claude updates the deal stage, writes the contact note, and creates the follow-up task without you logging into the CRM.
...
- If **agent-native automation** (Claude, ChatGPT, or Codex operating the CRM) and **open source** are non-negotiable, Customermates is the direct fit. Cloud from [[commercial.price.starter.monthly]] per user per month (Starter tier), free to self-host.
...
<Faq>
<FaqItem question="What are the advantages of using a CRM?">
...
<FaqItem question="What are the pros and cons of CRM?">
...
<FaqItem question="What are the four types of CRM?">
...
<FaqItem question="How much does a CRM cost?">
Free-tier options like HubSpot Free or self-hosted Customermates Community Edition cost $0. Cloud CRMs start at [[commercial.price.starter.monthly]] per user per month (Customermates) or $14 (Pipedrive). Mid-market options run $25 to $50 per user (HubSpot Sales, Salesforce Sales Cloud). Enterprise platforms run higher. On top come implementation costs from $0 (self-serve) to $250,000 (Salesforce Enterprise with consulting).
</FaqItem>

<FaqItem question="Does a small business need a CRM?">
...
<FaqItem question="How long does CRM implementation take?">
...
<FaqItem question="When does a CRM start to pay for itself?">
...
<FaqItem question="Should I get a CRM if I have fewer than 50 contacts?">
