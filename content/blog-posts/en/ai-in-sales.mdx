---
title: "AI in Sales: Use Cases, Tools, and How to Get Started"
...
- Customermates: open-source CRM exposing [[derived.mcp.tools.total]] MCP tools; any MCP-compatible AI agent (Claude, GPT-4o, custom models) can operate the full CRM autonomously. Cloud from [[commercial.price.starter.monthly]]/user/month (Starter), free to self-host.
...
Customermates provides [[derived.mcp.tools.total]] MCP tools covering all entities: contacts, organizations, deals, services, tasks, custom fields, and webhooks. An AI agent connected via MCP can accompany the entire sales process, from lead creation to close note.
...
<FaqItem question="Which AI tools are suitable for sales?">
...
<FaqItem question="What does an AI-powered sales workflow cost?">
With an open-source CRM like Customermates ([[commercial.price.pro.monthly]]/user/month for the Pro tier's unified inbox, with a free self-hosting option), an MCP-capable AI model, and n8n for automation, you can build a complete AI sales workflow whose total depends on the model and n8n hosting you choose.
</FaqItem>

<FaqItem question="What is the difference between AI for sales and sales automation?">
...
<FaqItem question="How do I get started with AI in B2B sales?">
...
<FaqItem question="What is the role of the CRM in an AI sales stack?">
