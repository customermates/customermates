...
- Customermates: open-source CRM exposing 45 MCP tools; any MCP-compatible AI agent (Claude, GPT-4o, custom models) can operate the full CRM autonomously. Cloud from €12/user/month (Starter), free to self-host.
...
Customermates provides 45 MCP tools covering all entities: contacts, organizations, deals, services, tasks, custom fields, and webhooks. An AI agent connected via MCP can accompany the entire sales process, from lead creation to close note.
