...
- Customermates: open-source CRM exposing 46 MCP tools; any MCP-compatible AI agent (Claude, GPT-4o, custom models) can operate the full CRM autonomously. Cloud from €12/user/month (Starter), free to self-host.
...
Customermates provides 46 MCP tools covering all entities: contacts, organizations, deals, services, tasks, custom fields, and webhooks. An AI agent connected via MCP can accompany the entire sales process, from lead creation to close note.
...
With an open-source CRM like Customermates (from €29/user/month for the Pro tier's unified inbox, free self-hosting option), an MCP-capable AI model, and n8n for automation, a complete AI sales workflow is achievable for well under €60 per user per month.
