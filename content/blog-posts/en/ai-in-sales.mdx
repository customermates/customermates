...
With an open-source CRM like Customermates (from €9/user/month, free self-hosting option), an MCP-capable AI model, and n8n for automation, a complete AI sales workflow is achievable for well under €50 per user per month.
