...
| Native unified inbox (LinkedIn, WhatsApp, Instagram, Telegram) | <StatusAvailable /> | <StatusPartial />     | <StatusPartial />     | <StatusUnavailable /> | <StatusPartial />     | <StatusUnavailable /> |
| AI agents operate the CRM (MCP)                                | <StatusAvailable /> | <StatusPartial />     | <StatusPartial />     | <StatusPartial />     | <StatusPartial />     | <StatusUnavailable /> |
...
| ----------------------------------------------- | ----------------------------------------- | ---------------------- | -------------------------------------------- |
| **Customermates**                               | From [[commercial.price.starter.monthly]] | SMBs, startups         | Open source, GDPR-native, n8n automation     |
...
For a team of 10 users with full feature access over one year, the cost difference is dramatic: Customermates Starter totals [[commercial.price.starter.monthly.seats.10.months.12]] while Salesforce Enterprise exceeds €21,000. Even mid-range options like HubSpot Professional reach €10,800.
...
- **Customermates managed service:** Starter is [[commercial.price.starter.monthly]] per user per month; use the [pricing page](/pricing) for the current plan contract.
- **Other entry-level market offers (roughly €12-20/user at the observed entry price):** Pipedrive and Zoho. Verify each vendor's current edition, billing cadence, tax treatment, and feature limits before comparing.
...
At this stage, affordability matters. A CRM that costs [[commercial.price.starter.monthly]]/user/month with the full core CRM included removes the budget objection entirely. [CRM for small business](/blog/crm-for-small-business)
...
A CRM with a DPA and SCCs system should meet these requirements:
...
<FaqItem question="What are the best CRM systems?">
...
CRM pricing ranges from free (with significant limitations) to over €300/user/month for enterprise platforms. Most small businesses pay between €10 and €30 per user per month. Customermates costs from [[commercial.price.starter.monthly]]/user/month with the full core CRM included, no add-ons, no surprises. [Detailed cost breakdown](/blog/crm-cost)
</FaqItem>

<FaqItem question="Is a CRM worth it for small business?">
...
<FaqItem question="What is the difference between CRM and ERP?">
...
<FaqItem question="Can I self-host a CRM system?">
...
- **AI agents operate the CRM:** Claude, ChatGPT, or Gemini read and write the CRM directly through a native MCP integration with [[derived.mcp.tools.total]] tools, so deal stages move, notes stay current, and follow-ups get drafted without anyone typing into the system
- **Native unified inbox:** email, LinkedIn, WhatsApp, Instagram, and Telegram in one inbox inside the CRM, with the same AI agents able to read, draft, and send across every channel (Pro tier and up)
- **The full core CRM from [[commercial.price.starter.monthly]]/user/month:** [Contact management](/features/contact-management), [pipeline](/features/pipeline), [email integration](/features/email-integration), [workflow automation](/features/workflow-automation), custom fields, audit logging, and API access, no add-ons, no tier restrictions
- **GDPR-focused:** managed application database in an EU region, disclosed cloud subprocessors and transfer safeguards, plus a self-hosting option
...
- **No vendor lock-in:** Open source lets you inspect the system. Read supported records through REST API or MCP anytime
