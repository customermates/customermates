...
- **All features for €10/user/month:** [Contact management](/features/contact-management), [pipeline](/features/pipeline), [email integration](/features/email-integration), [workflow automation](/features/workflow-automation), AI agents, audit logging, and API access — no add-ons, no tier restrictions
