...
[Customermates](/) is the closest in concept: an open-source CRM where any MCP-compatible AI agent (Claude, ChatGPT, Gemini) reads and writes records directly through 46 native tools, alongside a native unified inbox the same agents can operate. Free to self-host, from €12/user/month on EU cloud.
