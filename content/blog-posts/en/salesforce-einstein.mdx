...
[Customermates](/) is the closest in concept: an open-source CRM where any MCP-compatible AI agent (Claude, ChatGPT, Gemini) reads and writes records directly through 57 native tools. Free to self-host, €7/user/month on EU cloud.
