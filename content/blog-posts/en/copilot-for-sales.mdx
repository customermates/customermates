...
[Customermates](/) is an open-source CRM with 46 native MCP tools that let Claude, ChatGPT, and Gemini operate the CRM directly, including a native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram). It produces the same workflow outcomes (drafted emails, meeting summaries, deal updates) without the layered Microsoft license stack. Free to self-host via Docker; cloud from €29 per user per month for the Pro tier that includes the unified inbox.
