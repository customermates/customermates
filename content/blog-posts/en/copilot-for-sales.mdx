...
If your CRM is Salesforce instead of Dynamics, replace the Dynamics line with Salesforce Sales Cloud Pro Suite ($100/user/month, more for Enterprise) for a comparable stack.
...
**[Customermates](/).** The open-source alternative for teams that want AI inside the CRM without the license stack. Customermates is an open-source CRM with [[derived.mcp.tools.total]] native [MCP](/features/api) tools that let Claude, ChatGPT, and Gemini read and write contacts, organizations, deals, services, and tasks directly, and operate a native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram) from the same chat. Instead of paying $50/user for an AI layer plus $100/user for a CRM, you pay [[commercial.price.pro.monthly]] per user per month for the Pro tier (the one that adds the unified inbox, so drafted emails actually send from it) and bring your own AI assistant (which most teams already have a subscription to). The result is the same outcome (drafted emails, summarized meetings, updated records, all from inside the AI assistant your team uses) at a fraction of the seat cost and without lock-in to Microsoft or Salesforce.
...
The user experience differs (in-app for Copilot, in-chat for Customermates), but the deal-record outcome is the same. The cost difference is large, and the platform commitment is much lower.

## Frequently asked questions

<Faq>
<FaqItem question="What is Microsoft Copilot for Sales?">
...
<FaqItem question="Is Copilot for Sales a CRM?">
...
<FaqItem question="How much does Copilot for Sales cost?">
...
<FaqItem question="What CRMs does Copilot for Sales work with?">
...
<FaqItem question="How do I turn on Copilot for Sales?">
...
<FaqItem question="Is Copilot for Sales worth it?">
...
<FaqItem question="What is the difference between Copilot for Sales and Copilot in Sales?">
...
<FaqItem question="Is Copilot for Sales being discontinued?">
...
<FaqItem question="Does Copilot for Sales work outside the Microsoft stack?">
...
<FaqItem question="What is the open-source alternative to Copilot for Sales?">
[Customermates](/) is an open-source CRM with [[derived.mcp.tools.total]] native MCP tools that let Claude, ChatGPT, and Gemini operate the CRM directly, including a native unified inbox (email, LinkedIn, WhatsApp, Instagram, Telegram). It produces the same workflow outcomes (drafted emails, meeting summaries, deal updates) without the layered Microsoft license stack. Free to self-host via Docker; cloud from [[commercial.price.pro.monthly]] per user per month for the Pro tier that includes the unified inbox.
</FaqItem>
</Faq>
