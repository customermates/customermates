...
- Managed white-label branding through the Enterprise tier and a dedicated agency program
- AI agents operate the CRM: Claude, ChatGPT, and Gemini read and write records through 45 native MCP tools, so client data entry runs through the agent
...
**Pricing**: the base CRM starts at €12 per user per month (Starter). White-label branding is available on the Enterprise tier (custom pricing) and through the agency program, which is a €149 monthly platform fee plus €5 per user per month. Self-hosting under AGPL-3.0 has €0 licensing, and because you hold the source you can rebrand at the code level yourself.
...
Costs vary by approach. GoHighLevel charges $297-497 per month for agency-level white labeling. Vendasta starts at $79 per month plus scaling fees. Open-source self-hosted CRMs have no licensing cost but require hosting and maintenance. With Customermates, the base CRM starts at €12 per user per month, and managed white-label runs through its agency program (a €149 monthly platform fee plus €5 per user per month) or a custom Enterprise plan. Most agencies resell at €20-50 per user, creating healthy margins.
...
1. **Evaluate Customermates**: Open-source and self-hostable, base CRM from €12 per user per month, with managed white-label through the agency program (€149 monthly platform fee plus €5 per user) or the Enterprise tier, GDPR-native, n8n automation included
