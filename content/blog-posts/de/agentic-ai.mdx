...
**Model Context Protocol (MCP).** Ein offener Standard von Anthropic, der es KI-Agenten ermöglicht, über eine standardisierte Schnittstelle auf externe Tools und Daten zuzugreifen. Customermates implementiert MCP mit 46 Tools, die alle CRM-Entitäten abdecken. Das erlaubt es, Claude oder ein anderes MCP-kompatibles Modell direkt als CRM-Agenten zu nutzen.
