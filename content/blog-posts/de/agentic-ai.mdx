---
title: "Agentische KI: Definition, Funktionsweise, Praxisbeispiele"
...
Customermates ist so konzipiert, dass KI-Agenten über [MCP (Model Context Protocol)](/features/api) direkt auf das CRM zugreifen können. Mit [[derived.mcp.tools.total]] MCP-Tools können Agenten alle Entitäten lesen und schreiben: Kontakte, Organisationen, Deals, Services, Aufgaben und benutzerdefinierte Felder. Das macht Customermates zu einer praktischen Grundlage für agentische KI im [Vertrieb](/blog/ai-in-sales). Die [Preise](/pricing) starten bei [[commercial.price.starter.monthly]] pro Nutzer und Monat (Starter), oder kostenlos selbst gehostet. Wer Salesforce Agentforce als Vergleichspunkt im Kopf hat, findet im [Salesforce-Alternative-Vergleich](/compare/salesforce-alternative) die Gegenüberstellung der agentischen Funktionen.
...
**Model Context Protocol (MCP).** Ein offener Standard von Anthropic, der es KI-Agenten ermöglicht, über eine standardisierte Schnittstelle auf externe Tools und Daten zuzugreifen. Customermates implementiert MCP mit [[derived.mcp.tools.total]] Tools, die alle CRM-Entitäten abdecken. Das erlaubt es, Claude oder ein anderes MCP-kompatibles Modell direkt als CRM-Agenten zu nutzen.
...
<Faq>
<FaqItem question="Was ist agentische KI? Definition.">
...
<FaqItem question="Was ist der Unterschied zwischen agentischer KI und KI-Agenten?">
...
<FaqItem question="Welche Beispiele gibt es für agentische KI?">
...
<FaqItem question="Ist agentische KI sicher?">
...
<FaqItem question="Wie unterscheidet sich agentische KI von generativer KI?">
...
<FaqItem question="Was ist ein Multi-Agenten-System?">
...
<FaqItem question="Was ist der Unterschied zwischen agentischer KI und einem Chatbot?">
