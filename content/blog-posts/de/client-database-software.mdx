...
| **Customermates** | **Open Source, KI-nativ, EU-Hosting** | **7 € / Nutzer / Monat (Cloud)** | **Kostenlos selbst hostbar** | **Ja (Docker)** | **AGPL-3.0** | **Nativer MCP-Server** | **Deutschland (Cloud), eigener Server (Self-Host)** |
...
**Preisstaffel.** Self-Hosting kostenlos unter AGPL-3.0, drei Container, eigene Infrastruktur. Cloud ab 7 Euro pro Nutzer pro Monat im Jahresplan, gehostet in Deutschland. Keine Add-on-Aufschläge für Webhooks, API oder MCP, alles im Basistarif.
