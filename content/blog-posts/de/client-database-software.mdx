...
**Der Free-Tier-Realitätscheck.** HubSpot Free wirkt wie ein Geschenk, bis Sie Marketing-Automation, Sequenzen oder Reporting brauchen, dann landen Sie bei 90 Euro pro Platz pro Monat im Sales Hub Professional. Salesforce startet bei 25 Euro pro Nutzer und wächst bei einer typischen Mittelstandsimplementierung schnell auf 1.250 bis 5.000 Euro pro Organisation pro Monat, weil Service Cloud, Marketing Cloud und Add-ons hinzukommen. Pipedrive hat keinen Free-Tier, nur 14 Tage Test, was zumindest ehrlich ist.
...
| ----------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | ---------------------------- | --------------- | ------------ | -------------------------- | --------------------------------------------------- |
| HubSpot CRM       | Marketing-Anbindung                                                  | 15 € / Platz (Sales Hub)                                             | Ja, 1 Mio Kontakte           | Nein            | Nein         | Breeze (eingeschränkt)     | EU-Option                                           |
...
| **Customermates** | **Open Source, KI-nativ, vereinheitlichter Posteingang, EU-Hosting** | **Ab [[commercial.price.starter.monthly]] / Nutzer / Monat (Cloud)** | **Kostenlos selbst hostbar** | **Ja (Docker)** | **AGPL-3.0** | **Nativer MCP-Server**     | **Deutschland (Cloud), eigener Server (Self-Host)** |
...
**Preisstaffel.** Free-Tier kostenlos. Sales Hub Starter 15 Euro pro Platz pro Monat. Sales Hub Professional 90 Euro pro Platz (mit Onboarding-Gebühr). Sales Hub Enterprise 150 Euro pro Platz. Marketing Hub und Service Hub werden separat berechnet, was die reale Rechnung schnell auf das Drei- bis Fünffache des Sales-Hub-Listenpreises bringt.
...
**Spezifische Funktionen.** Drag-and-drop-Pipeline-Ansicht als Kernkonzept. Smart-Docs für Angebote und Verträge. Aktivitäts-basiertes Vertriebsmodell (jeder Deal hat eine nächste Aktion). LeadBooster-Add-on für Chatbot, Webformulare und Live-Chat. Workflow-Automatisierung ab Growth-Plan.

**Preisstaffel.** Nach der Umbenennung der Pipedrive-Pläne im Juli 2025: Lite 14 Euro pro Nutzer pro Monat (jährlich). Growth 39 Euro. Premium 49 Euro. Ultimate 79 Euro. Add-ons wie LeadBooster und Web Visitors kommen oben drauf. Kein Free-Tier, nur 14 Tage Test ohne Kreditkarte.
...
**Schwächen.** Marketing-Funktionen praktisch nicht vorhanden. Reporting limitiert in den unteren Tarifen. Custom Fields im Lite-Plan begrenzt. Per-Nutzer-Pricing wird ab 10 Personen teuer.
...
**Preisstaffel.** Starter Suite 25 Euro pro Nutzer pro Monat. Pro Suite 100 Euro. Enterprise 175 Euro. Unlimited 350 Euro (jährliche Abrechnung erforderlich). Realistische Mittelstandsimplementierung mit Sales Cloud Enterprise plus Service Cloud plus Add-ons landet schnell bei 1.250 bis 5.000 Euro pro Monat für 10 bis 25 Nutzer. Implementierungspartner nicht eingerechnet.
...
Customermates ist ein Open-Source-CRM und damit zugleich Kundendatenbank, gebaut für KI-Agent-Bedienung. Das CRM liefert fünf Entitäten (Kontakte, Unternehmen, Deals, Services, Aufgaben) mit zehn Custom-Field-Typen, zwei Ansichten (Tabelle und Kanban-Karten), einen nativen vereinheitlichten Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram) ab der Pro-Stufe und eine vollständige REST-API.

**Spezifische Funktionen.** Eingebauter MCP-Server mit [[derived.mcp.tools.total]] Tools für direkten Zugriff durch Claude, Codex oder ChatGPT. Der Agent legt Kontakte an, schreibt Notizen, aktualisiert Deals und liest oder sendet Nachrichten im vereinheitlichten Posteingang, ohne dass Sie ins CRM einloggen. Nativer vereinheitlichter Posteingang für E-Mail, LinkedIn, WhatsApp, Instagram und Telegram ab der Pro-Stufe. n8n-Community-Node für visuelle Workflow-Automatisierung. [[derived.webhooks.events.total]] Webhook-Events ab dem Einstiegstarif. Zehn typisierte Custom-Field-Typen (Text, E-Mail, Telefon, Link, Datum, Datumsbereich, Datum und Uhrzeit, Datum-und-Uhrzeit-Bereich, Währung, Single-Select). Self-Hosting via `docker compose up -d` in 30 Minuten produktiv.

**Preisstaffel.** Self-Hosting kostenlos unter AGPL-3.0 via Docker Compose, eigene Infrastruktur. Cloud ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter-Stufe), in der EU-Region gehostet. Keine Add-on-Aufschläge für Webhooks, API oder MCP, alles im Basistarif (der vereinheitlichte Posteingang startet in der Pro-Stufe für [[commercial.price.pro.monthly]]).

**Stärken.** Native KI-Agent-Steuerung über MCP, die keines der anderen sechs Tools bietet. Ein nativer vereinheitlichter Posteingang, den dieselben Agenten bedienen. Vollständige Datenhoheit durch Self-Hosting. Transparentes Pricing ohne Mindestbestellmengen oder Onboarding-Gebühren. EU-Hosting (Deutschland) als Standard, nicht als Premium-Option.
...
**Salesforce-Skalierungsspirale.** Salesforce startet bei 25 Euro pro Nutzer im Starter-Plan, aber der echte Mittelstandsstandard ist Sales Cloud Enterprise (175 Euro) oder Unlimited (350 Euro). Hinzu kommen Service Cloud, Marketing Cloud, AppExchange-Add-ons und ein Implementierungspartner. Eine 25-Personen-Organisation landet realistisch bei 4.000 bis 10.000 Euro pro Monat plus einmaligen Implementierungskosten von 30.000 bis 150.000 Euro.
...
**Customermates (AGPL-3.0).** Mein eigenes Projekt, Solo-Founder-Build aus Deutschland. Fünf Entitäten, zehn typisierte Custom-Field-Typen, zwei Ansichten, ein nativer vereinheitlichter Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram) ab der Pro-Stufe und eine REST-API mit [[derived.mcp.tools.total]] MCP-Tools für native KI-Agent-Bedienung. Self-Hosting in 30 Minuten via Docker, Cloud ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter). Verwaltete Datenbank in einer EU-Region; beim Self-Hosting wählen Sie den Standort selbst. Wann wählen: wenn Sie KI-Agenten (Claude, Codex, ChatGPT) bereits nutzen und das CRM von der KI bedient werden soll, wenn DSGVO und Datenhoheit harte Kriterien sind, wenn Sie ein modernes, schlankes CRM ohne Marketing-Ballast suchen.
...
4. **Custom Fields nachpflegen**: Felder, die im Excel als Spalten existierten, aber nicht zum Standardschema passen, werden als Custom Fields nachgebaut. Bei Customermates über die zehn typisierten Custom-Field-Typen.
...
<Faq>
<FaqItem question="Was ist der Unterschied zwischen einer Kundendatenbank und einem CRM?">
...
<FaqItem question="Kann ich Excel als Kundendatenbank verwenden?">
...
<FaqItem question="Welche Kundendatenbank-Software ist DSGVO-konform?">
...
<FaqItem question="Kann ich eine Kundendatenbank selbst hosten?">
Ja, mit Open-Source-Lösungen wie Customermates (AGPL-3.0), EspoCRM oder SuiteCRM. Customermates startet mit `docker compose up -d` auf einem eigenen Server, in 30 Minuten ist das System einsatzbereit. Die Daten bleiben Ihre, das Schema ist offen, die Migration zu einem anderen System bleibt jederzeit möglich.
</FaqItem>

<FaqItem question="Welche Kundendatenbank ist die beste für kleine Unternehmen?">
...
<FaqItem question="Wie übertrage ich meine Kundendaten von Excel in eine richtige Kundendatenbank?">
Der Weg hängt vom Zielsystem ab. Bereinigen und normalisieren Sie zunächst die Quelldaten. Systeme mit einem CSV-Importer können anschließend eine Feldzuordnung anbieten. Customermates hat keinen CSV-Importer; legen Sie unterstützte Datensätze über die REST API oder einen autorisierten KI-Agenten per MCP an. Dauer und Aufwand hängen von Datenqualität, Mapping, Volumen und dem verwendeten Client ab.
</FaqItem>

<FaqItem question="Welche Kundendatenbank-Software hat das beste Free-Tier?">
...
<FaqItem question="Kann ich mehrere CRMs parallel betreiben?">
