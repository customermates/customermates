...
- **Open Source, EU-Hosting, KI-Agent-Steuerung**: Customermates ab 12 Euro pro Nutzer im Cloud-Tarif (Starter), kostenlos selbst hostbar.
...
Ja. Customermates ist unter AGPL-3.0 lizenziert und kostenlos selbst hostbar via `docker compose up -d`. Zwei Container—die App mit eingebettetem Workflow-Worker und PostgreSQL—reichen aus. Andere Optionen: EspoCRM, SuiteCRM, Krayin. Die Cloud-Variante von Customermates startet bei 12 Euro pro Nutzer pro Monat (Starter) und ist in Deutschland gehostet.
