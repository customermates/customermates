---
title: "Excel CRM 2026: Kostenlose Vorlage, Aufbau und Grenzen"
...
- **Open Source, EU-Hosting, KI-Agent-Steuerung**: Customermates ab [[commercial.price.starter.monthly]] pro Nutzer im Cloud-Tarif (Starter), kostenlos selbst hostbar.

## Vom Excel-CRM zur Open-Source-Alternative

Customermates ist gebaut für genau diesen Übergang. Die Tabellen-Ansicht (eine von zwei Standard-Ansichten neben der Kanban-Karten-Ansicht) fühlt sich für Excel-Nutzer vertraut an: Spalten, Zeilen, Filter, Sortierung. Zehn typisierte Custom-Field-Typen (plain, singleSelect, currency, date, date range, dateTime, dateTime range, email, link, phone) bilden die meisten Spalten ab, die Sie aus Excel mitbringen, jetzt allerdings mit Validierung und Such-Indexierung.

Der entscheidende Unterschied zur Excel-Welt: Customermates lässt sich von KI-Agenten bedienen. Über einen eingebauten [MCP-Server](https://modelcontextprotocol.io) mit [[derived.mcp.tools.total]] Tools können Claude, ChatGPT oder Codex direkt im CRM lesen und schreiben, inklusive eines nativen vereinheitlichten Posteingangs über E-Mail, LinkedIn, WhatsApp, Instagram und Telegram. Praktisch heißt das: Sie leiten eine E-Mail an Claude weiter, und Claude legt den Kontakt an, schreibt die Notiz, aktualisiert den Deal-Status. Die Datenpflege, die in Excel manuell laufen muss, übernimmt der Agent.

Cloud-Hosting in der EU-Region ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter-Stufe), Self-Hosting via `docker compose up -d` kostenlos unter [AGPL-3.0](https://www.gnu.org/licenses/agpl-3.0.html). Migration von Excel: Tabelle exportieren, Datensätze über die REST API oder einen KI-Agenten per MCP anlegen, Custom Fields anpassen. Mit einem KI-Agenten ist auch die Migration in einem Vormittag erledigt.
...
<Faq>
<FaqItem question="Kann ich Excel als CRM nutzen?">
...
<FaqItem question="Wann sollte ich von Excel auf ein CRM umsteigen?">
...
<FaqItem question="Welche Spalten gehören in eine CRM-Vorlage?">
...
<FaqItem question="Ist Google Sheets besser als Excel für ein CRM?">
...
<FaqItem question="Gibt es ein kostenloses Open-Source-CRM?">
Ja. Customermates ist unter AGPL-3.0 lizenziert und kostenlos selbst hostbar via `docker compose up -d`. Zwei Container laufen, in 30 Minuten ist das System einsatzbereit. Andere Optionen: EspoCRM, SuiteCRM, Krayin. Die Cloud-Variante von Customermates startet bei [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter) und ist in der EU-Region gehostet.
</FaqItem>

<FaqItem question="Brauche ich Apps Script für ein Excel-CRM?">
