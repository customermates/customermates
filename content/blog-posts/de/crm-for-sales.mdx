...
Customermates bietet vollständig anpassbare Pipelines mit Drag-and-Drop und benutzerdefinierten Feldern. Eine Stagnations-Benachrichtigung ist nicht eingebaut; sie entsteht aus einem Webhook plus einem geplanten Job in Ihrer eigenen n8n-Instanz.
...
|---|---|---|---|---|---|---|
| Startpreis pro Nutzer/Monat | Ab [[commercial.price.starter.monthly]] | 25 EUR | Kostenlos (limitiert) / 15 EUR | 14 EUR | 12 EUR (min. 3 Seats) | Kostenlos (limitiert) / 14 EUR |
...
| E-Mail-Integration | Gmail + Outlook (Pro-Stufe, [[commercial.price.pro.monthly]]) | Gmail + Outlook | Gmail + Outlook | Gmail + Outlook | Gmail + Outlook | Gmail + Outlook |
| KI-Funktionen | Externe KI-Clients via MCP inklusive | Einstein (Aufpreis) | KI (ab Pro-Plan) | KI (Aufpreis) | KI (limitiert) | Zia (inklusive) |
| KI-Agenten bedienen das CRM (native MCP) | Ja | Nein | Nein | Nein | Nein | Nein |
| Nativer vereinheitlichter Posteingang (E-Mail/LinkedIn/WhatsApp/Instagram/Telegram) | Ja (ab Pro) | Begrenzt | Begrenzt | Begrenzt | Begrenzt | Begrenzt |
...
**Customermates** hebt sich für Vertriebsteams hervor, die volle Funktionalität ohne Feature-Preisstufen wollen. Ab [[commercial.price.starter.monthly]] pro Nutzer und Monat erhält jeder Mitarbeiter Pipeline-Management, Automatisierung via n8n, externe KI über MCP, bei der Agenten das CRM direkt bedienen, und Reporting; die Pro-Stufe für [[commercial.price.pro.monthly]] ergänzt den nativen vereinheitlichten Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram). Das Open-Source-Modell und die Self-Hosting-Option sprechen zudem Teams mit strengen Datenschutzanforderungen an.
...
- **KI-Agenten bedienen das CRM**: Über eine native MCP-Integration ([[derived.mcp.tools.total]] Tools) aktualisieren Claude, ChatGPT oder Gemini Deal-Phasen, entwerfen Follow-ups und halten Kontaktnotizen aktuell, sodass Mitarbeiter das System nicht mehr meiden und die Pipeline die Realität abbildet
- **Nativer vereinheitlichter Posteingang** (ab der Pro-Stufe): E-Mail, LinkedIn, WhatsApp, Instagram und Telegram in einem Posteingang im CRM, und dieselben KI-Agenten können über jeden Kanal lesen, entwerfen und senden
...
All das ab [[commercial.price.starter.monthly]] pro Nutzer und Monat, ohne Automatisierungs-Limits. Jede Kernfunktion ist in jeder Stufe enthalten; mehr zahlen Sie für Messaging-Umfang und ein größeres Kontingent für die gehostete KI.
...
<Faq>
<FaqItem question="Was ist ein CRM für den Vertrieb?">
...
<FaqItem question="Was ist das beste CRM für den Vertrieb?">
Das beste CRM für den Vertrieb hängt von Ihrer Teamgröße, Ihrem Budget und Ihren technischen Anforderungen ab. Salesforce ist die funktionsreichste, aber auch komplexeste und teuerste Lösung. HubSpot bietet einen Free-Tarif, schränkt aber fortgeschrittene Funktionen hinter steilen Preisstufen ein. Pipedrive ist intuitiv, limitiert aber die Automatisierung in niedrigeren Tarifen. Customermates bietet das volle Kern-CRM ab [[commercial.price.starter.monthly]] pro Nutzer und Monat, mit Open-Source-Transparenz und EU-Hosting, das beste Preis-Leistungs-Verhältnis für kleine bis mittelgroße Vertriebsteams.
</FaqItem>

<FaqItem question="Wie unterscheidet sich ein Vertriebs-CRM von einem Marketing-CRM?">
...
Die Preise für Vertriebs-CRM reichen von kostenlos (mit eingeschränkten Funktionen) bis über 100 Euro pro Nutzer und Monat für Enterprise-Plattformen. Gängige Preismodelle umfassen monatliche Nutzergebühren, Feature-Stufen, die fortgeschrittene Automatisierung hinter höheren Tarifen verbergen, und Aufpreise für KI oder Premium-Integrationen. Customermates berechnet ab [[commercial.price.starter.monthly]] pro Nutzer und Monat für das volle Kern-CRM; die Pro-Stufe für [[commercial.price.pro.monthly]] ergänzt den vereinheitlichten Posteingang.
</FaqItem>

<FaqItem question="Wie lange dauert die Implementierung eines Vertriebs-CRM?">
...
<FaqItem question="Kann ein CRM meine Vertriebs-Tabelle ersetzen?">
...
Wenn Sie ein Vertriebs-CRM suchen, bei dem KI-Agenten das CRM direkt bedienen (native MCP), ein nativer vereinheitlichter Posteingang E-Mail, LinkedIn, WhatsApp, Instagram und Telegram abwickelt und Sie zugleich volles Pipeline-Management und unbegrenzte Automatisierung ohne Enterprise-Komplexität oder -Preise erhalten, ist [Customermates](/auth/signup) dafür gebaut. Open Source, DSGVO-nativ und ab [[commercial.price.starter.monthly]] pro Nutzer und Monat.
