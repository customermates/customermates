...
image: /images/light/de/customer-communication-management.png
---
...
Ich entwickle selbst ein Open-Source-CRM namens Customermates. Zwei Dinge stehen im Mittelpunkt. Erstens ein nativer Sammelposteingang, der E-Mail, LinkedIn, WhatsApp, Instagram und Telegram an einem Ort im CRM zusammenführt, sodass die Kanäle aus diesem Leitfaden nicht länger in getrennten Tools liegen. Zweitens KI-Agenten wie Claude oder ChatGPT, die das CRM direkt bedienen: Wenn jemand in der Pipeline antwortet, fasst das System die Kommunikation zusammen, schiebt das Deal-Stadium weiter und legt die nächste Aufgabe an. Die Idee dahinter ist, dass das CRM sich für Solo-Gründer und kleine Teams im Hintergrund selbst aktualisiert, statt zur Datenpflegepflicht zu werden. Genau in dieser Schnittstelle, dort wo Kommunikation auf Datenpflege trifft, entscheidet sich, ob Kundenkommunikation skaliert oder am Aufwand scheitert.
