...
<FaqItem question="Brauche ich einen Customer Success Manager als Solo-Gründer?">
  Nein. Sie machen die Aufgabe selbst, bis das Volumen es rechtfertigt. Wichtig ist, dass Sie die Aufgabe als eigene
  Disziplin behandeln, nicht als Nebenprodukt von Vertrieb oder Support.
</FaqItem>
...
<FaqItem question="Welches CRM eignet sich für Customer Success Management?">
  Jedes CRM, das Custom Fields, Automatisierungen und individuelle Pipelines unterstützt. Spezialisierte CSM-Plattformen
  lohnen sich erst bei größerem Kundenvolumen. Für die meisten kleinen und mittelständischen Anbieter ist ein gut
  konfiguriertes CRM die pragmatischere Wahl.
</FaqItem>

<FaqItem question="Wie oft sollte ein CSM seine Kunden kontaktieren?">
  Das hängt vom Segment ab. Enterprise-Kunden brauchen monatliche Touchpoints, Mid-Market vierteljährlich, SMB meist nur
  ereignisbezogen. Wichtiger als die Frequenz ist die Qualität des Kontakts.
</FaqItem>
