...
Customermates positioniert sich in dieser Lücke: ein Open-Source-CRM mit Tabellen- und Kartenansicht (Kanban), fünf Entitäten (Kontakte, Unternehmen, Deals, Services, Aufgaben), zehn Feldtypen, einer vollständigen REST-API und einem MCP-Server mit [[derived.mcp.tools.total]] Tools, der KI-Agenten den direkten Zugriff erlaubt. Cloud ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter-Stufe), kostenlos selbst hostbar via Docker, AGPL-3.0-lizenziert.
...
Eine Customermates-Eigenheit für DACH-Käufer: das Produkt wird in der EU-Region gehostet, ist DSGVO-nativ entwickelt und steht unter AGPL. Wer Open Source als Compliance-Vorteil nutzen will (volle Code-Audit-Möglichkeit, kein Vendor Lock-in, Datenhoheit beim Self-Hosting), bekommt eine Konstellation, die kommerzielle SaaS-CRMs strukturell nicht bieten können.

## Für Beratungen und Agenturen: CRM unter eigener Marke

Wenn Sie selbst CRM-Beratung anbieten und Ihr eigenes CRM-Produkt unter Ihrer Marke vermarkten wollen, entsteht mit Customermates ein White-Label-Partnerprogramm. Geplant ist eine gehostete Instanz unter Ihrer Domain (etwa `crm.ihreagentur.de`) mit Ihrem Logo und Ihren Farben, Hosting, Updates und Wartung übernommen, abgerechnet an Ihre Kunden zu Ihrem eigenen Preis. Die Branding-Funktion ist noch nicht implementiert, heute ist das also ein Gespräch und ein Vertrag, kein Schalter.

White-Label gehört zur Enterprise-Stufe und wird individuell bepreist, als vertraglich vereinbarter Punkt und nicht als ausgelieferte Funktion. Das passt für Beratungen, die Implementierung und Betrieb in einer Hand anbieten wollen, ohne ein eigenes Produkt entwickeln und betreuen zu müssen. Mehr dazu auf Anfrage über das Kontaktformular.
...
<Faq>
<FaqItem question="Was macht ein CRM-Berater im Tagesgeschäft?">
...
<FaqItem question="Was kostet eine CRM Beratung?">
...
<FaqItem question="Brauche ich wirklich einen CRM-Berater?">
...
<FaqItem question="Wie lange dauert ein CRM-Beratungsprojekt?">
...
<FaqItem question="Was ist der Unterschied zwischen CRM-Berater und CRM-Implementierungspartner?">
...
<FaqItem question="Kann KI einen CRM-Berater ersetzen?">
...
<FaqItem question="Sollte ich einen Generalisten oder einen Plattform-Spezialisten beauftragen?">
...
<FaqItem question="Wie funktionieren Partner-Tier-Programme der Hersteller?">
