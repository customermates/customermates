...
Das ursprüngliche Pipeline-CRM. Starkes UI, schnelle Deal-Eingabe, hoher Bekanntheitsgrad. E-Mail-Integration, mobile App, einfache Automatisierung. Preis ab 14 €/User/Monat, für Teams sinnvoll erst ab 39 € (Growth).
...
**Vorsicht bei:** Add-on-Aufschlägen (LeadBooster, Smart Docs jeweils 32,50 €/Monat). Die Lite-Stufe ist für echte Teams zu dünn.
...
Der Marktstandard für Enterprise. Endlos anpassbar. Genauso endlos komplex. Pro-Platz-Preis ab 25 USD, in der Praxis landen Implementierungen meist bei 80 bis 175 USD/User/Monat plus Beratungskosten.
...
Das CRM, das ich baue. Open Source, selbst gehostet oder EU-Cloud. Ab 12 €/User/Monat (10 € jährlich, Starter); der native vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram) liegt auf Pro für 29 €, und KI-Agenten können ihn bedienen. Modernes Pipedrive-Pendant. Agent-nativ über MCP, n8n-Community-Node, vollständige REST-API, 26 Webhook-Events.
...
**Konkrete Adoptionsgeschichte.** Eine 12-Personen-Beratung in Stuttgart migrierte von Pipedrive Growth (etwa 39 €/User/Monat im Jahresplan, rund 5.600 €/Jahr für 12) zu Customermates Cloud (Starter im Jahresplan, 120 €/User/Jahr × 12 = 1.440 €/Jahr). Jahres-Ersparnis: rund 4.100 €. Sie migrierten auch 8.400 Kontakte und 1.200 Deals über den API-Import. Migrationsdauer: 3 Tage, hauptsächlich Bereinigung doppelter Kontakte. Nach 6 Monaten verkabelten sie Claude über [MCP](/docs/mcp) für das Entwerfen von Follow-up-Mails basierend auf der letzten Aktivität jedes Deals, die Art von Workflow, die in HubSpot extra 15 € bis 30 €/User/Monat kostet. Siehe [Preise](/pricing) und die [Self-Hosted-Feature-Seite](/features/self-hosted).
...
**Stufe 2: Definierte Stufen, keine Disziplin.** Sie haben ein Pipeline-Diagramm an einem Whiteboard, aber Vertriebler erfassen inkonsistent. Schlankes CRM (HubSpot Free, Pipedrive Lite, [Customermates](/)) plus wöchentliches Pipeline-Review-Meeting. Ziel: die Gewohnheit aufbauen.

**Stufe 3: Disziplinierte Erfassung, ein Playbook.** Vertriebler erfassen Aktivitäten täglich; ein Playbook für alle. Automatisierung dazu (Sequenzen, Vorlagen), einfache Berichte. Pipedrive Growth, [Customermates](/), HubSpot Sales Starter.

**Stufe 4: Mehrere Playbooks, segmentiert.** Outbound vs. Inbound, KMU vs. Enterprise, Expansion vs. Neukunden. Sie brauchen ein CRM, das mehrere Pipelines, rollenbasierte Zugriffe, segmentspezifische Custom Fields unterstützt. Pipedrive Growth, HubSpot Pro, [Customermates](/) mit Custom-Konfiguration.
...
- **Custom-Workflows über Zapier oder n8n:** Jedes CRM braucht irgendwann einen Custom-Workflow, den der Anbieter nicht gebaut hat. Zapier ist der Cross-Vendor-Standard; n8n ist die Open-Source-Alternative. [Customermates](/) hat einen offiziellen n8n-Community-Node.
...
- **KI-getriebene Aktualisierung.** Moderner Ansatz: Das CRM aktualisiert sich selbst aus Ihrer Aktivität. Customermates stellt 46 MCP-Tools bereit, sodass Claude oder Codex Deal-Updates fahren, Follow-ups entwerfen und Notizen aus einem Transkript schreiben können, ohne dass der Vertriebsmitarbeiter ins CRM tippt. Das hat sich 2025 bis 2026 geändert.
...
Realer Preis 2026 liegt bei 15 € bis 40 € pro User pro Monat für die Stufe, die die meisten Teams tatsächlich brauchen. Kostenlose Stufen existieren (HubSpot, Bitrix24), deckeln aber Funktionen. Open-Source-Optionen ([Customermates](/), EspoCRM, SuiteCRM) starten bei 12 €/User oder selbst gehostet nur Serverkosten.

**Welches CRM hat 2026 die besten KI-Funktionen?**
Salesforce und HubSpot haben das meiste Marketing zur KI. [Customermates](/) überzeugt in der Praxis, wenn Sie Claude, Codex oder ChatGPT bereits nutzen, weil das CRM [46 MCP-Tools](/docs/mcp) bereitstellt, mit denen Ihre KI das CRM direkt steuern kann, statt auf Anbieter-KI-Funktionen zu warten.
