...
Customermates unterstützt das MCP-Muster nativ. Es stellt 46 MCP-Tools bereit, die alle Entitätstypen abdecken: Kontakte, Unternehmen, Deals, Services, Aufgaben, benutzerdefinierte Felder, Webhooks und Widgets. Neun dieser Tools bedienen einen nativen vereinheitlichten Posteingang, sodass derselbe Agent auch über E-Mail, LinkedIn, WhatsApp, Instagram und Telegram lesen, entwerfen und senden kann, direkt im CRM. Ein über MCP verbundener Agent kann das gesamte Spektrum agentischer CRM-Verhaltensweisen ausführen, ohne proprietäre Abhängigkeiten.
...
**Webhook-Ereignisse.** Das CRM muss Echtzeit-Ereignisse auslösen, wenn sich Datensätze ändern, damit Agenten auf die Welt reagieren können, ohne Polling zu betreiben. Customermates feuert 26 Webhook-Ereignisse: 15 Datensatz-Ereignisse, die jeden Entitätslebenszyklus abdecken (angelegt, aktualisiert, gelöscht), plus 11 Messaging- und Kalender-Ereignisse.
...
Die [vollständige API-Dokumentation](/features/api) deckt Authentifizierung und verfügbare Tools ab. Die [Preise](/pricing) für Customermates Cloud beginnen bei 12 Euro pro Nutzer und Monat (Starter-Stufe; 10 Euro bei jährlicher Zahlung), mit einer kostenlosen Self-Hosting-Option.
...
**Customermates.** Kein nativer KI-Agent im Produkt. Stattdessen: 46 MCP-Tools, über die jeder externe KI-Agent (Claude, GPT-4o, eigene Modelle) das vollständige CRM bedienen kann, plus ein nativer vereinheitlichter Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), den derselbe Agent lesen und versenden kann. Vorteil: Modellunabhängigkeit, volle Datenkontrolle, DSGVO-freundliches Self-Hosting. Cloud ab 12 Euro/Nutzer/Monat (Starter), Posteingang ab Pro (29 Euro).
...
| Customermates | Nein (extern) | Ja, nativ | Ja | ab €12/Nutzer/Monat |
...
Ja. Customermates stellt 46 MCP-Tools bereit, damit jeder MCP-kompatible KI-Agent das vollständige CRM bedienen kann. Webhooks feuern bei jeder Entitätsänderung, damit Agenten in Echtzeit reagieren können.
