...
|---|---|---|---|
| **Customermates** | 7 € (jährlich) | Open Source, KI-Agenten-fähig, Made in Germany | Ja, EU-/DE-Hosting |
...
**Einstiegsklasse, 7 bis 20 € pro Nutzer.** Customermates (7 €), Pipedrive (14 €), Zoho (14 €), CentralStation (18 €). Vollwertige CRM-Funktionen für KMU.
...
- **7 € pro Nutzer und Monat in der Cloud.** Alle Funktionen inklusive: Kontakte, Unternehmen, Angebote, Aufgaben, Pipeline, Workflow-Automatisierung, API, Audit-Log, Berechtigungen.
...
Die Preise liegen zwischen kostenlos und über 300 € pro Nutzer und Monat. Die meisten KMU zahlen 10 bis 30 € pro Nutzer. Customermates kostet 7 € pro Nutzer und Monat im Jahresplan, mit allen Funktionen ohne Aufpreis.
