...
Verwenden Sie einen n8n-Webhook-Node oder einen CRM-Trigger. Bei [Customermates](/) lösen neue Kontakte automatisch Workflows über die separate n8n-Integration aus. Alternativ lassen sich Webformulare, E-Mail-Parser oder Chatbot-Ausgaben anbinden.
...
| **Gesamt (1 Nutzer)**           | **20 EUR + 5-10 EUR + [[commercial.price.starter.monthly]]** |
...
| Kosten                  | [[commercial.price.starter.monthly]]/Nutzer + 5-10 EUR API | Ab ~90 EUR/Sitz (Professional-Plan)    | 14 EUR/Nutzer + externes Tool |
...
**Customermates.** Ab [[commercial.price.starter.monthly]]/Nutzer/Monat (Starter), das volle Kern-CRM inklusive. Custom-Felder für Scores, Tags für Klassifizierung, native n8n-Integration für automatische Updates, DSGVO-konformes EU-Hosting. Über die native MCP-Integration ([[derived.mcp.tools.total]] Tools) bedienen Claude, ChatGPT oder Gemini das CRM direkt, und ein vereinheitlichter Posteingang bringt E-Mail, LinkedIn, WhatsApp, Instagram und Telegram ab der Pro-Stufe an einem Ort zusammen. Automatisierung ist in jeder Stufe enthalten, Sie zahlen also nicht extra für Funktionen, die Enterprise-CRMs hinter höheren Tarifen verstecken.

**HubSpot.** Lead-Scoring ist im Professional-Plan verfügbar (ab etwa 90 EUR pro Sitz und Monat). Das integrierte Scoring ist regelbasiert, nicht KI-gestützt. Für KI-Scoring über n8n funktioniert der kostenlose CRM-Tarif, bietet aber keine fortgeschrittenen Automatisierungs-Trigger.
...
<Faq>
<FaqItem question="Kann ChatGPT wirklich einen menschlichen SDR bei der Lead-Qualifizierung ersetzen?">
...
<FaqItem question="Mit welchem Framework sollte man starten?">
...
<FaqItem question="Wie genau ist ChatGPT beim Lead-Scoring?">
...
<FaqItem question="Funktioniert der n8n-Workflow mit GPT-4o und GPT-3.5?">
...
<FaqItem question="Wie gehe ich mit Leads um, die ChatGPT falsch bewertet?">
...
<FaqItem question="Ist es DSGVO-konform, Lead-Daten an ChatGPT zu senden?">
Bei Nutzung der OpenAI-API mit Business-Vereinbarung und AVV werden Daten verarbeitet, aber nicht für Training verwendet. Für maximale Compliance minimieren Sie die gesendeten personenbezogenen Daten (Firmenname und Nachrichteninhalt statt persönlicher E-Mail-Adressen) und erwägen Sie ein selbst gehostetes LLM über Ollama für sensible Daten. Auf CRM-Seite speichert Customermates Daten standardmäßig in der EU und stellt AVV und SCCs bereit, besitzt aber keine Compliance-Zertifizierung.
</FaqItem>

<FaqItem question="Lohnt sich Automatisierung auch bei nur 20 Leads pro Monat?">
...
<FaqItem question="Wie gehe ich mit Referral-Leads um, die kaum schriftliche Daten haben?">
