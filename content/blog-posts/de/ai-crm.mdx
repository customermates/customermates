...
**Schritt 1.** Wählen Sie ein CRM mit echtem MCP-Server. Customermates liefert einen mit [46 Tools, die jede CRM-Operation abdecken](/features/api) (Kontakte erstellen, Deals aktualisieren, Entitäten verknüpfen, Custom Columns konfigurieren). Salesforce, HubSpot und Pipedrive bieten MCP über Community-Server, aber die Abdeckung ist partiell.
