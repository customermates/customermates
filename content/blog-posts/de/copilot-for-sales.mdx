...
Wenn Sie Copilot for Sales evaluieren, sind die wirklich wichtigen Fragen nicht "funktioniert es", sondern "was kostet es tatsächlich", "welche Lizenzen brauche ich, bevor es überhaupt läuft" und "ist es das richtige Werkzeug für ein kleines Team". Dieser Leitfaden beantwortet das, mit ausgerechneter Preismathematik und einem Vergleich zu den schlankeren Alternativen, die kleine Teams tatsächlich einsetzen.
...
Nein. Copilot for Sales ist eine KI-Schicht, die auf einem bestehenden CRM aufsitzt. Sie brauchen weiterhin Dynamics 365 Sales oder Salesforce Sales Cloud darunter, damit überhaupt etwas funktioniert. Der Copilot ist der Assistent, das CRM ist die Datenbank, das Entitätsmodell und das System of Record.
...
Hier beginnen die Preisüberraschungen. Copilot for Sales funktioniert nicht isoliert. Sie brauchen mindestens drei Dinge, bevor der Assistent überhaupt etwas zu tun hat.
...
Wenn Ihr CRM Salesforce statt Dynamics ist, ersetzen Sie die Dynamics-Zeile durch Salesforce Sales Cloud Pro Suite (100 USD pro Nutzer pro Monat, mehr für Enterprise) für einen vergleichbaren Stack.
...
**Copilot in Sales** ist die KI direkt in Dynamics 365 Sales. Wenn Sie Dynamics 365 Sales Enterprise oder Premium haben, ist Copilot in Sales enthalten. Es funktioniert nur innerhalb der Dynamics-365-Web- und Mobile-App, nicht innerhalb von Outlook oder Teams.
...
Wenn Ihr Team in Outlook und Teams lebt, wollen Sie Copilot for Sales (oder Microsoft 365 Copilot mit den Sales-Funktionen im Bundle). Wenn Ihr Team in der Dynamics-365-Web-App lebt, reicht Copilot in Sales und ist mit Ihrer Stufe schon enthalten.

Das zu verwechseln kostet Geld. Wir sehen Organisationen, die unnötig beides bezahlen.

## Lohnt sich Copilot for Sales?

Die ehrliche Antwort hängt davon ab, auf welcher Seite zweier Schwellen Sie stehen.

**Lohnt sich, wenn:**

- Sie sind ohnehin tief in Microsoft 365 (E3/E5) und Dynamics 365 oder Salesforce
- Ihre Verkäufer verbringen den Großteil des Tages in Outlook und Teams
- Sie haben einen Salesforce- oder Dynamics-Admin, der den Konnektor konfigurieren und pflegen kann
- Sie haben mindestens 25 bis 50 Verkäufer (die Pro-Sitz-Mathematik wird darunter schwierig)
- Ihr bestehendes CRM ist System of Record und das ändert sich nicht

**Lohnt sich nicht, wenn:**

- Sie sind ein kleines Team (unter 20 Verkäufern) ohne Microsoft-365-Admin
- Sie haben kein Dynamics 365 oder Salesforce und wollen sich auf keines festlegen
- Ihre Verkäufer arbeiten außerhalb von Outlook und Teams (Gmail, Slack, eigene Tools)
- Sie wollen das "KI im CRM"-Erlebnis ohne den gestapelten Lizenzturm
- Sie wollen eine Open-Source- oder selbst hostbare Option für Datensouveränität
...
**[Customermates](/).** Die Open-Source-Alternative für Teams, die KI im CRM wollen, ohne den Lizenzturm. Customermates ist ein Open-Source-CRM mit [[derived.mcp.tools.total]] nativen [MCP-Tools](/features/api), die Claude, ChatGPT und Gemini direkt Kontakte, Unternehmen, Deals, Services und Aufgaben lesen und schreiben lassen und aus demselben Chat einen nativen vereinheitlichten Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram) bedienen. Statt 50 USD pro Nutzer für die KI-Schicht plus 100 USD pro Nutzer für ein CRM zu zahlen, zahlen Sie [[commercial.price.pro.monthly]] pro Nutzer pro Monat für die Pro-Stufe (die den vereinheitlichten Posteingang ergänzt, aus dem entworfene E-Mails tatsächlich verschickt werden) und bringen Ihren eigenen KI-Assistenten mit (für den die meisten Teams ohnehin schon ein Abo haben). Das Ergebnis ist dieselbe Wirkung (entworfene E-Mails, zusammengefasste Meetings, aktualisierte Datensätze, alles aus dem KI-Assistenten heraus, den Ihr Team nutzt) bei einem Bruchteil der Sitz-Kosten und ohne Microsoft- oder Salesforce-Lock-in.
...
Das Nutzererlebnis unterscheidet sich (in-app bei Copilot, im-Chat bei Customermates), das Deal-Datensatz-Ergebnis ist dasselbe. Der Kostenunterschied ist groß, das Plattform-Commitment deutlich niedriger.

## Häufige Fragen

<Faq>
<FaqItem question="Was ist Microsoft Copilot for Sales?">
...
<FaqItem question="Wie funktioniert Copilot im Vertrieb?">
...
<FaqItem question="Ist Copilot für den Vertrieb jetzt in Copilot enthalten?">
...
<FaqItem question="Wie aktiviere ich Copilot für Sales in Dynamics 365 Sales?">
...
<FaqItem question="Was kostet Copilot for Sales?">
...
<FaqItem question="Mit welchen CRMs funktioniert Copilot for Sales?">
...
<FaqItem question="Funktioniert Copilot for Sales außerhalb des Microsoft-Stacks?">
...
<FaqItem question="Lohnt sich Copilot for Sales?">
...
<FaqItem question="Was ist die Open-Source-Alternative zu Copilot for Sales?">
[Customermates](/) ist ein Open-Source-CRM mit [[derived.mcp.tools.total]] nativen MCP-Tools, die Claude, ChatGPT und Gemini das CRM direkt bedienen lassen, inklusive eines nativen vereinheitlichten Posteingangs (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram). Es liefert dieselben Workflow-Ergebnisse (entworfene E-Mails, Meeting-Zusammenfassungen, Deal-Updates) ohne den gestapelten Microsoft-Lizenzturm. Self-Hosting via Docker kostenlos, EU-Cloud ab [[commercial.price.pro.monthly]] pro Nutzer pro Monat für die Pro-Stufe mit vereinheitlichtem Posteingang.
</FaqItem>
</Faq>
