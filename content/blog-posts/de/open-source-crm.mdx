...
- KI-Agenten (Claude, ChatGPT, Gemini), die das CRM über eine native MCP-Integration lesen und schreiben (45 Tools)
...
**Preise**: ab 12 €/Nutzer/Monat für Managed Cloud (Starter, volles Kern-CRM; Pro für 29 € ergänzt den vereinheitlichten Posteingang). Self-Hosted ist kostenlos und Open Source.
...
| **Cloud-Option** | Ab 12 €/Nutzer/Mo. | Ab 95 GBP/Mo. | Ab 24,90 €/Nutzer/Mo. | Ab 15 USD/Nutzer/Mo. | Beta | Ab 12 USD/Nutzer/Mo. | Über Partner |
...
Wenn Sie keine Infrastruktur verwalten möchten, bietet Customermates [Managed EU Cloud Hosting](/pricing) ab 12 €/Nutzer/Monat mit dem vollen Kern-CRM inklusive, kein Docker-Setup nötig.
...
| Customermates (Cloud, Starter) | 1.440 € | 1.440 € | 1.440 € | 4.320 € |
