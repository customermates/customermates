...
**Überblick**: Customermates ist ein modernes, quelloffenes CRM für Unternehmen, die volle Funktionalität ohne Komplexität oder eskalierende Kosten wollen. Es führt mit zwei Fähigkeiten: KI-Agenten, die das CRM über eine native MCP-Integration bedienen, und einem nativen vereinheitlichten Posteingang für E-Mail, LinkedIn, WhatsApp, Instagram und Telegram. DSGVO-Konformität ist ein Kernprinzip.
...
- Nativer vereinheitlichter Posteingang: [E-Mail](/features/email-integration), LinkedIn, WhatsApp, Instagram und Telegram (Pro-Stufe)
- KI-Agenten (Claude, ChatGPT, Gemini), die das CRM über eine native MCP-Integration lesen und schreiben ([[derived.mcp.tools.total]] Tools)
- Leistungsstarke [Workflow-Automatisierung](/features/workflow-automation) über die n8n-Community-Node
...
**Preise**: ab [[commercial.price.starter.monthly]]/Nutzer/Monat für Managed Cloud (Starter, volles Kern-CRM; Pro für [[commercial.price.pro.monthly]] ergänzt den vereinheitlichten Posteingang). Self-Hosted ist kostenlos und Open Source.

**Vorteile:**

- Transparente Stufen mit dem vollen Kern-CRM in jeder Stufe, keine Upsells
- DSGVO-nativ mit EU-Datenhosting
- n8n-Automatisierung ermöglicht komplexe Workflows ohne Programmierung
- KI-Agenten und der vereinheitlichte Posteingang sind integriert, nicht nachträglich angebaut
...
**Am besten für**: Kleine bis mittlere Unternehmen, die ein modernes Open Source CRM mit transparenten Preisen, starker Automatisierung und voller Datenkontrolle wollen. [Preise ansehen](/pricing) oder [kostenlos testen](/auth/signup).
...
| **Cloud-Option**                                                  | Ab [[commercial.price.starter.monthly]]/Nutzer/Mo. | Ab 95 GBP/Mo. | Ab 24,90 €/Nutzer/Mo. | Ab 15 USD/Nutzer/Mo. | Beta           | Ab 12 USD/Nutzer/Mo. | Über Partner |
...
| **Vereinheitlichter Posteingang (LinkedIn/WhatsApp/IG/Telegram)** | Ja                                                 | Nein          | Nein                  | Nein                 | Nein           | Nein                 | Nein         |
| **Workflow-Automatisierung**                                      | n8n (visuell)                                      | Integriert    | Integriert            | BPM-Engine           | Eingeschränkt  | Integriert           | CiviRules    |
| **KI-Features**                                                   | Native MCP (Claude, ChatGPT, Gemini)               | Nein          | Nur Enterprise        | Nein                 | Geplant        | Nur Cloud            | Nein         |
...
Wenn Sie keine Infrastruktur verwalten möchten, bietet Customermates [Managed EU Cloud Hosting](/pricing) ab [[commercial.price.starter.monthly]]/Nutzer/Monat mit dem vollen Kern-CRM inklusive, kein Docker-Setup nötig.
...
<Faq>
<FaqItem question="Was ist ein Open Source CRM?">
...
<FaqItem question="Ist Open Source CRM wirklich kostenlos?">
Die Software selbst ist kostenlos zum Download und Self-Hosting. Sie müssen jedoch für Server-Hosting, Wartung und möglicherweise technischen Support zahlen. Managed-Cloud-Versionen von Open Source CRMs berechnen eine monatliche Gebühr, übernehmen dafür aber die Infrastruktur. Customermates beispielsweise ist kostenlos zum Self-Hosting und startet bei [[commercial.price.starter.monthly]]/Nutzer/Monat für Managed Cloud.
</FaqItem>

<FaqItem question="Kann ich ein Open Source CRM mit Docker selbst hosten?">
...
<FaqItem question="Welches Open Source CRM ist das beste für kleine Unternehmen?">
Für kleine Unternehmen sind EspoCRM und Customermates starke Optionen. EspoCRM bietet eine saubere Oberfläche mit geringer Komplexität. Customermates ergänzt n8n-Automatisierung, einen nativen vereinheitlichten Posteingang und KI-Agenten, die das CRM über MCP bedienen, ab [[commercial.price.starter.monthly]]/Nutzer/Monat, mit dem vollen Kern-CRM in jeder Stufe. Beide unterstützen Docker-basiertes Self-Hosting.
</FaqItem>

<FaqItem question="Wie schneidet ein Open Source CRM im Vergleich zu Salesforce oder HubSpot ab?">
...
<FaqItem question="Ist ein Open Source CRM DSGVO-konform?">
...
<FaqItem question="Welches ist das beste Open Source CRM auf GitHub?">
