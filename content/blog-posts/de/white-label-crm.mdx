...
- Verwaltetes White-Label-Branding über die Enterprise-Stufe und ein eigenes Agentur-Programm
- KI-Agenten bedienen das CRM: Claude, ChatGPT und Gemini lesen und schreiben Datensätze über 45 native MCP-Tools, die Dateneingabe für Kunden läuft über den Agenten
...
**Preise**: Das Basis-CRM startet bei €12 pro Nutzer und Monat (Starter). White-Label-Branding gibt es auf der Enterprise-Stufe (individuelle Preise) und über das Agentur-Programm, eine monatliche Plattformgebühr von €149 plus €5 pro Nutzer und Monat. Self-Hosting unter AGPL-3.0 kostet €0 Lizenzierung, und da Ihnen der Quellcode gehört, können Sie das Branding auch selbst auf Code-Ebene anpassen.
