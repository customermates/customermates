...
Customermates hat weder CSV-Import noch Feldzuordnungsmaske; Datensätze entstehen über die REST API oder durch einen KI-Agenten per MCP. Beim Import ordnen Sie Ihre CSV-Spaltenüberschriften den CRM-Feldern zu, sehen eine Vorschau und bestätigen. Gängige Spaltenbezeichnungen wie Vorname, E-Mail und Firma werden automatisch erkannt.
