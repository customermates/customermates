...
Eine kurze, brauchbare Definition: **Salesforce Einstein ist die KI, die innerhalb von Salesforce lebt, mit Ihren CRM-Daten gefüttert wird und über Vorhersage-Scores, generierte Inhalte und konversationelle Oberflächen in jeder Salesforce-Cloud erscheint.**
...
- **Einstein Relationship Insights**: Verbindungen zwischen Kontakten, Accounts und den Netzwerken Ihrer Vertriebsmitarbeiter sichtbar machen

Diese Funktionen leben alle in der Sales Cloud und setzen entweder Sales Cloud Einstein (Add-on pro Nutzer) oder die höherpreisige All-in-Edition (2026 von Einstein 1 Sales in Agentforce 1 Sales umbenannt) voraus.
...
Das Preismodell von Salesforce Einstein ist der Teil, der die meisten Käufer überrascht, weil es keinen einzelnen Listenpreis gibt. Sie bezahlen durch drei Türen, oft gleichzeitig.
...
**Gebündelte Editionen.** Die Top-Edition, 2026 von Einstein 1 in Agentforce 1 umbenannt, bündelt die KI-Schicht, Sales/Service Cloud und Slack zu einem einzigen Pro-Nutzer-Tarif. Öffentliche Listenpreise liegen bei rund 550 USD pro Nutzer pro Monat für die Agentforce 1 Sales Edition, ebenfalls verhandelbar.
...
**Erforderliche Voraussetzungen.** Die meisten nützlichen Einstein-Funktionen setzen Data Cloud voraus, ein eigenständiges Produkt mit eigenem Verbrauchstarif. Ohne Data Cloud bekommen Sie die älteren prädiktiven Funktionen, aber nicht die cloud-übergreifende Verankerung, die Salesforce heute bewirbt.
...
Eine vollständige Aufschlüsselung pro Edition finden Sie im [Salesforce-Alternativenvergleich](/compare/salesforce-alternative).

## Salesforce Einstein vs. Agentforce

Agentforce ist kein Ersatz für Einstein. Es ist die Plattformschicht oberhalb von Einstein, mit der Sie autonome KI-Agenten bauen und ausrollen. Einstein bleibt die zugrundeliegende KI-Funktionalität, Agentforce ist, wie Sie Einstein in Agenten-Workflows orchestrieren.
...
Einstein ist für Organisationen gebaut, die ohnehin auf Salesforce laufen. Wenn Sie ein Fünf-Personen-Team mit Pipedrive sind, eine Fünfzehn-Personen-Beratung mit Notion, oder ein Founder-Led-Unternehmen ganz ohne CRM, dann ist Einstein der falsche Startpunkt. Die Gründe sind einfach:
...
**[Customermates](/).** Ein Open-Source-CRM, in dem die KI-Schicht das LLM ist, das Sie ohnehin nutzen. Über [[derived.mcp.tools.total]] native MCP-Tools lesen und schreiben Claude, ChatGPT und Gemini direkt Kontakte, Unternehmen, Deals, Services und Aufgaben. Dasselbe CRM enthält zudem einen nativen vereinheitlichten Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), den dieselben Agenten lesen, entwerfen und versenden können. Es gibt keine separate KI-Schicht zu lizenzieren, keine Data Cloud, keinen Trust Layer einzukalkulieren. Das CRM stellt sein Datenmodell über ein standardisiertes Protokoll bereit, und jeder kompatible KI-Agent bedient es. Auf EU-Cloud kostet das [[commercial.price.starter.monthly]] pro Nutzer pro Monat (Starter-Stufe), Self-Hosting via Docker ist kostenlos.

Der architektonische Unterschied zählt: Einstein ist eine geschlossene KI-Schicht innerhalb einer geschlossenen Plattform. Der MCP-basierte Ansatz ist ein CRM, das jede KI bedienen kann, und die KI, die Sie mitbringen, wird besser, ohne dass Sie auf einen Salesforce-Release warten müssen.
...
## So evaluieren Sie Salesforce Einstein für Ihr Team

Wenn Sie Einstein ernsthaft erwägen, sind die Fragen vor Vertragsschluss konkret und beantwortbar.
...
<Faq>
<FaqItem question="Was ist Salesforce Einstein in einfachen Worten?">
...
<FaqItem question="Ist Salesforce Einstein dasselbe wie Einstein GPT?">
...
<FaqItem question="Was ist der Unterschied zwischen Einstein und Agentforce?">
...
<FaqItem question="Was kostet Salesforce Einstein?">
Es gibt keinen einzelnen Preis. Pro-Nutzer-Add-ons lagen historisch bei 50 bis 75 USD pro Nutzer pro Monat. Die gebündelte Top-Edition (2026 von Einstein 1 in Agentforce 1 umbenannt) liegt bei rund 550 USD pro Nutzer pro Monat als Listenpreis. Generative KI- und Agenten-Nutzung wird verbrauchsbasiert abgerechnet (pro Konversation oder über Flex Credits), Data Cloud separat. Realistischer Wert-Einstiegspunkt nach Rabatt: 200 bis 400 USD pro Nutzer pro Monat.
</FaqItem>

<FaqItem question="Funktioniert Salesforce Einstein mit unseren bestehenden Daten?">
...
<FaqItem question="Ist Salesforce Einstein in der EU verfügbar und DSGVO-konform?">
...
<FaqItem question="Kann ich Einstein ohne Data Cloud nutzen?">
...
<FaqItem question="Gibt es Open-Source-Alternativen zu Salesforce Einstein?">
[Customermates](/) kommt dem Konzept am nächsten: ein Open-Source-CRM, in dem jeder MCP-kompatible KI-Agent (Claude, ChatGPT, Gemini) Datensätze direkt über [[derived.mcp.tools.total]] native Tools liest und schreibt, dazu ein nativer vereinheitlichter Posteingang, den dieselben Agenten bedienen. Self-Hosting kostenlos, EU-Cloud ab [[commercial.price.starter.monthly]] pro Nutzer pro Monat, DSGVO-nativ.
</FaqItem>

<FaqItem question="Welches ist das kleinste Team, das von Einstein profitiert?">
...
<FaqItem question="Wurde Einstein umbenannt?">
