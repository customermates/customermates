...
hero:
  ...
  description: "Was hinter Claude CRM steckt, was Claude im CRM tatsächlich tun kann, und das Open-Source-CRM, in dem Claude 46 MCP-Tools von Haus aus bedient."
...
| Kosten-Sensitivität | 12 EUR pro Nutzer ist nicht leistbar | Kleines Abo ist tragbar |
...
[Customermates](/) ist ein Open-Source-CRM, MCP-first gebaut. Es exponiert 46 native MCP-Tools: 44 über zehn Toolsets, die jede Entität im Datenmodell abdecken, plus zwei stets aktive Deep-Research-Connectoren.

- **Records (17):** filtern, zählen, suchen, abrufen, anlegen, aktualisieren, verlinken, entlinken, löschen, dazu Notiz- und Custom-Field-Bearbeitung über Kontakte, Unternehmen, Deals, Services und Aufgaben
- **Messaging (9):** lesen, entwerfen und senden über E-Mail, LinkedIn, WhatsApp, Instagram und Telegram
- **Social und Sales Navigator (8):** Social-Post-Tracking und LinkedIn-Sales-Navigator-Suche
- **Docs (2):** Produktdokumentation durchsuchen und lesen
- **Workspace (2):** Kontext zu aktuellem Nutzer und Workspace
- **Admin (2):** Rollen und Unternehmensverwaltung
- **Custom Columns (1):** Custom Fields über zehn Feldtypen verwalten
- **Widgets (1):** Dashboard-Widgets
- **Webhooks (1):** Webhook-Abonnements verwalten
- **Deep Research (2):** stets aktive `search`- und `fetch`-Connectoren

Diese neun Messaging-Tools sind die zweite Hälfte der Geschichte. Dieselben Agenten, die Datensätze aktuell halten, bedienen auch einen nativen, vereinheitlichten Posteingang und lesen, entwerfen und senden über E-Mail, LinkedIn, WhatsApp, Instagram und Telegram von einer Tool-Oberfläche aus. Messaging- und Social-Tools erfordern eine Pro- oder Business-Stufe, die Kern-Tools für Datensätze, Custom Fields und Workspace sind ab der Starter-Stufe verfügbar.
...
**Sie wollen KI im CRM, Ihr Team ist 1 bis 30 Personen, Sie wollen keine Connector-Steuer → MCP-nativ.** Nutzen Sie Customermates. Self-Hosting via Docker kostenlos, EU-Cloud ab 12 EUR pro Nutzer pro Monat (Starter-Stufe; 10 EUR bei jährlicher Zahlung), Open Source AGPL-3.0. Claude bedient es direkt über 46 MCP-Tools, und dieselben Agenten betreiben ab Pro den vereinheitlichten Posteingang über E-Mail, LinkedIn, WhatsApp, Instagram und Telegram.
...
[Customermates](/) ist ab 12 EUR pro Nutzer pro Monat auf EU-Cloud oder kostenlos selbst gehostet via Docker, mit nativer Claude-Unterstützung über 46 MCP-Tools. Die Kern-Tools für Datensätze und Workspace sind ab der Starter-Stufe dabei; es gibt keine separate KI-Stufe oder Connector-Gebühr.
