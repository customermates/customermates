...
**Schicht 1: Native Automation-Regeln.** Feldänderungs-Trigger, zeitbasierte Erinnerungen, einfache mehrstufige Sequenzen. Jedes moderne CRM hat das. Customermates liefert regelbasierte [Workflow-Automation](/features/workflow-automation) plus 26 Webhook-Events, die bei wichtigen Statusänderungen feuern.
...
Customermates erfüllt alle acht. Die [Preise](/pricing) starten bei 10 € pro Nutzer pro Monat im Jahresplan (Starter-Stufe); Workflow-Automation, Webhooks und der MCP-Server sind in jeder Stufe enthalten, ohne separaten „Automatisierungs-Tier".
...
**Native Workflow-Automation.** Regelbasierte [Workflow-Automation](/features/workflow-automation) mit bedingter Logik, Zeitverzögerungen und 26 Webhook-Events für jede Statusänderung. Im Basisplan inklusive, kein separater Tier.
...
**46 MCP-Tools.** Nativer MCP-Server stellt jede CRM-Operation (Kontakt anlegen, Deal aktualisieren, Aktivität protokollieren, Pipeline abfragen, Report generieren) Claude, ChatGPT, Gemini oder einem anderen MCP-fähigen Agenten bereit. Der Agent liest den Posteingang und schreibt in normaler Sprache zurück ins CRM.
...
**Customermates.** Open Source unter AGPL-3.0, EU-gehostete Cloud ab 12 €/Nutzer/Monat (Starter) oder Self-Hosted kostenlos. Native [Workflow-Automation](/features/workflow-automation), 26 Webhook-Events, [n8n-Community-Node](/features/integrations), ein nativer vereinheitlichter Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram ab Pro) und 46 MCP-Tools für direkten KI-Agenten-Betrieb. Kleineres Ökosystem als HubSpot oder Salesforce; die Agent-native Architektur ist der Differenzierungspunkt. Gut geeignet für technisch affine Mittelständler oder Teams, die ohnehin täglich Claude, ChatGPT oder Gemini nutzen.
