...
Customermates exponiert über einen [MCP-Server](https://modelcontextprotocol.io) 46 Tools, die jede CRM-Operation abdecken, plus einen nativen vereinheitlichten Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram). Der Agent liest Kontakte, schreibt Notizen, aktualisiert Felder, verknüpft Entitäten, konfiguriert Custom Columns und liest oder sendet Nachrichten. Praktisch heißt das: nach einem Verkaufsgespräch leiten Sie die E-Mail-Zusammenfassung an Claude weiter, und Claude aktualisiert Deal-Stand, schreibt die Kontaktnotiz und legt die Follow-up-Aufgabe an, ohne dass Sie ins CRM einloggen.
...
- Wenn **agentische Automatisierung** (Claude, ChatGPT, Codex bedient das CRM) und **Open Source** zum Pflichtprogramm gehören, ist Customermates die direkte Wahl. Cloud ab 12 Euro pro Nutzer pro Monat (10 Euro im Jahresplan, Starter-Stufe), kostenlos selbst hostbar.
