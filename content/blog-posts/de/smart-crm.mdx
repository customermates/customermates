...
Der Test legt offen, welche Produkte architektonisch agenten-bedienbar sind und welche nicht. HubSpot hat einen Connector für Claude veröffentlicht, der einen Teil davon abdeckt. Salesforce hat Agentforce ausgeliefert, das das innerhalb von Salesforce abdeckt. [Customermates](/) deckt es über 46 native MCP-Tools ab, die jede Entität (Kontakte, Unternehmen, Deals, Services, Aufgaben, Custom Fields, Widgets, Webhooks) und den Messaging-Posteingang erfassen. Andere CRMs erfordern Integrations-Arbeit.
...
**[Customermates](/).** Das Open-Source Smart CRM. MCP-first gebaut: 46 native Tools bedeuten, dass Claude, ChatGPT und Gemini das CRM direkt bedienen, ohne Integrations-Schicht. Dazu kommt ein nativer vereinheitlichter Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), sodass dieselben Agenten, die die Dateneingabe erledigen, auch über jeden Kanal lesen, entwerfen und senden. AGPL-3.0 Lizenz, Self-Hosting via Docker kostenlos, EU-Cloud ab 12 EUR pro Nutzer pro Monat. Die Smart-CRM-Definition deckt sich mit der Architektur: KI ist die primäre Daten-Eingabe-Schicht, kein aufgesetztes Feature.
...
**1. Gesamtkosten pro Sitz, nicht Listenpreis.** HubSpots kostenloser Tarif ist großzügig, die Smart-Funktionen sind nicht enthalten. Salesforce-Listenpreise sind hoch vor Rabatt, aber vorhersehbar. Customermates startet bei 12 EUR pro Nutzer pro Monat, mit der KI/MCP-Schicht in jeder Stufe inklusive. Die relevante Zahl sind die Kosten, wenn die KI-Funktionen, die Sie tatsächlich wollen, eingeschaltet sind.
...
Ja. [Customermates](/) ist ein Open-Source Smart CRM unter AGPL-3.0, mit 46 nativen MCP-Tools, mit denen jeder KI-Agent die Datensätze und den vereinheitlichten Posteingang bedient. Self-Hosting via Docker, Cloud ab 12 EUR pro Nutzer pro Monat.
