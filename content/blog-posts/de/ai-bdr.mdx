...
[Customermates](/) ist ein Open-Source-CRM, gebaut, damit jeder MCP-kompatible KI-Agent das gesamte CRM direkt liest und schreibt. Es gibt 45 native MCP-Tools, die Kontakte, Unternehmen, Deals, Services, Aufgaben, benutzerdefinierte Felder, Widgets und Webhooks abdecken. Ein über MCP angebundener AI BDR "schickt keine Leads ans CRM", er bedient das CRM.
...
Customermates ist DSGVO-nativ, EU-Cloud (Frankfurt) oder selbst gehostet via Docker, AGPL-3.0 lizenziert, Made in Germany. Der Agent operiert auf Daten, die Ihre Infrastruktur nie verlassen, wenn das die Anforderung ist.
...
**Customermates.** Kein AI BDR. Das CRM, in das jeder der oben genannten via MCP einklinkt, mit 45 nativen Tools. Open Source unter AGPL-3.0, Cloud ab 12 EUR pro Nutzer pro Monat (Starter) oder kostenlos selbst gehostet via Docker; der vereinheitlichte Posteingang mit der Konversationshistorie liegt auf Pro ab 29 EUR. Geeignet als Ziel-Schicht des Stacks, wo Kontakte, Deals und Konversationen tatsächlich leben.
