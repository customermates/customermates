...
| **Customermates** | 8 Typen, unbegrenzt pro Entität | 5 eingebaute Entitäten, alle mit Custom Fields | Ja, vollständig + 15 Webhooks + MCP | Ja (Docker) | 7 €/User/Mo |
...
Wenn du ein anpassbares CRM willst, das API, Webhooks, Custom Fields und einen MCP-Server für KI-Agent-Automatisierung schon enthält, [Customermates](/pricing) liefert das für 7 € pro User pro Monat. Die ersten sieben Tage sind kostenlos, keine Kreditkarte. Wenn Self-Hosting Pflicht ist, dasselbe Produkt liegt auf [GitHub](https://github.com/customermates/customermates) unter AGPL-3.0.
