...
14 € für Standard, 23 € für Professional pro User pro Monat (Jahresabrechnung). Hohe Funktionsbreite zu niedrigem Preis. Geeignet für Teams im Zoho-Ökosystem (Zoho Books, Zoho Desk, Zoho Mail). Vorsicht bei der Implementierungskomplexität und dem etwas in die Jahre gekommenen UI.

### Pipedrive Lite / Growth

14 € für Lite, 39 € für Growth (Pipedrive hat seine Stufen 2025 umbenannt; die alten Namen Essential/Advanced/Professional/Enterprise gibt es nicht mehr, und es gibt keinen kostenlosen Tarif, nur eine 14-tägige Testphase). Die Growth-Stufe ist die, in der echte Teams leben. Geeignet für vertriebsgeführte Teams, die das klassische Pipeline-Erlebnis wollen. Vorsicht bei den Add-on-Aufschlägen (LeadBooster, Smart Docs jeweils 32,50 €/Monat).

**Warum die Lite-Stufe von Pipedrive eine Falle ist:** Lite fehlt E-Mail-Öffnungs-Tracking, Gruppen-E-Mails, Klick-Tracking, Custom-Signaturen, E-Mail-Vorlagen, Scheduler-Integrationen und entscheidende Automatisierungs-Trigger. Die meisten Teams merken das in Woche 4, wenn sie „automatisch einen Deal anlegen, wenn ein Lead antwortet" aufsetzen wollen und feststellen, dass das Growth verlangt. Die 14 € werden in zwei Monaten zu 39 € für jedes Team mit echtem Outbound.

**Was Growth freischaltet:** vollständige bidirektionale E-Mail-Synchronisation mit sieben Anbietern, Sequenzen (Sales Cadences), Automatisierungs-Builder, Custom-E-Mail-Vorlagen, Klick-Tracking, Meeting-Scheduler, KI-Sales-Assistent. Das ist das realistische Pipedrive-Produkt. Unterhalb dieser Stufe zahlen Sie für eine aufgemotzte Deal-Pipeline.
...
Das CRM, das ich baue. Open Source, EU-gehostet oder selbst hostbar. Cloud-Stufen ab [[commercial.price.starter.monthly]]/User/Monat bis [[commercial.price.business.monthly]] für Business, oder selbst gehostet für immer kostenlos. Modernes Pipedrive-Pendant, agent-nativ über MCP, vollständige REST-API, n8n-Community-Node. Geeignet für Teams, die Datenhoheit, EU-Hosting und KI-getriebene Workflows wertschätzen. Vorsicht bei: jüngeres Projekt als Zoho oder HubSpot, kleinere Community.

**Was in [[commercial.price.starter.monthly]]/User/Monat (Starter) enthalten ist:** unbegrenzte Deals, Kontakte, Unternehmen, benutzerdefinierte Felder, eigene Pipelines, rollenbasierte Berechtigungen, mobile App, REST-API, [[derived.mcp.tools.total]] [MCP-Tools](/docs/mcp), [[derived.webhooks.events.total]] Webhook-Ereignisse, [n8n-Integration](/blog/n8n-for-beginners-build-your-first-workflow), [Self-Hosting](/features/self-hosted) mit demselben Quellcode. Der vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), Kalendersync und Sales Navigator liegen ab Pro bei [[commercial.price.pro.monthly]]/User/Monat. Jede der genannten Kern-CRM-Funktionen ist in jeder Stufe enthalten; mehr zahlen Sie für Messaging-Kapazität und ein größeres Kontingent für die gehostete KI.
...
**Pipedrive:** Lite (14 €) fehlt E-Mail-Öffnungs-Tracking, Custom Fields jenseits der Basis und E-Mail-Sync-Regeln. Growth (39 €) hat das alles. Effektivpreis ist 468 €/User/Jahr für die Stufe, die Teams tatsächlich nutzen.
...
| Pipedrive Growth              | 14.040 €                                                | 3.000 € (Add-ons) | 50 Std.    | niedrig               | ~20.000 €                          |
| HubSpot Free + Sales Starter  | 7.200 €                                                 | 1.000 €           | 60 Std.    | mittel                | ~12.000 €                          |
| CentralStationCRM             | 6.480 €                                                 | 500 €             | 40 Std.    | niedrig               | ~8.000 €                           |
| Customermates Cloud           | [[commercial.price.starter.monthly.seats.10.months.36]] | 500 €             | 30 Std.    | keines (eigene Daten) | Katalog-Abo + Add-ons + Admin-Zeit |
...
Diese Zahlen schwanken je nach konkretem Setup um 30 %, aber die Reihenfolge ist konsistent. Die „günstigen CRMs", die alle auflisten (14 € bis 15 €/User), kommen über drei Jahre für ein 10-Personen-Team typischerweise auf 7.000 € bis 20.000 €. Die Open-Source-Optionen kommen auf 3.500 € bis 6.000 €.
...
**5 bis 15 Personen, 200 bis 1.000 aktive Deals:** [Customermates](/) Cloud (ab [[commercial.price.starter.monthly]]/User) oder selbst gehostet (nur Serverkosten), Pipedrive Lite (14 €) oder Zoho Standard (14 €). In dieser Phase beginnt der Per-User-Preis bezahlter Tools zu zählen; selbst gehostetes Open Source beginnt mathematisch zu gewinnen.

**15 bis 50 Personen, 1.000 bis 5.000 aktive Deals:** Pipedrive Growth (39 €) oder [Customermates](/) selbst gehostet mit Managed Hosting. SaaS-Preise skalieren linear mit Nutzern, Open Source nicht. Das Argument für selbst gehostet wird hier stärker.
...
Wenn Sie ein 4- bis 15-Personen-Team sind, das Datenhoheit schätzt und KI-Tools nutzt: [Customermates](/) Cloud ab [[commercial.price.starter.monthly]]/User/Monat oder selbst gehostet, wenn Sie die technische Kapazität haben. Customermates selbst gehostet auf einem kleinen EU-VPS ist der günstigste glaubwürdige Weg, den ich kenne.

Wenn Sie ein 4- bis 15-Personen-Team in einem reinen DACH-Kontext ohne KI-Fokus sind: Pipedrive Growth, Zoho CRM Pro oder CentralStationCRM. Alle im 12 € bis 39 €/User/Monat-Bereich, alle glaubwürdig.

Wenn Sie ein 15- bis 50-Personen-Team sind: Pipedrive Growth oder [Customermates](/) selbst gehostet sind die zwei, die ich ernsthaft evaluieren würde.
...
**Die 8-Personen-Beratung in Berlin.** Startete in Jahr 1 auf HubSpot Free, angezogen vom polierten Marketing-Automation-Layer. Stieß im Monat 4 an die Kontakt-Grenze und upgradete auf Sales Hub Starter zu 100 €/Monat. Im Monat 8 brauchten sie Sequenzen und Custom Reports, sprangen auf Pro für 450 €/Monat. Jahr-2-Kosten: 5.400 € allein für Lizenzen. Jahr 3 fügten sie Marketing Hub für 800 €/Monat hinzu. Gesamt 3-Jahres-Ausgaben: ~21.500 €. Im heutigen Vergleich kosten acht Customermates-Cloud-Starter-Sitze [[commercial.price.starter.monthly.seats.8]] pro Monat; Self-Hosting hat keine Software-Lizenzgebühr, verursacht aber Infrastruktur- und Wartungskosten.

**Die 12-Personen-Agentur aus München.** Startete auf Pipedrive Lite, weil ein Mitgründer es bei einem früheren Job nutzte. Merkten in Monat 6, dass sie E-Mail-Tracking brauchten, sprangen auf Growth. Fügten in Jahr 2 LeadBooster für Chat hinzu (32,50 € × 12 = 390 €/Monat). Gesamt 3-Jahres-Ausgaben: ~16.500 €. Blieben bei Pipedrive, weil das Team es sauber adoptiert hatte und die Kosten fair wirkten. Vernünftiges Ergebnis.

**Die 5-Personen-Dienstleistungsfirma aus Hamburg.** Startete auf Salesforce Starter Suite, weil der Geschäftsführer dachte „Salesforce ist die sichere Standardwahl". Verbrachte 80 Stunden Admin-Zeit in den ersten 3 Monaten mit Konfiguration. Kosten: 25 € × 5 = 125 €/Monat Basis plus 4.000 € Implementierungspaket von einem Berater. Jahr-1-Total: 5.500 €. Im heutigen Vergleich kosten fünf Customermates-Cloud-Starter-Sitze [[commercial.price.starter.monthly.seats.5]] pro Monat.
...
<Faq>
<FaqItem question="Was ist das günstigste CRM für den Mittelstand?">
Für 1- bis 3-Personen-Teams: HubSpot Free ist tatsächlich brauchbar. Für 4- bis 15-Personen-Teams: Open Source selbst gehostet ([Customermates](/), EspoCRM) ist am günstigsten, nur Serverkosten. Für SaaS: CentralStationCRM (18 €), Less Annoying CRM (15 €) und Pipedrive Lite (14 €) sind die Einstiegspunkte.
</FaqItem>

<FaqItem question="Sind kostenlose CRMs wirklich kostenlos?">
...
<FaqItem question="Was ist das beste CRM unter 20 € pro User?">
Pipedrive Lite, Zoho CRM Standard, OnePageCRM, Less Annoying CRM, [Customermates](/) (ab [[commercial.price.starter.monthly]]), HubSpot Sales Starter, CentralStationCRM. Alle in der Preisklasse glaubwürdig. Wählen Sie das, was zu Ihrem Vertriebsprozess passt.
</FaqItem>

<FaqItem question="Ist Open-Source-CRM wirklich günstiger?">
...
<FaqItem question="Ist Salesforce für den Mittelstand günstig?">
