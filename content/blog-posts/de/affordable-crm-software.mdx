...
Das CRM, das ich baue. Open Source, EU-gehostet oder selbst hostbar. Cloud-Stufen ab 12 €/User/Monat (10 € im Jahresplan) bis 69 € für Business, oder selbst gehostet für immer kostenlos. Modernes Pipedrive-Pendant, agent-nativ über MCP, vollständige REST-API, n8n-Community-Node. Geeignet für Teams, die Datenhoheit, EU-Hosting und KI-getriebene Workflows wertschätzen. Vorsicht bei: jüngeres Projekt als Zoho oder HubSpot, kleinere Community.

**Was in 12 €/User/Monat (Starter) enthalten ist:** unbegrenzte Deals, Kontakte, Unternehmen, benutzerdefinierte Felder, eigene Pipelines, rollenbasierte Berechtigungen, mobile App, REST-API, 45 [MCP-Tools](/docs/mcp), 26 Webhook-Ereignisse, [n8n-Integration](/blog/n8n-for-beginners-build-your-first-workflow), [Self-Hosting](/features/self-hosted) mit demselben Quellcode. Der vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), Kalendersync und Sales Navigator liegen ab Pro bei 29 €/User/Monat. Jede der genannten Kern-CRM-Funktionen und externer MCP-Zugriff sind in jeder Stufe enthalten; höhere Tarife bieten mehr Messaging-Kapazität und größere Kontingente für den gehosteten Assistenten.
...
| Customermates Cloud | 4.320 € | 500 € | 30 Std. | keines (eigene Daten) | ~6.000 € |
...
**5 bis 15 Personen, 200 bis 1.000 aktive Deals:** [Customermates](/) Cloud (ab 12 €/User) oder selbst gehostet (nur Serverkosten), Pipedrive Lite (14 €) oder Zoho Standard (14 €). In dieser Phase beginnt der Per-User-Preis bezahlter Tools zu zählen; selbst gehostetes Open Source beginnt mathematisch zu gewinnen.
...
Wenn Sie ein 4- bis 15-Personen-Team sind, das Datenhoheit schätzt und KI-Tools nutzt: [Customermates](/) Cloud ab 12 €/User/Monat oder selbst gehostet, wenn Sie die technische Kapazität haben. Customermates selbst gehostet auf einem kleinen EU-VPS ist der günstigste glaubwürdige Weg, den ich kenne.
...
**Die 8-Personen-Beratung in Berlin.** Startete in Jahr 1 auf HubSpot Free, angezogen vom polierten Marketing-Automation-Layer. Stieß im Monat 4 an die Kontakt-Grenze und upgradete auf Sales Hub Starter zu 100 €/Monat. Im Monat 8 brauchten sie Sequenzen und Custom Reports, sprangen auf Pro für 450 €/Monat. Jahr-2-Kosten: 5.400 € allein für Lizenzen. Jahr 3 fügten sie Marketing Hub für 800 €/Monat für Landing Pages und E-Mail-Automatisierung hinzu. Gesamt 3-Jahres-Ausgaben: ~21.500 €. Migrierten in Jahr 4 zu Customermates selbst gehostet, weil schon die Cloud-Starter-Stufe zu 12 € × 8 = 96 €/Monat eine Selbstverständlichkeit war, und selbst gehostet für reine Serverkosten noch attraktiver wurde, sobald ein Junior-Entwickler beitrat, der den Server warten konnte. Ersparnis in Jahren 4-5: rund 17.000 €.
...
Pipedrive Lite, Zoho CRM Standard, OnePageCRM, Less Annoying CRM, [Customermates](/) (ab 12 €), HubSpot Sales Starter, CentralStationCRM. Alle in der Preisklasse glaubwürdig. Wählen Sie das, was zu Ihrem Vertriebsprozess passt.
