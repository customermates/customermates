...
Das CRM, das ich baue. Open Source, EU-gehostet oder selbst hostbar. Cloud-Stufen ab 12 €/User/Monat (10 € im Jahresplan) bis 59 € für Business, oder selbst gehostet für immer kostenlos. Modernes Pipedrive-Pendant, agent-nativ über MCP, vollständige REST-API, n8n-Community-Node. Geeignet für Teams, die Datenhoheit, EU-Hosting und KI-getriebene Workflows wertschätzen. Vorsicht bei: jüngeres Projekt als Zoho oder HubSpot, kleinere Community.

**Was in 12 €/User/Monat (Starter) enthalten ist:** unbegrenzte Deals, Kontakte, Unternehmen, benutzerdefinierte Felder, eigene Pipelines, rollenbasierte Berechtigungen, mobile App, REST-API, 45 [MCP-Tools](/docs/mcp), 26 Webhook-Ereignisse, [n8n-Integration](/blog/n8n-for-beginners-build-your-first-workflow), [Self-Hosting](/features/self-hosted) mit demselben Quellcode. Der vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), Kalendersync und Sales Navigator liegen ab Pro bei 29 €/User/Monat. Jede der genannten Kern-CRM-Funktionen ist in jeder Stufe enthalten; mehr zahlen Sie nur für Messaging-Kapazität.
