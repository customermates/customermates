...
**Was in 12 €/User/Monat (Starter) enthalten ist:** unbegrenzte Deals, Kontakte, Unternehmen, benutzerdefinierte Felder, eigene Pipelines, rollenbasierte Berechtigungen, mobile App, REST-API, 46 [MCP-Tools](/docs/mcp), 26 Webhook-Ereignisse, [n8n-Integration](/blog/n8n-for-beginners-build-your-first-workflow), [Self-Hosting](/features/self-hosted) mit demselben Quellcode. Der vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), Kalendersync und Sales Navigator liegen ab Pro bei 29 €/User/Monat. Jede der genannten Kern-CRM-Funktionen ist in jeder Stufe enthalten; mehr zahlen Sie nur für Messaging-Kapazität.
