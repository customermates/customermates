...
**Was in [[commercial.price.starter.monthly]]/User/Monat (Starter) enthalten ist:** unbegrenzte Deals, Kontakte, Unternehmen, benutzerdefinierte Felder, eigene Pipelines, rollenbasierte Berechtigungen, mobile App, REST-API, [[derived.mcp.tools.total]] [MCP-Tools](/docs/mcp), [[derived.webhooks.events.total]] Webhook-Ereignisse, [n8n-Integration](/blog/n8n-for-beginners-build-your-first-workflow), [Self-Hosting](/features/self-hosted) mit demselben Quellcode. Der vereinheitlichte Posteingang (E-Mail, LinkedIn, WhatsApp, Instagram, Telegram), Kalendersync und Sales Navigator liegen ab Pro bei [[commercial.price.pro.monthly]]/User/Monat. Jede der genannten Kern-CRM-Funktionen ist in jeder Stufe enthalten; mehr zahlen Sie nur für Messaging-Kapazität.
