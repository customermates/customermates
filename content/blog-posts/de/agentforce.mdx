...
**Open-Source-CRM + externes LLM über MCP.** [Customermates](/blog/open-source-crm) plus Claude, Codex oder ein beliebiges MCP-fähiges Modell. Open Source unter AGPL-3.0, selbst hostbar, EU-gehostete Cloud-Option. Preis: 7 €/Nutzer/Monat fürs CRM plus KI-API-Kosten (typisch 5 bis 50 €/Monat für kleine Teams).
...
Das CRM ist Open Source unter AGPL-3.0. Self-Hosted kostet die Servermiete (Hetzner CX21 für 5 €/Monat reicht für ein 20-Personen-Team). Cloud-gehostet startet die [Preisgestaltung](/pricing) bei 7 €/Nutzer/Monat im Jahresplan, mit EU-Hosting (Deutschland) als Standard.
