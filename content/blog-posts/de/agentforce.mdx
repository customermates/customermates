...
Salesforce bietet drei Preismodelle für Agentforce an. Alle kommen zusätzlich zu Ihrer bestehenden Salesforce-Rechnung, und Flex Credits und Konversationen lassen sich nicht in derselben Org kombinieren.
...
**Flex Credits.** Grob 0,10 US-Dollar pro Agent-Aktion (eine Aktion verbraucht 20 Credits, ein Paket von 100.000 Credits kostet 500 US-Dollar). Eine Aktion ist grob ein Tool-Aufruf: einen Datensatz lesen, ein Feld aktualisieren, eine E-Mail senden. Voice-Aktionen kosten 30 Credits. Sinnvoll bei variablen internen Workloads, bei denen die Konversationszahl schwer vorhersagbar ist.

**Nutzerbasierte Lizenzierung.** Eine sitzplatzbasierte Option ab 125 US-Dollar pro Nutzer pro Monat, bis 550 US-Dollar pro Nutzer pro Monat für die Edition Agentforce 1 Sales. Sinnvoll, wenn die Nutzung hoch und vorhersagbar genug ist, dass ein fester Sitzplatzpreis die verbrauchsbasierte Abrechnung schlägt.
...
**Wichtiger Kontext:** Agentforce setzt Sales Cloud, Service Cloud oder Data Cloud als Plattform voraus. Sales Cloud reicht von 25 US-Dollar pro Nutzer pro Monat (Starter Suite) über 100 (Pro Suite) bis 175 (Enterprise) und 350 (Unlimited), oberhalb von Starter jährlich abgerechnet. Die meisten Teams, die Agentforce einsetzen, liegen auf Enterprise. Ein 25-Personen-Team mit Sales Cloud Enterprise plus Agentforce gibt realistisch 5.000 bis 15.000 US-Dollar pro Monat aus, vor Implementierungskosten.
...
**Kleine bis mittelständische Teams ohne bestehendes Salesforce.** Die Gesamtkosten zum Einstieg (Sales Cloud + Agentforce + Implementierungspartner) starten bei rund 50.000 € pro Jahr für ein kleines Team. Zum Vergleich setzt sich Customermates aus dem aktuellen CRM-Abo plus der gemessenen API-Nutzung beim gewählten Modellanbieter zusammen; vergleichen Sie die Stacks daher mit Ihrer tatsächlichen Teamgröße und Nutzung statt mit einer festen All-in-Schätzung.
...
**Salesforce Agentforce.** Closed Source, gehostet, in die Salesforce-Plattform integriert. Geeignet für Enterprise-Salesforce-Häuser mit Budget. Preis: 2 US-Dollar/Konversation, rund 0,10 US-Dollar/Aktion oder ab 125 US-Dollar/Nutzer/Monat, plus Salesforce-Lizenz.
...
**Open-Source-CRM + externes LLM über MCP.** [Customermates](/blog/open-source-crm) plus Claude, Codex oder ein beliebiges MCP-fähiges Modell. Open Source unter AGPL-3.0, selbst hostbar, EU-gehostete Cloud-Option. Preis: ab [[commercial.price.starter.monthly]]/Nutzer/Monat fürs CRM (Starter; Pro ab [[commercial.price.pro.monthly]] mit vereinheitlichtem Posteingang) plus KI-API-Kosten (typisch 5 bis 50 €/Monat für kleine Teams).
...
Für viele Teams unter 100 Nutzern liefert der Open-Source-Pfad einen großen Teil der relevanten Agent-Funktionalität zu deutlich niedrigeren Softwarekosten. Für Enterprise mit bestehender Salesforce-Investition erweitert Agentforce das Vorhandene, statt es zu ersetzen.

## Customermates als Open-Source-Agentforce-Alternative

Customermates stellt [[derived.mcp.tools.total]] MCP-Tools bereit, die Claude, Codex, ChatGPT oder einen beliebigen anderen MCP-fähigen Agenten das vollständige CRM bedienen lassen:
...
Das CRM ist Open Source unter AGPL-3.0. Self-Hosted kostet die Servermiete (Hetzner CX21 für 5 €/Monat reicht für ein 20-Personen-Team). Cloud-gehostet startet die [Preisgestaltung](/pricing) bei [[commercial.price.starter.monthly]]/Nutzer/Monat (Starter), mit EU-Hosting (Deutschland) als Standard.
...
Für deutsche Mittelständler in Banken, Versicherungen oder Gesundheitswesen ist Customermates Self-Hosted auf einem deutschen Server (Hetzner, IONOS) der sauberste Weg ohne Drittland-Datentransfer. Schrems-II-Risiko entfällt strukturell.
...
<Faq>
<FaqItem question="Ist Agentforce nur ein Chatbot?">
...
<FaqItem question="Funktioniert Agentforce ohne Salesforce?">
...
<FaqItem question="Wie unterscheidet sich Agentforce von Einstein?">
...
<FaqItem question="Kann ich Claude oder GPT mit Agentforce nutzen?">
...
<FaqItem question="Was ist die beste Agentforce-Alternative für kleine Teams?">
Für Teams unter 50 Nutzern ohne bestehendes Salesforce ist die kosteneffizienteste Alternative ein Open-Source-CRM mit MCP-Unterstützung plus Ihr bevorzugtes LLM. [Customermates](/blog/open-source-crm) plus Claude oder ChatGPT liefert einen großen Teil der relevanten Agent-Erfahrung zu deutlich niedrigeren Softwarekosten. Der Trade-off ist das kleinere Integrations-Ökosystem; für viele kleine Teams ist das nicht die bindende Begrenzung.
</FaqItem>

<FaqItem question="Was kostet Agentforce für kleine Teams?">
Die realistischen Mindestkosten für Agentforce sind die Salesforce-Plattform-Lizenz plus die Agentforce-Nutzung. Für ein 10-Personen-Team sind das grob 2.000 bis 5.000 US-Dollar pro Monat für Sales Cloud Enterprise plus Agentforce, vor Implementierung. Die meisten kleinen Teams können das nicht rechtfertigen. Zum Vergleich kostet das Customermates-Starter-Abo für dasselbe Team [[commercial.price.starter.monthly.seats.10]] pro Monat vor der gemessenen Claude-API-Nutzung beim gewählten Anbieter.
</FaqItem>

<FaqItem question="Wie migriere ich später von Agentforce, falls nötig?">
...
<FaqItem question="Ist Agentforce DSGVO-konform?">
...
<FaqItem question="Wohin entwickelt sich Agentforce?">
