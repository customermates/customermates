...
| Preis | 99 € bis 299 €/User/Monat typisch | 12 € bis 30 €/User/Monat oder selbst gehostet |
...
Das CRM, das ich baue. Open Source, EU-gehostet oder selbst gehostet. Ab 12 €/User/Monat (10 € jährlich, Starter) oder selbst gehostet nur Serverkosten. Konfigurierbar: Sie definieren Kandidaten, Stellen, Vorstellungen, Vermittlungen als Entitäten mit Custom Fields. Der native vereinheitlichte Posteingang (LinkedIn, WhatsApp, E-Mail, Instagram, Telegram) hält Kandidatengespräche über jeden Kanal im CRM, und KI-Agenten können Outreach entwerfen und senden. Agent-nativ über MCP, vollständige REST-API, n8n-Community-Node, 26 Webhook-Events. Geeignet für: Boutique-Agenturen (1 bis 15 Recruiter), interne TA-Teams, die Datenhoheit wollen, Agenturen, die KI-Tools (Claude, Codex) das CRM direkt steuern lassen wollen.

**Konkretes Recruiting-Setup mit Customermates.** Tag 1: Installation auf einem kleinen EU-VPS oder Anmeldung für die Cloud-Version. Tag 2: Den Recruiting-Ablauf auf feste CRM-Entitäten und eigene Felder abbilden: Kontakte für Kandidaten, Organisationen für Kunden und Deals für Stellen oder Vorstellungen. Tag 3: Bestehende Kandidaten-Excel für die REST API aufbereiten, deduplizieren und Pipeline-Stufen aufsetzen. Tag 5: [E-Mail](/features/email-integration) und nur lesenden [Kalenderzugriff](/features/follow-up) verbinden. Woche 2: Einen separat betriebenen n8n-Workflow erstellen, der bei Abschluss Daten an lexoffice übergibt und das Back Office in Slack informiert. Der Aufwand hängt von Daten, Mapping und externen Diensten ab. Siehe [Self-Hosted](/features/self-hosted) und [Pipeline](/features/pipeline).

**Konkrete Kosten über 3 Jahre (8 Recruiter).** Cloud zu 12 € × 8 = 96 €/Monat → 3.456 € über 3 Jahre. Selbst gehostet auf einem Hetzner-CX21-EU-VPS zu 5 €/Monat + Admin-Zeit (~30 Stunden gesamt) → 180 € Serverkosten + etwa 1.500 € Zeit bei 50 €/Stunde = 1.680 €. So oder so ein Vielfaches günstiger als Bullhorn (über 14.000 €) oder Recruit CRM (über 9.600 €) bei gleicher Personalstärke. Der Kompromiss ist die kleinere Community und weniger vorgefertigte recruiting-spezifische Integrationen.

### Pipedrive (konfiguriert)

Mainstream-Vertriebs-CRM, mit angepassten Pipeline-Stufen und Feldern für Recruiting nutzbar. Eingeschränkte kandidatenspezifische Funktionen, aber ausgereifte Plattform. 39 €/User/Monat für die realistische Stufe (Growth). Geeignet für: kleine Agenturen, die Pipedrive bereits kennen und eine bekannte Größe wollen.
...
[Customermates](/) stellt 46 MCP-Tools, REST-API und Webhooks genau dafür bereit. Eine Personalagentur kann Claude die folgenden Aufgaben übergeben:
...
**Recruit CRM → Customermates selbst gehostet (8-Recruiter-Boutique).** Migration: 4 Wochen. Der CSV-Export aus Recruit CRM war sauber. Das Laden unterstützter Datensätze in Customermates lief über eine kundenseitige [REST-API](/features/api)-Integration, die Mapping, Validierung und Deduplizierung übernahm. Custom-Workflow-Wiederaufbau: 30 Stunden. Interne Kosten: rund 6.000 €. Jährliche Ersparnis: rund 5.000 € plus einfachere Administration. Amortisation: 1,2 Jahre.
...
Vertikale Tools: 35 € bis 300 €/User/Monat typisch. Horizontales CRM für Recruiting konfiguriert: 12 € bis 40 €/User/Monat. Selbst gehostete Open-Source-Variante: nur Serverkosten (20 € bis 200 €/Monat fürs ganze Team).
