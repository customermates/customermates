...
Supported product-backed content primitives currently include cards and their real slots, buttons and provider tiles, badges, chips, avatars, compound tables, inputs and labels, alerts, separators, overlapping stacks, counters, state swaps, focus geometry, and connectors. Social presentation variants are bounded adaptations of the real component rather than downstream reconstructions. Extend the schema, catalog, and tests before exposing another product component; never approximate it in a downstream content repository.
