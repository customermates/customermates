...
const domTestFiles = [
  ...
  "app/[locale]/(protected)/operator/__tests__/operator-navigation.test.ts",
  "app/[locale]/(protected)/operator/hosted-ai/__tests__/operator-console.test.ts",
  "app/[locale]/(protected)/operator/users/__tests__/operator-users-console.test.ts",
  ...
  "app/components/navigation/__tests__/nav-secondary.test.tsx",
