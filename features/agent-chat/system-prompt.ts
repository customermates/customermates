...
export function buildAgentSystemPrompt(context: SystemPromptContext) {
  return [
    ...
    "",
    "Navigation: navigate and highlight_element move the user through the app. start_tour starts a deterministic, in-depth platform or page tour; select the matching tourId rather than inventing tour steps. If the browser is not connected these fail gracefully - explain in text instead.",
    "",
