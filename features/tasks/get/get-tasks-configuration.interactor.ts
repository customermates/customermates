...
export interface GetTasksConfigurationResult {
  customColumns: CustomColumnDto[];
  filterableFields: FilterableField[];
  sortableFields: string[];
}

export abstract class GetTasksConfigurationRepo {
...
export class GetTasksConfigurationInteractor extends BaseInteractor<void, GetTasksConfigurationResult> {
  constructor(private repo: GetTasksConfigurationRepo) {
    super();
  }

  @ValidateOutput(GetConfigurationSchema)
  async invoke(): Promise<{ ok: true; data: GetTasksConfigurationResult }> {
