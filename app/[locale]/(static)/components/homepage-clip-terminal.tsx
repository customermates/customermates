...
export function HomepageClipTerminal({ strings }: { strings: ClipTerminal }) {
  ...
  return (
    <div className="relative aspect-16/10 w-full overflow-hidden rounded-xl border border-white/5 bg-[#0a0a0f] font-terminal text-[10px] leading-[1.55] text-[#d4d4d8] shadow-[0_24px_60px_-22px_rgba(0,0,0,0.55)] sm:text-[12px] md:text-[13px]">
