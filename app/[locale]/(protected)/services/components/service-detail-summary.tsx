...
export const ServiceDetailSummary = observer(function ServiceDetailSummary() {
  ...
  const deals = previewItems(previewFieldValues[SERVICE_DETAIL_FIELD.dealIds], fetchedEntity.deals);
  const tasks = previewItems(previewFieldValues[SERVICE_DETAIL_FIELD.taskIds], fetchedEntity.tasks);
  const users = previewItems(previewFieldValues[SERVICE_DETAIL_FIELD.userIds], fetchedEntity.users);
    ...
    <EntityDetailSummary
      ...
      fields={[
        ...
        },
        {
          ...
          label: t("Common.inputs.amount"),
          value: intlStore.formatCurrency(form.amount ?? 0),
        },
        {
