...
export const WikiPageActions = observer(({ store, formId, hasDocument, onCreate, onReload }: Props) => {
      ...
      {hasDocument && store.form.id && (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem
              onSelect={() =>
                runUserAction(() => copyToClipboard(`${window.location.origin}/wiki?page=${store.form.id}`))
              }
            >
              <Link />
