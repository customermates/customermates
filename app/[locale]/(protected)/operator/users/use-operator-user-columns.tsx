...
export function useOperatorUserColumns(): ColumnDef<OperatorUserRowDto>[] {
  ...
  return useMemo<ColumnDef<OperatorUserRowDto>[]>(
    () => [
      {
        id: "name",
        header: t("OperatorUsers.columns.name"),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        id: "createdAt",
        header: t("OperatorUsers.columns.createdAt"),
