  ...
  new ManageDataViewsInteractor(
    {
      ...
      [SURFACE.operatorUsers]: getOperatorUsersRepo(),
      [SURFACE.operatorWorkspaces]: getOperatorWorkspacesRepo(),
      [SURFACE.operatorAudit]: getOperatorAuditRepo(),
